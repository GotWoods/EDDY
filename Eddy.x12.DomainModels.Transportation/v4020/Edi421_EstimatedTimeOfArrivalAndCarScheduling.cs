...
using Eddy.x12.DomainModels.Transportation.v4020._421;
...
public class Edi421_EstimatedTimeOfArrivalAndCarScheduling {
	...
	[SectionPosition(17)] public List<REF_ReferenceIdentification> ReferenceIdentification2 { get; set; } = new();
	...
	public ValidationResult Validate()
	{
		...
		validator.CollectionSize(x => x.Name, 0, 10);
