...
using Eddy.x12.DomainModels.Transportation.v4020._494;
...
public class Edi494_RailScaleRates {
	...
	[SectionPosition(13)] public List<LR9> LR9 {get;set;} = new();
	[SectionPosition(14)] public List<LSCL> LSCL {get;set;} = new();
	...
	public ValidationResult Validate()
	{
		...
		validator.CollectionSize(x => x.PriceAuthorityIdentification, 1, 8);
