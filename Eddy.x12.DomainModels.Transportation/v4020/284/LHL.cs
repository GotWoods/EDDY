...
public class LHL {
	...
	[SectionPosition(9)] public LH3_HazardousMaterialShippingName? HazardousMaterialShippingName { get; set; }
	[SectionPosition(10)] public PO4_ItemPhysicalDetails? ItemPhysicalDetails { get; set; }
	[SectionPosition(11)] public List<MAN_MarksAndNumbers> MarksAndNumbers { get; set; } = new();
