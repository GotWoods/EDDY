...
using Eddy.x12.DomainModels.Transportation.v4020._353;
...
public class Edi353_CustomsEventsAdvisoryDetails {
	...
	[SectionPosition(3)] public P4_USPortInformation? PortInformation { get; set; }
	[SectionPosition(4)] public List<LM15> LM15 {get;set;} = new();
