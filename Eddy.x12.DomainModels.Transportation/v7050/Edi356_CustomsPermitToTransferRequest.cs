...
using Eddy.x12.DomainModels.Transportation.v7050._356;

namespace Eddy.x12.DomainModels.Transportation.v7050;

public class Edi356_CustomsPermitToTransferRequest {
	...
	{
		var validator = new TransactionValidator<Edi356_CustomsPermitToTransferRequest>(this);
