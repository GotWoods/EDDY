...
using Eddy.x12.DomainModels.Transportation.v7050._424;

namespace Eddy.x12.DomainModels.Transportation.v7050;

public class Edi424_RailCarrierServicesSettlement {
	[SectionPosition(1)] public ST_TransactionSetHeader TransactionSetHeader { get; set; } = new();
	[SectionPosition(2)] public BSW_BeginningSegmentForCarrierServicesSettlement BeginningSegmentForCarriersServicesSettlement { get; set; } = new();
