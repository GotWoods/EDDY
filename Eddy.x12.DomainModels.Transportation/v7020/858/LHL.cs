...
namespace Eddy.x12.DomainModels.Transportation.v7020._858;
...
public class LHL {
	...
	[SectionPosition(10)] public SL1_TariffDetails? TariffDetails { get; set; }
	...
	[SectionPosition(13)] public List<M12_InBondIdentifyingInformation> InBondIdentifyingInformation { get; set; } = new();
	[SectionPosition(14)] public List<X1_ExportLicense> ExportLicense { get; set; } = new();
	[SectionPosition(15)] public X2_ImportLicense? ImportLicense { get; set; }
	[SectionPosition(16)] public List<L5_DescriptionMarksAndNumbers> DescriptionMarksAndNumbers { get; set; } = new();
	[SectionPosition(17)] public List<PER_AdministrativeCommunicationsContact> AdministrativeCommunicationsContact { get; set; } = new();
	[SectionPosition(18)] public List<LH2_HazardousClassificationInformation> HazardousClassificationInformation { get; set; } = new();
	[SectionPosition(19)] public LHR_HazardousMaterialIdentifyingReferenceNumbers? HazardousMaterialIdentifyingReferenceNumbers { get; set; }
	[SectionPosition(20)] public List<LH6_HazardousCertification> HazardousCertification { get; set; } = new();
	[SectionPosition(21)] public List<Y7_CargoBookingPriority> CargoBookingPriority { get; set; } = new();
	[SectionPosition(22)] public List<G62_DateTime> DateTime { get; set; } = new();
	[SectionPosition(23)] public List<NTE_NoteSpecialInstruction> NoteSpecialInstruction { get; set; } = new();
	[SectionPosition(24)] public LP_LoadPlanning? LoadPlanning { get; set; }
	[SectionPosition(25)] public List<AXL_VehicleAxleMeasurements> VehicleAxleMeasurements { get; set; } = new();
	[SectionPosition(26)] public List<LHL_LL0> LL0 {get;set;} = new();
	[SectionPosition(27)] public List<LHL_LLH1> LLH1 {get;set;} = new();
	[SectionPosition(28)] public List<LHL_LFA1> LFA1 {get;set;} = new();
	[SectionPosition(29)] public List<LHL_LNM1> LNM1 {get;set;} = new();
	[SectionPosition(30)] public List<LHL_LN1> LN1 {get;set;} = new();
	public ValidationResult Validate()
	{
		...
		validator.CollectionSize(x => x.CargoBookingPriority, 0, 2);
