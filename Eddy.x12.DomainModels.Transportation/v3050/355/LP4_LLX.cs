...
public class LP4_LLX {
	...
	[SectionPosition(6)] public List<LP4__LLX_LM14> LM14 {get;set;} = new();
	[SectionPosition(7)] public List<LP4__LLX_LM15> LM15 {get;set;} = new();
	[SectionPosition(8)] public List<LP4__LLX_LM20> LM20 {get;set;} = new();
	[SectionPosition(9)] public List<LP4__LLX_LMBL> LMBL {get;set;} = new();
