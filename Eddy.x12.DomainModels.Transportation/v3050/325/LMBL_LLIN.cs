...
namespace Eddy.x12.DomainModels.Transportation.v3050._325;
...
public class LMBL_LLIN {
	...
	[SectionPosition(12)] public List<R4_Port> Port { get; set; } = new();
	[SectionPosition(13)] public List<N9_ReferenceNumber> ReferenceNumber { get; set; } = new();
