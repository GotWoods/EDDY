...
using Eddy.x12.DomainModels.Transportation.v3050._304;
...
public class Edi304_ShippingInstructions {
	...
	[SectionPosition(13)] public List<LM1> LM1 {get;set;} = new();
	[SectionPosition(14)] public M2_SalesDeliveryTerms? SalesDeliveryTerms { get; set; }
	[SectionPosition(15)] public C2_BankID? BankID { get; set; }
	...
	[SectionPosition(26)] public List<X1_ExportLicense> ExportLicense { get; set; } = new();
