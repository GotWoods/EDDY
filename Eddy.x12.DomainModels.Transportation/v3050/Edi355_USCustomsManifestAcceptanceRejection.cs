...
using Eddy.x12.DomainModels.Transportation.v3050._355;

namespace Eddy.x12.DomainModels.Transportation.v3050;

public class Edi355_USCustomsManifestAcceptanceRejection {
	...
	{
		var validator = new TransactionValidator<Edi355_USCustomsManifestAcceptanceRejection>(this);
