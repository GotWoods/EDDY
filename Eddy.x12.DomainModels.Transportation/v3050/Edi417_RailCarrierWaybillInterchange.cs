...
using Eddy.x12.DomainModels.Transportation.v3050._417;
...
public class Edi417_RailCarrierWaybillInterchange {
	...
	[SectionPosition(11)] public List<N8A_AdditionalReferenceInformation> AdditionalReferenceInformation { get; set; } = new();
	[SectionPosition(12)] public V9_EventDetail? EventDetail { get; set; }
	[SectionPosition(13)] public F9_OriginStation OriginStation { get; set; } = new();
	[SectionPosition(14)] public D9_DestinationStation DestinationStation { get; set; } = new();
	[SectionPosition(15)] public List<LN1> LN1 {get;set;} = new();
	[SectionPosition(16)] public List<LS1> LS1 {get;set;} = new();
	[SectionPosition(17)] public List<R2_RouteInformation> RouteInformation { get; set; } = new();
	[SectionPosition(18)] public RE_RebillAtInterchange? RebillAtInterchange { get; set; }
	[SectionPosition(19)] public R9_RouteCode? RouteCode { get; set; }
	[SectionPosition(20)] public E1_EmptyCarDispositionPendedDestinationConsignee? EmptyCarDispositionPendedDestinationConsignee { get; set; }
	[SectionPosition(21)] public E4_EmptyCarDispositionPendedDestinationCity? EmptyCarDispositionPendedDestinationCity { get; set; }
	[SectionPosition(22)] public List<E5_EmptyCarDispositionPendedDestinationRoute> EmptyCarDispositionPendedDestinationRoute { get; set; } = new();
	[SectionPosition(23)] public PI_PriceAuthorityIdentification? PriceAuthorityIdentification { get; set; }
	[SectionPosition(24)] public List<H3_SpecialHandlingInstructions> SpecialHandlingInstructions { get; set; } = new();
	[SectionPosition(25)] public List<PS_ProtectiveServiceInstructions> ProtectiveServiceInstructions { get; set; } = new();
	[SectionPosition(26)] public List<LLX> LLX {get;set;} = new();
	[SectionPosition(27)] public List<LT1> LT1 {get;set;} = new();
	[SectionPosition(28)] public L3_TotalWeightAndCharges? TotalWeightAndCharges { get; set; }
	[SectionPosition(29)] public LS_LoopHeader? LoopHeader { get; set; }
	[SectionPosition(30)] public List<LLH1> LLH1 {get;set;} = new();
	[SectionPosition(31)] public LE_LoopTrailer? LoopTrailer { get; set; }
	[SectionPosition(32)] public List<PER_AdministrativeCommunicationsContact> AdministrativeCommunicationsContact { get; set; } = new();
	[SectionPosition(33)] public List<LH2_HazardousClassificationInformation> HazardousClassificationInformation { get; set; } = new();
	[SectionPosition(34)] public LHR_HazardousMaterialIdentifyingReferenceNumbers? HazardousMaterialIdentifyingReferenceNumbers { get; set; }
	[SectionPosition(35)] public List<X7_CustomsInformation> CustomsInformation { get; set; } = new();
	[SectionPosition(36)] public GA_CanadianGrainInformation? CanadianGrainInformation { get; set; }
	[SectionPosition(37)] public SE_TransactionSetTrailer TransactionSetTrailer { get; set; } = new();
