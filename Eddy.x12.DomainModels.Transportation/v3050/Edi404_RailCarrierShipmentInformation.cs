...
using Eddy.x12.DomainModels.Transportation.v3050._404;
...
public class Edi404_RailCarrierShipmentInformation {
	...
	[SectionPosition(18)] public R9_RouteCode? RouteCode { get; set; }
	[SectionPosition(19)] public E1_EmptyCarDispositionPendedDestinationConsignee? EmptyCarDispositionPendedDestinationConsignee { get; set; }
	[SectionPosition(20)] public E4_EmptyCarDispositionPendedDestinationCity? EmptyCarDispositionPendedDestinationCity { get; set; }
	[SectionPosition(21)] public List<E5_EmptyCarDispositionPendedDestinationRoute> EmptyCarDispositionPendedDestinationRoute { get; set; } = new();
	[SectionPosition(22)] public PI_PriceAuthorityIdentification? PriceAuthorityIdentification { get; set; }
	[SectionPosition(23)] public List<H3_SpecialHandlingInstructions> SpecialHandlingInstructions { get; set; } = new();
	[SectionPosition(24)] public List<PS_ProtectiveServiceInstructions> ProtectiveServiceInstructions { get; set; } = new();
	[SectionPosition(25)] public List<LLX> LLX {get;set;} = new();
	[SectionPosition(26)] public List<LLX2> LLX2 {get;set;} = new();
	[SectionPosition(27)] public L3_TotalWeightAndCharges? TotalWeightAndCharges { get; set; }
	[SectionPosition(28)] public LS_LoopHeader? LoopHeader { get; set; }
	[SectionPosition(29)] public List<LLH1> LLH1 {get;set;} = new();
	[SectionPosition(30)] public LE_LoopTrailer? LoopTrailer { get; set; }
	[SectionPosition(31)] public List<PER_AdministrativeCommunicationsContact> AdministrativeCommunicationsContact { get; set; } = new();
	[SectionPosition(32)] public List<LH2_HazardousClassificationInformation> HazardousClassificationInformation { get; set; } = new();
	[SectionPosition(33)] public LHR_HazardousMaterialIdentifyingReferenceNumbers? HazardousMaterialIdentifyingReferenceNumbers { get; set; }
	[SectionPosition(34)] public List<LH6_HazardousCertification> HazardousCertification { get; set; } = new();
	[SectionPosition(35)] public XH_ProFormaB13Information? ProFormaB13Information { get; set; }
	[SectionPosition(36)] public List<X7_CustomsInformation> CustomsInformation { get; set; } = new();
	[SectionPosition(37)] public GA_CanadianGrainInformation? CanadianGrainInformation { get; set; }
	[SectionPosition(38)] public SE_TransactionSetTrailer TransactionSetTrailer { get; set; } = new();
	...
	public ValidationResult Validate()
	{
		...
		validator.CollectionSize(x => x.LLX2, 0, 64);
		...
		foreach (var item in LLX2) validator.Results.AddRange(item.Validate().Errors);
