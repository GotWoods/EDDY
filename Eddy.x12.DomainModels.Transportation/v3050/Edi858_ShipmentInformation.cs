...
using Eddy.x12.DomainModels.Transportation.v3050._858;
...
public class Edi858_ShipmentInformation {
	...
	[SectionPosition(20)] public List<R4_Port> Port { get; set; } = new();
	...
	[SectionPosition(25)] public List<LE1> LE1 {get;set;} = new();
	[SectionPosition(26)] public M1_Insurance? Insurance { get; set; }
	[SectionPosition(27)] public M2_SalesDeliveryTerms? SalesDeliveryTerms { get; set; }
	[SectionPosition(28)] public List<L7_TariffReference> TariffReference { get; set; } = new();
	[SectionPosition(29)] public List<NTE_NoteSpecialInstruction> NoteSpecialInstruction { get; set; } = new();
	[SectionPosition(30)] public XH_ProFormaB13Information? ProFormaB13Information { get; set; }
	[SectionPosition(31)] public GA_CanadianGrainInformation? CanadianGrainInformation { get; set; }
	[SectionPosition(32)] public List<LN7> LN7 {get;set;} = new();
	[SectionPosition(33)] public List<LN1> LN1 {get;set;} = new();
	[SectionPosition(34)] public List<LS5> LS5 {get;set;} = new();

	//Details
	[SectionPosition(35)] public List<LLX> LLX {get;set;} = new();

	//Summary
	[SectionPosition(36)] public L3_TotalWeightAndCharges? TotalWeightAndCharges { get; set; }
	...
	public ValidationResult Validate()
	{
		...
		validator.CollectionSize(x => x.Port, 0, 5);
