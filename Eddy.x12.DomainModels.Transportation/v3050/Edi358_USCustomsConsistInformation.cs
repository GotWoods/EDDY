...
using Eddy.x12.DomainModels.Transportation.v3050._358;

namespace Eddy.x12.DomainModels.Transportation.v3050;

public class Edi358_USCustomsConsistInformation {
	...
	{
		var validator = new TransactionValidator<Edi358_USCustomsConsistInformation>(this);
