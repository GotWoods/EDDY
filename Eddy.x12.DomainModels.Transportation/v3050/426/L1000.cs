...
public class L1000 {
	...
	[SectionPosition(14)] public List<RE_RebillAtInterchange> RebillAtInterchange { get; set; } = new();
	[SectionPosition(15)] public R9_RouteCode? RouteCode { get; set; }
	...
	[SectionPosition(21)] public List<L1A_BillingIdentification> BillingIdentification { get; set; } = new();
	[SectionPosition(22)] public List<X7_CustomsInformation> CustomsInformation { get; set; } = new();
	[SectionPosition(23)] public GA_CanadianGrainInformation? CanadianGrainInformation { get; set; }
