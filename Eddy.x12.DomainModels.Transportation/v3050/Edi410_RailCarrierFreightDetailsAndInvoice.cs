...
using Eddy.x12.DomainModels.Transportation.v3050._410;
...
public class Edi410_RailCarrierFreightDetailsAndInvoice {
	...
	[SectionPosition(13)] public RE_RebillAtInterchange? RebillAtInterchange { get; set; }
	...
	[SectionPosition(16)] public List<LT1> LT1 {get;set;} = new();
	[SectionPosition(17)] public L3_TotalWeightAndCharges TotalWeightAndCharges { get; set; } = new();
	[SectionPosition(18)] public List<X7_CustomsInformation> CustomsInformation { get; set; } = new();
	[SectionPosition(19)] public GA_CanadianGrainInformation? CanadianGrainInformation { get; set; }
