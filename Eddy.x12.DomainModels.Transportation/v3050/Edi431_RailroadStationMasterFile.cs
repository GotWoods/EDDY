...
using Eddy.x12.DomainModels.Transportation.v3050._431;
...
public class Edi431_RailroadStationMasterFile {
	...
	[SectionPosition(5)] public SMS_StationCodesSegment? StationCodesSegment { get; set; }
	[SectionPosition(6)] public List<SMA_StationAddress> StationAddress { get; set; } = new();
	[SectionPosition(7)] public List<SMR_CrossReference> CrossReference { get; set; } = new();
	[SectionPosition(8)] public List<SMO_OperationalServices> OperationalServices { get; set; } = new();
