...
namespace Eddy.x12.DomainModels.Transportation.v8040._325;
...
public class LMBL_LLIN {
	...
	[SectionPosition(7)] public List<MAN_MarksAndNumbersInformation> MarksAndNumbersInformation { get; set; } = new();
