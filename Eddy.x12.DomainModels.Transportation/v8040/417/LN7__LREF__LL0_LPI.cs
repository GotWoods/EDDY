...
namespace Eddy.x12.DomainModels.Transportation.v8040._417;

public class LN7__LREF__LL0_LPI {
	...
	{
		var validator = new TransactionValidator<LN7__LREF__LL0_LPI>(this);
