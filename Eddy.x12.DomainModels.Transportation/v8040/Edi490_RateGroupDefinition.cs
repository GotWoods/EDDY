...
using Eddy.x12.DomainModels.Transportation.v8040._490;
...
public class Edi490_RateGroupDefinition {
	...
	public ValidationResult Validate()
	{
		...
		validator.CollectionSize(x => x.TermText, 0, 999);
		validator.CollectionSize(x => x.Geography, 0, 999);
		validator.CollectionSize(x => x.ShipmentConditions, 0, 999);
		validator.CollectionSize(x => x.ProductCommodity, 0, 999);
		validator.Required(x => x.TransactionSetTrailer);
		

		validator.CollectionSize(x => x.LPT, 0, 999);
