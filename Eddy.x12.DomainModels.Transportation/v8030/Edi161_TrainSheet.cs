...
using Eddy.x12.DomainModels.Transportation.v8030._161;
...
public class Edi161_TrainSheet {
	...
	public ValidationResult Validate()
	{
		...
		validator.CollectionSize(x => x.SpecialHandlingInstructions, 0, 25);
		validator.CollectionSize(x => x.FacingDirection, 0, 25);
