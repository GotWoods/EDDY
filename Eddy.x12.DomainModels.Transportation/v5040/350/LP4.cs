...
namespace Eddy.x12.DomainModels.Transportation.v5040._350;
...
public class LP4 {
	...
	[SectionPosition(5)] public List<VID_ConveyanceIdentification> ConveyanceIdentification { get; set; } = new();
