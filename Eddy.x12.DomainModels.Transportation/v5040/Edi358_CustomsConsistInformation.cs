...
using Eddy.x12.DomainModels.Transportation.v5040._358;
...
public class Edi358_CustomsConsistInformation {
	...
	[SectionPosition(5)] public List<CII_ConveyanceInsuranceInformation> ConveyanceInsuranceInformation { get; set; } = new();
	[SectionPosition(6)] public List<LNM1> LNM1 {get;set;} = new();
	[SectionPosition(7)] public List<LP4> LP4 {get;set;} = new();
