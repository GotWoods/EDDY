...
namespace Eddy.x12.DomainModels.Transportation.v4060._212;
...
public class L0200 {
	...
	[SectionPosition(5)] public List<MAN_MarksAndNumbers> MarksAndNumbersInformation { get; set; } = new();
	[SectionPosition(6)] public AT8_ShipmentWeightPackagingAndQuantityData? ShipmentWeightPackagingAndQuantityData { get; set; }
	[SectionPosition(7)] public List<Q7_LadingExceptionCode> LadingExceptionStatus { get; set; } = new();
