...
namespace Eddy.x12.DomainModels.Transportation.v4060._920;
...
public class LF02 {
	...
	[SectionPosition(3)] public List<MAN_MarksAndNumbers> MarksAndNumbersInformation { get; set; } = new();
	...
	[SectionPosition(6)] public List<Q7_LadingExceptionCode> LadingExceptionStatus { get; set; } = new();
