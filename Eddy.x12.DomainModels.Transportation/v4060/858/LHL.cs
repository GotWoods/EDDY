...
namespace Eddy.x12.DomainModels.Transportation.v4060._858;
...
public class LHL {
	...
	[SectionPosition(10)] public SL1_TariffReference? TariffDetails { get; set; }
	...
	[SectionPosition(20)] public List<Y7_CargoBookingPriority> CargoBookingPriority { get; set; } = new();
