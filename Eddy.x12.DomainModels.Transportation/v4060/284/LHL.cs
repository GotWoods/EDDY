...
namespace Eddy.x12.DomainModels.Transportation.v4060._284;
...
public class LHL {
	...
	[SectionPosition(9)] public LH3_HazardousMaterialShippingName? HazardousMaterialShippingNameInformation { get; set; }
	[SectionPosition(10)] public PO4_ItemPhysicalDetails? ItemPhysicalDetails { get; set; }
	[SectionPosition(11)] public List<MAN_MarksAndNumbers> MarksAndNumbersInformation { get; set; } = new();
