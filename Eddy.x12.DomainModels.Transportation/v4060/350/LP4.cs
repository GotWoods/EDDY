...
namespace Eddy.x12.DomainModels.Transportation.v4060._350;
...
public class LP4 {
	...
	[SectionPosition(5)] public List<LP4_LN9> LN9 {get;set;} = new();
	[SectionPosition(6)] public List<LP4_LX4> LX4 {get;set;} = new();
