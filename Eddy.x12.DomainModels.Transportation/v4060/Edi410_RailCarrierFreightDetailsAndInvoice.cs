...
using Eddy.x12.DomainModels.Transportation.v4060._410;
...
public class Edi410_RailCarrierFreightDetailsAndInvoice {
	...
	[SectionPosition(2)] public B3B_BeginningSegmentForCarriersInvoice BeginningSegmentForRailCarriersInvoice { get; set; } = new();
