...
namespace Eddy.x12.DomainModels.Transportation.v4060._104;

public class LFOB {
	[SectionPosition(1)] public FOB_FOBRelatedInstructions FOBRelatedInstructions { get; set; } = new();
	[SectionPosition(2)] public SL1_TariffReference TariffDetails { get; set; } = new();
	...
	[SectionPosition(10)] public C3_Currency? CurrencyIdentifier { get; set; }
	...
	public ValidationResult Validate()
	{
		...
		validator.Required(x => x.TariffDetails);
