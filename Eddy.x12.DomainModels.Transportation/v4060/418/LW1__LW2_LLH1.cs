...
namespace Eddy.x12.DomainModels.Transportation.v4060._418;

public class LW1__LW2_LLH1 {
	...
	[SectionPosition(3)] public List<LH3_HazardousMaterialShippingName> HazardousMaterialShippingNameInformation { get; set; } = new();
	...
	[SectionPosition(10)] public List<LW1__LW2__LLH1_LN1> LN1 {get;set;} = new();
	public ValidationResult Validate()
	{
		var validator = new TransactionValidator<LW1__LW2_LLH1>(this);
