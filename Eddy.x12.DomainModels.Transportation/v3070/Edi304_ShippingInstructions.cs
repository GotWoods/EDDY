...
using Eddy.x12.DomainModels.Transportation.v3070._304;
...
public class Edi304_ShippingInstructions {
	...
	[SectionPosition(24)] public List<L11_BusinessInstructions> BusinessInstructionsAndReferenceNumber { get; set; } = new();
