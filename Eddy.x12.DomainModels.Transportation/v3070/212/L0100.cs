...
namespace Eddy.x12.DomainModels.Transportation.v3070._212;
...
public class L0100 {
	...
	[SectionPosition(7)] public List<L11_BusinessInstructions> BusinessInstructionsAndReferenceNumber { get; set; } = new();
