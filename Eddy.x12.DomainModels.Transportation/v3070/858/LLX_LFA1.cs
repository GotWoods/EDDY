...
namespace Eddy.x12.DomainModels.Transportation.v3070._858;

public class LLX_LFA1 {
	...
	[SectionPosition(3)] public L10_Weight? Weight { get; set; }
	public ValidationResult Validate()
	{
		var validator = new TransactionValidator<LLX_LFA1>(this);
