...
namespace Eddy.x12.DomainModels.Transportation.v3070._304;
...
public class LLX_LL0 {
	...
	[SectionPosition(3)] public List<LLX__LL0_LPO4> LPO4 {get;set;} = new();
	...
	[SectionPosition(10)] public LIN_ItemIdentification? ItemIdentification { get; set; }
	[SectionPosition(11)] public List<L12_AlternateLadingDescription> AlternateLadingDescription { get; set; } = new();
	[SectionPosition(12)] public List<N9_ReferenceIdentification> ReferenceIdentification { get; set; } = new();
