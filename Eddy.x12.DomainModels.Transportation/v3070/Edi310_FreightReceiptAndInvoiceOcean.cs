...
using Eddy.x12.DomainModels.Transportation.v3070._310;
...
public class Edi310_FreightReceiptAndInvoiceOcean {
	...
	[SectionPosition(18)] public List<K1_Remarks> HeaderRemarks { get; set; } = new();
	...
	[SectionPosition(29)] public L11_BusinessInstructions? BusinessInstructionsAndReferenceNumber { get; set; }
