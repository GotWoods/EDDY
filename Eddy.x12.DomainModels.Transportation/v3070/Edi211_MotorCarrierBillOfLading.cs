...
using Eddy.x12.DomainModels.Transportation.v3070._211;
...
public class Edi211_MotorCarrierBillOfLading {
	...
	[SectionPosition(6)] public List<L11_BusinessInstructions> BusinessInstructionsAndReferenceNumber { get; set; } = new();
