...
public class L0400 {
	...
	[SectionPosition(4)] public POD_ProofOfDelivery? ProofOfDelivery { get; set; }
	...
	[SectionPosition(13)] public List<L0400_L0430> L0430 {get;set;} = new();
	[SectionPosition(14)] public List<L0400_L0460> L0460 {get;set;} = new();
