...
using Eddy.x12.DomainModels.Transportation.v3070._350;

namespace Eddy.x12.DomainModels.Transportation.v3070;

public class Edi350_USCustomsStatusInformation {
	...
	{
		var validator = new TransactionValidator<Edi350_USCustomsStatusInformation>(this);
