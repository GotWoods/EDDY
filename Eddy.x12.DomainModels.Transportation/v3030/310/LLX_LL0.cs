...
namespace Eddy.x12.DomainModels.Transportation.v3030._310;
...
public class LLX_LL0 {
	...
	[SectionPosition(7)] public List<C8_CertificationsAndClauses> CertificationsAndClauses { get; set; } = new();
