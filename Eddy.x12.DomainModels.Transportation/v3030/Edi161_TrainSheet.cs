...
using Eddy.x12.DomainModels.Transportation.v3030._161;
...
public class Edi161_TrainSheet {
	...
	[SectionPosition(4)] public List<FAC_FacingDirection> FacingDirection { get; set; } = new();
	...
	public ValidationResult Validate()
	{
		...
		validator.CollectionSize(x => x.EventDetail, 1, 10);
