...
namespace Eddy.x12.DomainModels.Transportation.v3030._418;
...
public class LW1_LW2 {
	...
	[SectionPosition(8)] public LS_LoopHeader? LoopHeader { get; set; }
	[SectionPosition(9)] public List<LW1__LW2_LLH1> LLH1 {get;set;} = new();
	[SectionPosition(10)] public LE_LoopTrailer? LoopTrailer { get; set; }
	[SectionPosition(11)] public List<PER_AdministrativeCommunicationsContact> AdministrativeCommunicationsContact { get; set; } = new();
	[SectionPosition(12)] public LH2_HazardousClassificationInformation? HazardousClassificationInformation { get; set; }
	[SectionPosition(13)] public LHR_HazardousMaterialIdentifyingReferenceNumbers? HazardousMaterialIdentifyingReferenceNumbers { get; set; }
