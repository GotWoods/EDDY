...
namespace Eddy.x12.DomainModels.Transportation.v3030._404;

public class LN7 {
	[SectionPosition(1)] public N7_EquipmentDetails EquipmentDetails { get; set; } = new();
	[SectionPosition(2)] public List<LN7_LVC> LVC {get;set;} = new();
	[SectionPosition(3)] public List<M7_SealNumbers> SealNumbers { get; set; } = new();
	[SectionPosition(4)] public N5_EquipmentOrdered? EquipmentOrdered { get; set; }
	[SectionPosition(5)] public IC_IntermodalChassisEquipment? IntermodalChassisEquipment { get; set; }
	[SectionPosition(6)] public IM_IntermodalMovementInformation? IntermodalMovementInformation { get; set; }
