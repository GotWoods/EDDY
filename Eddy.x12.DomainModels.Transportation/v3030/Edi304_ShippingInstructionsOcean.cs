...
public class Edi304_ShippingInstructionsOcean {
	...
	[SectionPosition(29)] public List<K1_Remarks> SummaryRemarks { get; set; } = new();
	[SectionPosition(30)] public List<L11_BusinessInstructions> SummaryBusinessInstructions { get; set; } = new();
	...
	public ValidationResult Validate()
	{
		...
		validator.CollectionSize(x => x.HeaderBusinessInstructions, 0, 99);
