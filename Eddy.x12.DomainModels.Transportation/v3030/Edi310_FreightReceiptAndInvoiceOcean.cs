...
using Eddy.x12.DomainModels.Transportation.v3030._310;
...
public class Edi310_FreightReceiptAndInvoiceOcean {
	...
	[SectionPosition(17)] public List<K1_Remarks> HeaderRemarks { get; set; } = new();
	...
	[SectionPosition(25)] public List<K1_Remarks> SummaryRemarks { get; set; } = new();
