...
using Eddy.x12.DomainModels.Transportation.v3030._300;
...
public class Edi300_ReservationBookingRequestOcean {
	...
	[SectionPosition(4)] public Y7_Priority? Priority { get; set; }
	[SectionPosition(5)] public Y1_SpaceReservationRequest SpaceReservationRequest { get; set; } = new();
	[SectionPosition(6)] public List<Y2_ContainerDetails> ContainerDetails { get; set; } = new();
	...
	[SectionPosition(9)] public List<G61_Contact> Contact { get; set; } = new();
	...
	[SectionPosition(14)] public List<V1_VesselIdentification> VesselIdentification { get; set; } = new();
	[SectionPosition(15)] public List<V9_EventDetail> EventDetail { get; set; } = new();
