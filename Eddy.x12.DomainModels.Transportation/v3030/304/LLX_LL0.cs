...
public class LLX_LL0 {
	...
	[SectionPosition(4)] public List<L12_AlternateLadingDescription> AlternateLadingDescription { get; set; } = new();
	[SectionPosition(5)] public List<LLX__LL0_LL1> LL1 {get;set;} = new();
	[SectionPosition(6)] public L4_Measurement? Measurement { get; set; }
	[SectionPosition(7)] public L7_TariffReference? TariffReference { get; set; }
	[SectionPosition(8)] public X1_ExportLicense? ExportLicense { get; set; }
	[SectionPosition(9)] public X2_ImportLicense? ImportLicense { get; set; }
	[SectionPosition(10)] public List<C8_CertificationsAndClauses> CertificationsAndClauses { get; set; } = new();
	[SectionPosition(11)] public List<LLX__LL0_LH1> LH1 {get;set;} = new();
