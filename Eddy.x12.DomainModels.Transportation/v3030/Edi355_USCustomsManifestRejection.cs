...
using Eddy.x12.DomainModels.Transportation.v3030._355;

namespace Eddy.x12.DomainModels.Transportation.v3030;

public class Edi355_USCustomsManifestRejection {
	...
	{
		var validator = new TransactionValidator<Edi355_USCustomsManifestRejection>(this);
