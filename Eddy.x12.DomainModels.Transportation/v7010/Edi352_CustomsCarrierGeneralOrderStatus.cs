...
using Eddy.x12.DomainModels.Transportation.v7010._352;

namespace Eddy.x12.DomainModels.Transportation.v7010;

public class Edi352_CustomsCarrierGeneralOrderStatus {
	...
	{
		var validator = new TransactionValidator<Edi352_CustomsCarrierGeneralOrderStatus>(this);
