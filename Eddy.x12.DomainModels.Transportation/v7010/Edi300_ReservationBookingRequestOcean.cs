...
using Eddy.x12.DomainModels.Transportation.v7010._300;
...
public class Edi300_ReservationBookingRequestOcean {
	...
	[SectionPosition(5)] public Y7_CargoBookingPriority? CargoBookingPriority { get; set; }
	...
	public ValidationResult Validate()
	{
		...
		validator.CollectionSize(x => x.LN1, 1, 99);
		...
		validator.CollectionSize(x => x.Remarks, 0, 20);
