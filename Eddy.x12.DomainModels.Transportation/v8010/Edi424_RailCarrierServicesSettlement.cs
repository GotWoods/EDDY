...
using Eddy.x12.DomainModels.Transportation.v8010._424;

namespace Eddy.x12.DomainModels.Transportation.v8010;

public class Edi424_RailCarrierServicesSettlement {
	[SectionPosition(1)] public ST_TransactionSetHeader TransactionSetHeader { get; set; } = new();
	[SectionPosition(2)] public BSW_BeginningSegmentForCarriersServicesSettlement BeginningSegmentForCarriersServicesSettlement { get; set; } = new();
	...
	public ValidationResult Validate()
	{
		...
		validator.Required(x => x.BeginningSegmentForCarriersServicesSettlement);
