...
public class LN7 {
	...
	[SectionPosition(10)] public List<M12_InBondIdentifyingInformation> InBondIdentifyingInformation { get; set; } = new();
	[SectionPosition(11)] public List<GA_CanadianGrainInformation> CanadianGrainInformation { get; set; } = new();
	[SectionPosition(12)] public List<LN7_LE1> LE1 {get;set;} = new();
