...
using Eddy.x12.DomainModels.Transportation.v8010._432;

namespace Eddy.x12.DomainModels.Transportation.v8010;

public class Edi432_RailCarHireRateNegotiation {
	...
	{
		var validator = new TransactionValidator<Edi432_RailCarHireRateNegotiation>(this);
