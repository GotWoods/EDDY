...
using Eddy.x12.DomainModels.Transportation.v3010._858;
...
public class Edi858_ShipmentInformation {
	...
	[SectionPosition(21)] public MEA_Measurements? Measurements { get; set; }
	...
	[SectionPosition(25)] public E1_EmptyCarDispositionPendedDestinationConsignee? EmptyCarDispositionPendedDestinationConsignee { get; set; }
	[SectionPosition(26)] public E4_EmptyCarDispositionPendedDestinationCity? EmptyCarDispositionPendedDestinationCity { get; set; }
	[SectionPosition(27)] public List<E5_EmptyCarDispositionPendedDestinationRoute> EmptyCarDispositionPendedDestinationRoute { get; set; } = new();
	...
	[SectionPosition(34)] public List<LN7> LN7 {get;set;} = new();
	[SectionPosition(35)] public List<LN1> LN1 {get;set;} = new();
	[SectionPosition(36)] public List<LS5> LS5 {get;set;} = new();
	...
	public ValidationResult Validate()
	{
		...
		validator.CollectionSize(x => x.LS5, 0, 5);
