...
using Eddy.x12.DomainModels.Transportation.v5010._453;
...
public class Edi453_RailroadServiceCommitmentAdvice {
	...
	[SectionPosition(4)] public List<N1_PartyIdentification> PartyIdentification { get; set; } = new();
	...
	public ValidationResult Validate()
	{
		...
		validator.CollectionSize(x => x.PartyIdentification, 0, 999999);
