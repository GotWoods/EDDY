...
using Eddy.x12.DomainModels.Transportation.v3020._304;
...
public class Edi304_ShippingInstructionsOcean {
	...
	[SectionPosition(12)] public M1_Insurance? Insurance { get; set; }
	...
	[SectionPosition(19)] public List<K1_Remarks> HeaderRemarks { get; set; } = new();
	[SectionPosition(20)] public List<L11_BusinessInstructions> HeaderBusinessInstructions { get; set; } = new();
	...
	[SectionPosition(25)] public List<PWK_Paperwork> Paperwork { get; set; } = new();
	[SectionPosition(26)] public List<LL1> LL1 {get;set;} = new();
	[SectionPosition(27)] public List<V9_EventDetail> EventDetail { get; set; } = new();
	[SectionPosition(28)] public List<K1_Remarks> SummaryRemarks { get; set; } = new();
	[SectionPosition(29)] public List<L11_BusinessInstructions> SummaryBusinessInstructions { get; set; } = new();
	...
	public ValidationResult Validate()
	{
		...
		validator.CollectionSize(x => x.HeaderBusinessInstructions, 0, 24);
		...
		validator.CollectionSize(x => x.SummaryBusinessInstructions, 0, 24);
