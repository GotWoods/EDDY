...
using Eddy.x12.DomainModels.Transportation.v3020._350;

namespace Eddy.x12.DomainModels.Transportation.v3020;

public class Edi350_USCustomsReleaseInformationOcean {
	...
	{
		var validator = new TransactionValidator<Edi350_USCustomsReleaseInformationOcean>(this);
