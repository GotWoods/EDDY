...
using Eddy.x12.DomainModels.Transportation.v4010._223;
...
public class Edi223_ConsolidatorsFreightBillAndInvoice {
	...
	[SectionPosition(2)] public B3A_InvoiceType InvoiceType { get; set; } = new();
	...
	//Details
	[SectionPosition(6)] public List<L4000> L4000 {get;set;} = new();
	...
	public ValidationResult Validate()
	{
		...
		validator.CollectionSize(x => x.L4000, 1, 9999);
