...
namespace Eddy.x12.DomainModels.Transportation.v4010._215;
...
public class L0200 {
	...
	[SectionPosition(4)] public MS6_ShipmentQuantityAndWeight? ShipmentQuantityAndWeight { get; set; }
	...
	public ValidationResult Validate()
	{
		...
		validator.CollectionSize(x => x.L0220, 1, 10);
