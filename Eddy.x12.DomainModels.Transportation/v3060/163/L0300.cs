...
namespace Eddy.x12.DomainModels.Transportation.v3060._163;
...
public class L0300 {
	...
	[SectionPosition(7)] public List<G61_Contact> Contact { get; set; } = new();
	[SectionPosition(8)] public List<G62_DateTime> DateTime { get; set; } = new();
	[SectionPosition(9)] public List<L0300_L0350> L0350 {get;set;} = new();
