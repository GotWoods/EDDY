...
using Eddy.x12.DomainModels.Transportation.v3060._210;
...
public class Edi210_MotorCarrierFreightDetailsAndInvoice {
	...
	[SectionPosition(9)] public List<R3_RouteInformationMotor> RouteInformationMotor { get; set; } = new();
	...
	[SectionPosition(14)] public List<L0250> L0250 {get;set;} = new();

	//Details
	[SectionPosition(15)] public List<L0300> L0300 {get;set;} = new();
	[SectionPosition(16)] public List<L0400> L0400 {get;set;} = new();
