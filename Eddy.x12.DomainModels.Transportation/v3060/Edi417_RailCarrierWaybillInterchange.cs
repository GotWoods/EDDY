...
using Eddy.x12.DomainModels.Transportation.v3060._417;
...
public class Edi417_RailCarrierWaybillInterchange {
	...
	[SectionPosition(20)] public PI_PriceAuthorityIdentification? PriceAuthorityIdentification { get; set; }
	[SectionPosition(21)] public List<H3_SpecialHandlingInstructions> SpecialHandlingInstructions { get; set; } = new();
	[SectionPosition(22)] public List<PS_ProtectiveServiceInstructions> ProtectiveServiceInstructions { get; set; } = new();
