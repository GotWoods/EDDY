...
using Eddy.x12.DomainModels.Transportation.v3060._404;
...
public class Edi404_RailCarrierShipmentInformation {
	...
	[SectionPosition(19)] public PI_PriceAuthorityIdentification? PriceAuthorityIdentification { get; set; }
	[SectionPosition(20)] public List<H3_SpecialHandlingInstructions> SpecialHandlingInstructions { get; set; } = new();
	[SectionPosition(21)] public List<PS_ProtectiveServiceInstructions> ProtectiveServiceInstructions { get; set; } = new();
	[SectionPosition(22)] public List<LLX> LLX {get;set;} = new();
	[SectionPosition(23)] public List<LT1> LT1 {get;set;} = new();
	[SectionPosition(24)] public L3_TotalWeightAndCharges? TotalWeightAndCharges { get; set; }
	[SectionPosition(25)] public LS_LoopHeader? LoopHeader { get; set; }
	[SectionPosition(26)] public List<LLH1> LLH1 {get;set;} = new();
	[SectionPosition(27)] public LE_LoopTrailer? LoopTrailer { get; set; }
	[SectionPosition(28)] public List<PER_AdministrativeCommunicationsContact> AdministrativeCommunicationsContact { get; set; } = new();
	[SectionPosition(29)] public List<LH2_HazardousClassificationInformation> HazardousClassificationInformation { get; set; } = new();
	[SectionPosition(30)] public LHR_HazardousMaterialIdentifyingReferenceNumbers? HazardousMaterialIdentifyingReferenceNumbers { get; set; }
	[SectionPosition(31)] public List<LH6_HazardousCertification> HazardousCertification { get; set; } = new();
	[SectionPosition(32)] public XH_ProFormaB13Information? ProFormaB13Information { get; set; }
	[SectionPosition(33)] public List<X7_CustomsInformation> CustomsInformation { get; set; } = new();
