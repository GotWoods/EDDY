...
using Eddy.x12.DomainModels.Transportation.v3060._163;

namespace Eddy.x12.DomainModels.Transportation.v3060;

public class Edi163_AppointmentScheduleInformation {
	...
	[SectionPosition(4)] public Q5_StatusDetails? StatusDetails { get; set; }
	...
	{
		var validator = new TransactionValidator<Edi163_AppointmentScheduleInformation>(this);
