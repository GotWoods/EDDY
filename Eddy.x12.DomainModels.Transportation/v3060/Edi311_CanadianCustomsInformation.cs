...
using Eddy.x12.DomainModels.Transportation.v3060._311;

namespace Eddy.x12.DomainModels.Transportation.v3060;

public class Edi311_CanadianCustomsInformation {
	...
	{
		var validator = new TransactionValidator<Edi311_CanadianCustomsInformation>(this);
		...
		validator.CollectionSize(x => x.Port, 1, 10);
		validator.CollectionSize(x => x.Remarks, 0, 5);
