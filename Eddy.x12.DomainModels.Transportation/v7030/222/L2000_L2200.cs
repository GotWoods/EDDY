...
namespace Eddy.x12.DomainModels.Transportation.v7030._222;
...
public class L2000_L2200 {
	...
	[SectionPosition(5)] public List<PLD_PalletShipmentInformation> PalletShipmentInformation { get; set; } = new();
	...
	public ValidationResult Validate()
	{
		...
		validator.CollectionSize(x => x.PalletShipmentInformation, 0, 2);
