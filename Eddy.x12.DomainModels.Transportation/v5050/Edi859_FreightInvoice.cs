...
using Eddy.x12.DomainModels.Transportation.v5050._859;
...
public class Edi859_FreightInvoice {
	...
	[SectionPosition(7)] public Y7_CargoBookingPriority? CargoBookingPriority { get; set; }
	[SectionPosition(8)] public C3_CurrencyIdentifier? CurrencyIdentifier { get; set; }
	...
	[SectionPosition(25)] public P1_Pickup? Pickup { get; set; }
	[SectionPosition(26)] public ITA_AllowanceChargeOrService? AllowanceChargeOrService { get; set; }
	[SectionPosition(27)] public List<N8_WaybillReference> WaybillReference { get; set; } = new();
	[SectionPosition(28)] public R9_RouteCodeIdentification? RouteCodeIdentification { get; set; }
	[SectionPosition(29)] public List<LH1> LH1 {get;set;} = new();
	[SectionPosition(30)] public List<LN7> LN7 {get;set;} = new();
	[SectionPosition(31)] public List<LN1> LN1 {get;set;} = new();
	[SectionPosition(32)] public List<LS5> LS5 {get;set;} = new();

	//Details
	[SectionPosition(33)] public List<LLX> LLX {get;set;} = new();

	//Summary
	[SectionPosition(34)] public L3_TotalWeightAndCharges? TotalWeightAndCharges { get; set; }
	[SectionPosition(35)] public SE_TransactionSetTrailer TransactionSetTrailer { get; set; } = new();
