...
using Eddy.x12.DomainModels.Transportation.v5050._109;

namespace Eddy.x12.DomainModels.Transportation.v5050;

public class Edi109_VesselContentDetails {
	...
	{
		var validator = new TransactionValidator<Edi109_VesselContentDetails>(this);
