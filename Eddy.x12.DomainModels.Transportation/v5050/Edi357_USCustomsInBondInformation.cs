...
using Eddy.x12.DomainModels.Transportation.v5050._357;

namespace Eddy.x12.DomainModels.Transportation.v5050;

public class Edi357_USCustomsInBondInformation {
	...
	{
		var validator = new TransactionValidator<Edi357_USCustomsInBondInformation>(this);
