...
namespace Eddy.x12.DomainModels.Transportation.v4050._325;
...
public class LMBL_LLIN {
	...
	[SectionPosition(9)] public N1_Name? PartyIdentification { get; set; }
	...
	[SectionPosition(13)] public List<N9_ReferenceIdentification> ExtendedReferenceInformation { get; set; } = new();
