...
using Eddy.x12.DomainModels.Transportation.v4050._859;
...
public class Edi859_FreightInvoice {
	...
	[SectionPosition(7)] public Y7_Priority? CargoBookingPriority { get; set; }
	...
	[SectionPosition(28)] public R9_RouteCode? RouteCodeIdentification { get; set; }
