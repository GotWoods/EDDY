...
namespace Eddy.x12.DomainModels.Transportation.v4050._120;
...
public class LG62_LVC {
	...
	[SectionPosition(4)] public N1_Name? PartyIdentification { get; set; }
	...
	[SectionPosition(8)] public REF_ReferenceIdentification? ReferenceInformation { get; set; }
