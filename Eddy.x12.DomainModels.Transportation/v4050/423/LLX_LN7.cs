...
namespace Eddy.x12.DomainModels.Transportation.v4050._423;
...
public class LLX_LN7 {
	...
	[SectionPosition(14)] public List<QTY_Quantity> QuantityInformation { get; set; } = new();
	[SectionPosition(15)] public List<N9_ReferenceIdentification> ExtendedReferenceInformation { get; set; } = new();
