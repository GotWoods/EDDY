...
namespace Eddy.x12.DomainModels.Transportation.v4050._460;

public class LSB__LSC_LLX {
	[SectionPosition(1)] public LX_AssignedNumber TransactionSetLineNumber { get; set; } = new();
	[SectionPosition(2)] public List<RS_RateSubset> RateSubset { get; set; } = new();
	...
	public ValidationResult Validate()
	{
		...
		validator.CollectionSize(x => x.RateSubset, 1, 2);
