...
using Eddy.x12.DomainModels.Transportation.v4050._421;
...
public class Edi421_EstimatedTimeOfArrivalAndCarScheduling {
	...
	[SectionPosition(9)] public List<N1_Name> PartyIdentification { get; set; } = new();
	...
	[SectionPosition(17)] public List<REF_ReferenceIdentification> ReferenceInformation { get; set; } = new();
