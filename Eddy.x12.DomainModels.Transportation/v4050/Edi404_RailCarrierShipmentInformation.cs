...
using Eddy.x12.DomainModels.Transportation.v4050._404;
...
public class Edi404_RailCarrierShipmentInformation {
	...
	[SectionPosition(17)] public R9_RouteCode? RouteCodeIdentification { get; set; }
	...
	public ValidationResult Validate()
	{
		...
		validator.CollectionSize(x => x.ExtendedReferenceInformation, 1, 30);
