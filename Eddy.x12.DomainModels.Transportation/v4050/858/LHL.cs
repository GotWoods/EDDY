...
public class LHL {
	...
	[SectionPosition(11)] public List<N9_ReferenceIdentification> ExtendedReferenceInformation { get; set; } = new();
	...
	[SectionPosition(20)] public List<Y7_Priority> CargoBookingPriority { get; set; } = new();
