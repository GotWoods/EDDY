...
using Eddy.x12.DomainModels.Transportation.v4050._300;
...
public class Edi300_ReservationBookingRequestOcean {
	...
	[SectionPosition(5)] public Y7_Priority? CargoBookingPriority { get; set; }
	...
	[SectionPosition(8)] public List<N9_ReferenceIdentification> ExtendedReferenceInformation { get; set; } = new();
