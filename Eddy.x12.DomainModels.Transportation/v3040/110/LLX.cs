...
public class LLX {
	...
	[SectionPosition(4)] public P1_PickUp? PickUp { get; set; }
	...
	[SectionPosition(9)] public List<RMT_RemittanceAdvice> RemittanceAdvice { get; set; } = new();
	[SectionPosition(10)] public List<NTE_NoteSpecialInstruction> NoteSpecialInstruction { get; set; } = new();
	[SectionPosition(11)] public List<LLX_LL5> LL5 {get;set;} = new();
