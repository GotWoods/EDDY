...
using Eddy.x12.DomainModels.Transportation.v3040._204;
...
public class Edi204_MotorCarrierShipmentInformation {
	...
	//Details
	[SectionPosition(18)] public List<L0300> L0300 {get;set;} = new();
	[SectionPosition(19)] public List<L0400> L0400 {get;set;} = new();
