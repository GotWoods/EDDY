...
using Eddy.x12.DomainModels.Transportation.v3040._404;
...
public class Edi404_RailCarrierShipmentInformation {
	...
	[SectionPosition(24)] public List<LLX> LLX {get;set;} = new();
	[SectionPosition(25)] public List<LLX2> LLX2 {get;set;} = new();
	[SectionPosition(26)] public L3_TotalWeightAndCharges? TotalWeightAndCharges { get; set; }
	[SectionPosition(27)] public LS_LoopHeader? LoopHeader { get; set; }
	[SectionPosition(28)] public List<LLH1> LLH1 {get;set;} = new();
	[SectionPosition(29)] public LE_LoopTrailer? LoopTrailer { get; set; }
	[SectionPosition(30)] public List<PER_AdministrativeCommunicationsContact> AdministrativeCommunicationsContact { get; set; } = new();
	[SectionPosition(31)] public List<LH2_HazardousClassificationInformation> HazardousClassificationInformation { get; set; } = new();
	[SectionPosition(32)] public LHR_HazardousMaterialIdentifyingReferenceNumbers? HazardousMaterialIdentifyingReferenceNumbers { get; set; }
	[SectionPosition(33)] public List<LH6_HazardousCertification> HazardousCertification { get; set; } = new();
	[SectionPosition(34)] public XH_ProFormaB13Information? ProFormaB13Information { get; set; }
