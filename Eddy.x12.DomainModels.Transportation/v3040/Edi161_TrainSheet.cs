...
using Eddy.x12.DomainModels.Transportation.v3040._161;
...
public class Edi161_TrainSheet {
	...
	[SectionPosition(3)] public List<FAC_FacingDirection> FacingDirection { get; set; } = new();
	[SectionPosition(4)] public List<V9_EventDetail> EventDetail { get; set; } = new();
	...
	public ValidationResult Validate()
	{
		...
		validator.CollectionSize(x => x.FacingDirection, 1, 10);
