...
using Eddy.x12.DomainModels.Transportation.v3040._110;
...
public class Edi110_AirFreightDetailsAndInvoice {
	...
	//Summary
	[SectionPosition(8)] public L3_TotalWeightAndCharges TotalWeightAndCharges { get; set; } = new();
	[SectionPosition(9)] public ACS_AncillaryCharges? AncillaryCharges { get; set; }
