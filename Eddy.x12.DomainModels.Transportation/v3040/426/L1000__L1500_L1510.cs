...
public class L1000__L1500_L1510 {
	...
	[SectionPosition(3)] public L7_TariffReference? TariffReference { get; set; }
	[SectionPosition(4)] public L7A_ContractReferenceIdentifier? ContractReferenceIdentifier { get; set; }
