...
using Eddy.x12.DomainModels.Transportation.v3040._350;

namespace Eddy.x12.DomainModels.Transportation.v3040;

public class Edi350_USCustomsReleaseInformation {
	...
	{
		var validator = new TransactionValidator<Edi350_USCustomsReleaseInformation>(this);
