...
public class LLX_LN7 {
	...
	[SectionPosition(8)] public List<LLX__LN7_LL1> LL1 {get;set;} = new();
	[SectionPosition(9)] public L7_TariffReference? TariffReference { get; set; }
	[SectionPosition(10)] public X1_ExportLicense? ExportLicense { get; set; }
	[SectionPosition(11)] public List<X2_ImportLicense> ImportLicense { get; set; } = new();
	[SectionPosition(12)] public List<N9_ReferenceNumber> ReferenceNumber { get; set; } = new();
	[SectionPosition(13)] public List<LLX__LN7_LH1> LH1 {get;set;} = new();
	[SectionPosition(14)] public List<LLX__LN7_LLH1> LLH1 {get;set;} = new();
