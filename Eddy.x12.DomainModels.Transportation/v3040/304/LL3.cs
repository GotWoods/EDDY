...
public class LL3 {
	...
	[SectionPosition(4)] public List<SUP_SupplementaryInformation> SupplementaryInformation { get; set; } = new();
	[SectionPosition(5)] public List<LL3_LL1> LL1 {get;set;} = new();
	[SectionPosition(6)] public TDS_TotalMonetaryValueSummary? TotalMonetaryValueSummary { get; set; }
	[SectionPosition(7)] public List<SAC_ServicePromotionAllowanceOrChargeInformation> ServicePromotionAllowanceOrChargeInformation { get; set; } = new();
	[SectionPosition(8)] public List<L9_ChargeDetail> ChargeDetail { get; set; } = new();
	[SectionPosition(9)] public List<ISS_InvoiceShipmentSummary> InvoiceShipmentSummary { get; set; } = new();
	[SectionPosition(10)] public List<V9_EventDetail> EventDetail { get; set; } = new();
	[SectionPosition(11)] public List<K1_Remarks> Remarks { get; set; } = new();
	[SectionPosition(12)] public List<L11_BusinessInstructions> BusinessInstructions { get; set; } = new();
	public ValidationResult Validate()
	{
		...
		validator.CollectionSize(x => x.SupplementaryInformation, 0, 25);
