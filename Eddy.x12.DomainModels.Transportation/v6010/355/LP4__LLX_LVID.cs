...
public class LP4__LLX_LVID {
	...
	[SectionPosition(6)] public List<LP4__LLX__LVID_LM72> LM72 {get;set;} = new();
	[SectionPosition(7)] public List<LP4__LLX__LVID_LN10> LN10 {get;set;} = new();
	public ValidationResult Validate()
	{
		...
		validator.CollectionSize(x => x.LM72, 0, 5);
		...
		foreach (var item in LM72) validator.Results.AddRange(item.Validate().Errors);
