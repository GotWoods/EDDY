...
namespace Eddy.x12.DomainModels.Transportation.v4040._304;
...
public class LL3 {
	...
	[SectionPosition(13)] public List<L11_BusinessInstructionsAndReferenceNumber> BusinessInstructionsAndReferenceNumber { get; set; } = new();
	public ValidationResult Validate()
	{
		...
		validator.CollectionSize(x => x.BusinessInstructionsAndReferenceNumber, 0, 24);
