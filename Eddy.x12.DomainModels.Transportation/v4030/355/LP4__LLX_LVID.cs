...
namespace Eddy.x12.DomainModels.Transportation.v4030._355;
...
public class LP4__LLX_LVID {
	...
	[SectionPosition(3)] public List<LP4__LLX__LVID_LMBL> LMBL {get;set;} = new();
	[SectionPosition(4)] public List<LP4__LLX__LVID_LVC> LVC {get;set;} = new();
	[SectionPosition(5)] public List<LP4__LLX__LVID_LN10> LN10 {get;set;} = new();
