...
namespace Eddy.x12.DomainModels.Transportation.v4030._601;
...
public class LBA1 {
	...
	[SectionPosition(5)] public List<P5_PortInformation> PortFunction { get; set; } = new();
	...
	public ValidationResult Validate()
	{
		...
		validator.CollectionSize(x => x.YesNoQuestion, 1, 10);
		validator.Required(x => x.DateTimeReference);
		validator.CollectionSize(x => x.PortFunction, 1, 2);
		...
		validator.CollectionSize(x => x.LL13, 1, 999);
