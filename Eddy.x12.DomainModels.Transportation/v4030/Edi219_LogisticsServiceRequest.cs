...
using Eddy.x12.DomainModels.Transportation.v4030._219;
...
public class Edi219_LogisticsServiceRequest {
	...
	[SectionPosition(5)] public List<MS3_InterlineInformation> InterlineInformation { get; set; } = new();
	...
	//Summary
	[SectionPosition(10)] public L3_TotalWeightAndCharges TotalWeightAndCharges { get; set; } = new();
