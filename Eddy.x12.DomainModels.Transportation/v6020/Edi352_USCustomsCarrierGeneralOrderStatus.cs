...
using Eddy.x12.DomainModels.Transportation.v6020._352;

namespace Eddy.x12.DomainModels.Transportation.v6020;

public class Edi352_USCustomsCarrierGeneralOrderStatus {
	...
	{
		var validator = new TransactionValidator<Edi352_USCustomsCarrierGeneralOrderStatus>(this);
