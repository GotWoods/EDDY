...
public class Edi210_MotorCarrierFreightDetailsAndInvoice
{
    ...
    [SectionPosition(11)] public List<_8020._210.EquipmentDetails> EquipmentDetails { get; set; } = new();
    ...
    [SectionPosition(13)] public List<_8020._210.TransactionSet> Transactions { get; set; } = new();
