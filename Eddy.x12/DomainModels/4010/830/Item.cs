...
public class Item
{
    ...
    [SectionPosition(5)] public List<CTP_TODO> PricingInformation { get; set; } = new();
    ...
    [SectionPosition(12)] public List<REF_ReferenceInformation> ReferenceInformations { get; set; } = new();
    ...
    [SectionPosition(17)] public FOB_RelatedInstructions RelatedInstructions { get; set; } = new();
    [SectionPosition(18)] public List<LDT_LeadTime> LeadTimes { get; set; } = new();
    [SectionPosition(19)] public List<QTY_QuantityInformation> QuantityInformations { get; set; } = new();
    ...
    [SectionPosition(25)] public List<MAN_MarksAndNumbersInformation> MarksAndNumbers { get; set; } = new();
