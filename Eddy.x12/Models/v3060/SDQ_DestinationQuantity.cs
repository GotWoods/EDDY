...
public class SDQ_DestinationQuantity : EdiX12Segment
{
	...
	public override ValidationResult Validate()
	{
		...
		validator.Length(x => x.IdentificationCode4, 2, 20);
		validator.Length(x => x.Quantity4, 1, 15);
		validator.Length(x => x.IdentificationCode5, 2, 20);
		validator.Length(x => x.Quantity5, 1, 15);
		validator.Length(x => x.IdentificationCode6, 2, 20);
		validator.Length(x => x.Quantity6, 1, 15);
		validator.Length(x => x.IdentificationCode7, 2, 20);
		validator.Length(x => x.Quantity7, 1, 15);
		validator.Length(x => x.IdentificationCode8, 2, 20);
		validator.Length(x => x.Quantity8, 1, 15);
		validator.Length(x => x.IdentificationCode9, 2, 20);
		validator.Length(x => x.Quantity9, 1, 15);
		validator.Length(x => x.IdentificationCode10, 2, 20);
