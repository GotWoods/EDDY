...
public class EFI_ElectronicFormatIdentification : EdiX12Segment
{
	...
	[Position(15)]
	public string VersionIdentifier4 { get; set; }
	...
	public override ValidationResult Validate()
	{
		...
		validator.ARequiresB(x=>x.ProgramIdentifier, x=>x.VersionIdentifier);
		validator.ARequiresB(x=>x.InterchangeFormat, x=>x.VersionIdentifier2);
		validator.ARequiresB(x=>x.CompressionTechnique, x=>x.VersionIdentifier3);
		validator.IfOneIsFilled_AllAreRequired(x=>x.VersionIdentifier4, x=>x.FilterIDCode);
		...
		validator.Length(x => x.VersionIdentifier4, 1, 30);
