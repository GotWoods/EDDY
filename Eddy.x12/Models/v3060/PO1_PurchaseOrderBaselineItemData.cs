...
[Segment("PO1")]
public class PO1_BaselineItemData : EdiX12Segment
{
	[Position(01)]
	...
	{
		var validator = new BasicValidator<PO1_BaselineItemData>(this);
		validator.ARequiresB(x=>x.UnitOrBasisForMeasurementCode, x=>x.QuantityOrdered);
