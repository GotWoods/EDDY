...
public class SI_ServiceCharacteristicIdentification : EdiX12Segment
{
	...
	public override ValidationResult Validate()
	{
		...
		validator.Length(x => x.ServiceCharacteristicsQualifier3, 2, 3);
		validator.Length(x => x.ProductServiceID3, 1, 80);
		validator.Length(x => x.ServiceCharacteristicsQualifier4, 2, 3);
		validator.Length(x => x.ProductServiceID4, 1, 80);
		validator.Length(x => x.ServiceCharacteristicsQualifier5, 2, 3);
		validator.Length(x => x.ProductServiceID5, 1, 80);
		validator.Length(x => x.ServiceCharacteristicsQualifier6, 2, 3);
		validator.Length(x => x.ProductServiceID6, 1, 80);
		validator.Length(x => x.ServiceCharacteristicsQualifier7, 2, 3);
		validator.Length(x => x.ProductServiceID7, 1, 80);
		validator.Length(x => x.ServiceCharacteristicsQualifier8, 2, 3);
		validator.Length(x => x.ProductServiceID8, 1, 80);
		validator.Length(x => x.ServiceCharacteristicsQualifier9, 2, 3);
		validator.Length(x => x.ProductServiceID9, 1, 80);
		validator.Length(x => x.ServiceCharacteristicsQualifier10, 2, 3);
