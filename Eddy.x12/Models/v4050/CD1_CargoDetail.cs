...
public class CD1_CargoDetail : EdiX12Segment
{
	...
	[Position(13)]
	public string BillOfLadingDispositionCode2 { get; set; }

	[Position(14)]
	public string BillOfLadingDispositionCode3 { get; set; }
	...
	public override ValidationResult Validate()
	{
		...
		validator.Length(x => x.BillOfLadingDispositionCode, 2);
		validator.Length(x => x.BillOfLadingDispositionCode2, 2);
		validator.Length(x => x.BillOfLadingDispositionCode3, 2);
