...
{
	[Position(01)]
	public string AutomaticEquipmentIdentificationSiteStatusCode { get; set; }

	[Position(02)]
	public string MovementTypeCode { get; set; }

	[Position(03)]
	public string TrainTerminationStatusCode { get; set; }

	[Position(04)]
	public string AutomaticEquipmentIdentificationConsistConfidenceLevelCode { get; set; }
