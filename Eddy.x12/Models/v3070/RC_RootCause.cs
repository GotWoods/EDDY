...
public class RC_RootCause : EdiX12Segment
{
	...
	[Position(06)]
	public string CasualPartConditionCode { get; set; }
	...
	public override ValidationResult Validate()
	{
		...
		validator.ARequiresB(x=>x.AgencyQualifierCode, x=>x.CasualPartConditionCode);
		validator.ARequiresB(x=>x.SourceSubqualifier, x=>x.AgencyQualifierCode);
		validator.AtLeastOneIsRequired(x=>x.CasualPartConditionCode, x=>x.Description);
		...
		validator.Length(x => x.CasualPartConditionCode, 1, 3);
