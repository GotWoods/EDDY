...
public class ID1_ItemDetailDimensions : EdiX12Segment
{
	...
	public override ValidationResult Validate()
	{
		...
		validator.ARequiresB(x=>x.ReferenceIdentification, x=>x.UnitOrBasisForMeasurementCode6);
		validator.ARequiresB(x=>x.ReferenceIdentification2, x=>x.UnitOrBasisForMeasurementCode6);
		validator.ARequiresB(x=>x.ReferenceIdentification3, x=>x.UnitOrBasisForMeasurementCode6);
