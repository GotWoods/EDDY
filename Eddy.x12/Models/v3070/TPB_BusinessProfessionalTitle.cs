...
{
	[Position(01)]
	public string BusinesssProfessionalTitle { get; set; }
	...
	public override ValidationResult Validate()
	{
		...
		validator.AtLeastOneIsRequired(x=>x.BusinesssProfessionalTitle, x=>x.FreeFormMessageText);
		validator.ARequiresB(x=>x.AgencyQualifierCode, x=>x.BusinesssProfessionalTitle);
		validator.ARequiresB(x=>x.SourceSubqualifier, x=>x.AgencyQualifierCode);
		validator.Length(x => x.BusinesssProfessionalTitle, 1, 3);
