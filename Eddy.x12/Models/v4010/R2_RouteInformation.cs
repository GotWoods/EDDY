...
public class R2_RouteInformation : EdiX12Segment
{
	...
	[Position(08)]
	public string IntermediateSwitchCarrier2 { get; set; }
	...
	public override ValidationResult Validate()
	{
		...
		validator.ARequiresB(x=>x.IntermediateSwitchCarrier2, x=>x.IntermediateSwitchCarrier);
		...
		validator.Length(x => x.IntermediateSwitchCarrier2, 2, 4);
