...
public class PR_ProductCommodity : EdiX12Segment
{
	...
	public override ValidationResult Validate()
	{
		...
		validator.AtLeastOneIsRequired(x=>x.CommodityCodeQualifier, x=>x.StandardCarrierAlphaCode);
		validator.IfOneIsFilled_AllAreRequired(x=>x.CommodityCodeQualifier, x=>x.CommodityCode);
		validator.OnlyOneOf(x=>x.CommodityCodeQualifier, x=>x.StandardCarrierAlphaCode);
