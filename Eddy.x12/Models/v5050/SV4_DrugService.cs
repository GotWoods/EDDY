...
public class SV4_DrugService : EdiX12Segment
{
	...
	[Position(20)]
	public string AdditionalDrugCoverageCode { get; set; }

	[Position(21)]
	public string CompoundRouteOfAdministrationCode { get; set; }

	[Position(22)]
	public string SubmittedDrugSalesTaxCode { get; set; }
	...
	public override ValidationResult Validate()
	{
		...
		validator.Length(x => x.SubmissionClarificationCode, 1, 2);
		validator.Length(x => x.AdditionalDrugCoverageCode, 1, 2);
		validator.Length(x => x.CompoundRouteOfAdministrationCode, 1, 2);
		validator.Length(x => x.SubmittedDrugSalesTaxCode, 2);
