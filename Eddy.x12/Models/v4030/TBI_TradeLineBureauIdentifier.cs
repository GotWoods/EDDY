...
public class TBI_TradeLineBureauIdentifier : EdiX12Segment
{
	...
	public override ValidationResult Validate()
	{
		...
		validator.Length(x => x.ReferenceIdentification5, 1, 50);
		validator.Length(x => x.ReferenceIdentification6, 1, 50);
		validator.Length(x => x.ReferenceIdentification7, 1, 50);
