...
public class AC_MovementRateSetHeader : EdiX12Segment
{
	...
	public override ValidationResult Validate()
	{
		...
		validator.AtLeastOneIsRequired(x=>x.StateOrProvinceCode, x=>x.LocationIdentifier);
		validator.AtLeastOneIsRequired(x=>x.StateOrProvinceCode2, x=>x.LocationIdentifier2);
