...
public class ID2_ItemImageDetail : EdiX12Segment
{
	...
	public override ValidationResult Validate()
	{
		...
		validator.IfOneIsFilled_AllAreRequired(x=>x.SpaceManagementReferenceCode, x=>x.ReferenceNumber);
		validator.IfOneIsFilled_AllAreRequired(x=>x.SpaceManagementReferenceCode2, x=>x.ReferenceNumber2);
