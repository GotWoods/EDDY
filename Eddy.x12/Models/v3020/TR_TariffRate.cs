...
public class TR_TariffRate : EdiX12Segment
{
	...
	public override ValidationResult Validate()
	{
		...
		validator.IfOneIsFilled_AllAreRequired(x=>x.UnitOfMeasurementCode, x=>x.PackagingCode);
		validator.IfOneIsFilled_AllAreRequired(x=>x.QuantityQualifier2, x=>x.Quantity2);
		validator.IfOneIsFilled_AllAreRequired(x=>x.UnitOfMeasurementCode2, x=>x.PackagingCode2);
