...
public class TAX_TaxReference : EdiX12Segment
{
	...
	public override ValidationResult Validate()
	{
		...
		validator.AtLeastOneIsRequired(x=>x.TaxIdentificationNumber, x=>x.LocationQualifier);
		validator.ARequiresB(x=>x.LocationQualifier, x=>x.LocationIdentifier);
		validator.ARequiresB(x=>x.LocationQualifier2, x=>x.LocationIdentifier2);
		validator.ARequiresB(x=>x.LocationQualifier3, x=>x.LocationIdentifier3);
		validator.ARequiresB(x=>x.LocationQualifier4, x=>x.LocationIdentifier4);
		validator.ARequiresB(x=>x.LocationQualifier5, x=>x.LocationIdentifier5);
