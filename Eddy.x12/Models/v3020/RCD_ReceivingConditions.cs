...
public class RCD_ReceivingConditions : EdiX12Segment
{
	...
	public override ValidationResult Validate()
	{
		...
		validator.ARequiresB(x=>x.QuantityUnitsReceivedOrAccepted, x=>x.UnitOfMeasurementCode);
		validator.ARequiresB(x=>x.QuantityUnitsReturned, x=>x.UnitOfMeasurementCode2);
