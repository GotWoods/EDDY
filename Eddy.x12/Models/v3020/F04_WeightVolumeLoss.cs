...
public class F04_WeightVolumeLoss : EdiX12Segment
{
	...
	public override ValidationResult Validate()
	{
		...
		validator.ARequiresB(x=>x.Weight, x=>x.WeightUnitQualifier);
		validator.ARequiresB(x=>x.Weight, x=>x.WeightQualifier);
		validator.ARequiresB(x=>x.Weight, x=>x.Weight2);
		validator.ARequiresB(x=>x.Weight2, x=>x.WeightUnitQualifier2);
		validator.ARequiresB(x=>x.Weight2, x=>x.WeightQualifier2);
		validator.ARequiresB(x=>x.Volume, x=>x.VolumeUnitQualifier);
		validator.ARequiresB(x=>x.Volume, x=>x.Volume2);
		validator.ARequiresB(x=>x.Volume2, x=>x.VolumeUnitQualifier2);
