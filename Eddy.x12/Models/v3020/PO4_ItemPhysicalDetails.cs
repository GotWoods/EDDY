...
public class PO4_ItemPhysicalDetails : EdiX12Segment
{
	...
	public override ValidationResult Validate()
	{
		...
		validator.ARequiresB(x=>x.Size, x=>x.UnitOfMeasurementCode);
		validator.IfOneIsFilledThenAtLeastOne(x=>x.WeightQualifier, x=>x.GrossWeightPerPack, x=>x.UnitOfMeasurementCode2);
		validator.ARequiresB(x=>x.GrossVolumePerPack, x=>x.UnitOfMeasurementCode3);
		validator.IfOneIsFilledThenAtLeastOne(x=>x.UnitOfMeasurementCode4, x=>x.Length, x=>x.Width, x=>x.Height);
