...
public class W11_WarehouseQuantitiesDetail : EdiX12Segment
{
	...
	public override ValidationResult Validate()
	{
		...
		validator.IfOneIsFilled_AllAreRequired(x=>x.QuantityReceived, x=>x.UnitOfMeasurementCode4);
		validator.IfOneIsFilled_AllAreRequired(x=>x.NumberOfUnitsShipped, x=>x.UnitOfMeasurementCode5);
		validator.IfOneIsFilled_AllAreRequired(x=>x.QuantityDamagedOnHold, x=>x.UnitOfMeasurementCode6);
		validator.IfOneIsFilled_AllAreRequired(x=>x.QuantityOrdered, x=>x.UnitOfMeasurementCode7);
