...
public class MEA_Measurements : EdiX12Segment
{
	...
	public override ValidationResult Validate()
	{
		...
		validator.ARequiresB(x=>x.MeasurementValue, x=>x.UnitOfMeasurementCode);
		validator.ARequiresB(x=>x.RangeMinimum, x=>x.UnitOfMeasurementCode);
		validator.ARequiresB(x=>x.RangeMaximum, x=>x.UnitOfMeasurementCode);
