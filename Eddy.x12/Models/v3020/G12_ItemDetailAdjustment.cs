...
public class G12_ItemDetailAdjustment : EdiX12Segment
{
	...
	public override ValidationResult Validate()
	{
		...
		validator.IfOneIsFilled_AllAreRequired(x=>x.CreditDebitQuantity, x=>x.UnitOfMeasurementCode);
		validator.AtLeastOneIsRequired(x=>x.UnitPriceDifference, x=>x.AmountOfAdjustment);
