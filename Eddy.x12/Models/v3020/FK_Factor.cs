...
public class FK_Factor : EdiX12Segment
{
	...
	public override ValidationResult Validate()
	{
		...
		validator.Length(x => x.FactorAmount2, 1, 9);
		validator.Length(x => x.FactorAmount3, 1, 9);
		validator.Length(x => x.FactorAmount4, 1, 9);
		validator.Length(x => x.FactorAmount5, 1, 9);
		validator.Length(x => x.FactorAmount6, 1, 9);
		validator.Length(x => x.FactorAmount7, 1, 9);
		validator.Length(x => x.FactorAmount8, 1, 9);
