...
public class G72_AllowanceOrCharge : EdiX12Segment
{
	...
	public override ValidationResult Validate()
	{
		...
		validator.IfOneIsFilled_AllAreRequired(x=>x.AllowanceOrChargeQuantity, x=>x.UnitOfMeasurementCode);
		validator.IfOneIsFilled_AllAreRequired(x=>x.AllowanceOrChargePercent, x=>x.DollarBasisForPercent);
