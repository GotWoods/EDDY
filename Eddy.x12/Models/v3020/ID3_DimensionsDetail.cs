...
public class ID3_DimensionsDetail : EdiX12Segment
{
	...
	public override ValidationResult Validate()
	{
		...
		validator.IfOneIsFilled_AllAreRequired(x=>x.Weight, x=>x.UnitOfMeasurementCode2);
		validator.IfOneIsFilled_AllAreRequired(x=>x.Volume, x=>x.UnitOfMeasurementCode3);
		validator.IfOneIsFilled_AllAreRequired(x=>x.Nesting, x=>x.UnitOfMeasurementCode5);
