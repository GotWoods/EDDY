...
public class ID1_ItemDetailDimensions : EdiX12Segment
{
	...
	public override ValidationResult Validate()
	{
		...
		validator.IfOneIsFilled_AllAreRequired(x=>x.Weight, x=>x.UnitOfMeasurementCode3);
		...
		validator.ARequiresB(x=>x.ReferenceNumber, x=>x.UnitOfMeasurementCode6);
		validator.ARequiresB(x=>x.ReferenceNumber2, x=>x.UnitOfMeasurementCode6);
		validator.ARequiresB(x=>x.ReferenceNumber3, x=>x.UnitOfMeasurementCode6);
