...
public class LAD_LadingDetail : EdiX12Segment
{
	...
	public override ValidationResult Validate()
	{
		...
		validator.IfOneIsFilled_AllAreRequired(x=>x.WeightUnitQualifier, x=>x.UnitWeight);
		validator.IfOneIsFilled_AllAreRequired(x=>x.WeightUnitQualifier2, x=>x.Weight);
