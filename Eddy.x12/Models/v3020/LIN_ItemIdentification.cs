...
public class LIN_ItemIdentification : EdiX12Segment
{
	...
	public override ValidationResult Validate()
	{
		...
		validator.ARequiresB(x=>x.ProductServiceIDQualifier11, x=>x.ProductServiceID11);
		validator.ARequiresB(x=>x.ProductServiceIDQualifier12, x=>x.ProductServiceID12);
		validator.ARequiresB(x=>x.ProductServiceIDQualifier13, x=>x.ProductServiceID13);
		validator.ARequiresB(x=>x.ProductServiceIDQualifier14, x=>x.ProductServiceID14);
		validator.ARequiresB(x=>x.ProductServiceIDQualifier15, x=>x.ProductServiceID15);
		...
		validator.Length(x => x.ProductServiceID11, 1, 30);
		validator.Length(x => x.ProductServiceIDQualifier12, 2);
		validator.Length(x => x.ProductServiceID12, 1, 30);
		validator.Length(x => x.ProductServiceIDQualifier13, 2);
		validator.Length(x => x.ProductServiceID13, 1, 30);
		validator.Length(x => x.ProductServiceIDQualifier14, 2);
		validator.Length(x => x.ProductServiceID14, 1, 30);
		validator.Length(x => x.ProductServiceIDQualifier15, 2);
		validator.Length(x => x.ProductServiceID15, 1, 30);
