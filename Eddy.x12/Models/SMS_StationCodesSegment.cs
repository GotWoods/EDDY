...
public class SMS_StationCodesSegment : EdiX12Segment
{
	...
	public override ValidationResult Validate()
	{
		...
		validator.IfOneIsFilled_AllAreRequired(x=>x.LocationIdentifier, x=>x.LocationIdentifier2);
		validator.IfOneIsFilled_AllAreRequired(x=>x.StandardCarrierAlphaCode2, x=>x.FreightStationAccountingCode2);
