...
public class PR1_PriceRequestParameterList1 : EdiX12Segment
{
	...
	public override ValidationResult Validate()
	{
		...
		validator.ARequiresB(x=>x.LocationIdentifier2, x=>x.LocationQualifier);
		validator.ARequiresB(x=>x.LocationIdentifier3, x=>x.LocationQualifier2);
		validator.ARequiresB(x=>x.LocationIdentifier4, x=>x.LocationQualifier2);
