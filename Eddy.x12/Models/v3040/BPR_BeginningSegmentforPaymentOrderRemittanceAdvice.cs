...
public class BPR_BeginningSegmentForPaymentOrderRemittanceAdvice : EdiX12Segment
{
	...
	[Position(20)]
	public string AccountNumberQualifierCode3 { get; set; }
	...
	public override ValidationResult Validate()
	{
		...
		validator.ARequiresB(x=>x.AccountNumberQualifierCode3, x=>x.AccountNumber3);
		...
		validator.Length(x => x.AccountNumberQualifierCode3, 2);
