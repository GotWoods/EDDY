...
{
	[Position(01)]
	public string InterconnectMailbagVersionNumber { get; set; }
	...
	[Position(12)]
	public string InterconnectMailbagTestIndicator { get; set; }

	public override ValidationResult Validate()
	{
		var validator = new BasicValidator<IH_InterconnectMailbagHeader>(this);
		validator.Required(x=>x.InterconnectMailbagVersionNumber);
		...
		validator.Required(x=>x.InterconnectMailbagTestIndicator);
		validator.Length(x => x.InterconnectMailbagVersionNumber, 5);
		...
		validator.Length(x => x.InterconnectMailbagTestIndicator, 1);
