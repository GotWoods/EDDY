...
public class SDQ_DestinationQuantity : EdiX12Segment
{
	...
	public override ValidationResult Validate()
	{
		...
		validator.ARequiresB(x=>x.IdentificationCode2, x=>x.Quantity2);
		validator.ARequiresB(x=>x.IdentificationCode3, x=>x.Quantity3);
		validator.ARequiresB(x=>x.IdentificationCode4, x=>x.Quantity4);
		validator.ARequiresB(x=>x.IdentificationCode5, x=>x.Quantity5);
		validator.ARequiresB(x=>x.IdentificationCode6, x=>x.Quantity6);
		validator.ARequiresB(x=>x.IdentificationCode7, x=>x.Quantity7);
		validator.ARequiresB(x=>x.IdentificationCode8, x=>x.Quantity8);
		validator.ARequiresB(x=>x.IdentificationCode9, x=>x.Quantity9);
		validator.ARequiresB(x=>x.IdentificationCode10, x=>x.Quantity10);
