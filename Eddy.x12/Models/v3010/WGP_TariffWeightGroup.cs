...
public class WGP_TariffWeightGroup : EdiX12Segment
{
	...
	public override ValidationResult Validate()
	{
		...
		validator.Length(x => x.Weight6, 1, 8);
		validator.Length(x => x.Weight7, 1, 8);
		validator.Length(x => x.Weight8, 1, 8);
		validator.Length(x => x.Weight9, 1, 8);
		validator.Length(x => x.Weight10, 1, 8);
		validator.Length(x => x.Weight11, 1, 8);
		validator.Length(x => x.Weight12, 1, 8);
		validator.Length(x => x.Weight13, 1, 8);
		validator.Length(x => x.Weight14, 1, 8);
		validator.Length(x => x.Weight15, 1, 8);
		validator.Length(x => x.Weight16, 1, 8);
