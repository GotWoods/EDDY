...
public class TR_TariffRate : EdiX12Segment
{
	...
	public override ValidationResult Validate()
	{
		...
		validator.IfOneIsFilled_AllAreRequired(x=>x.UnitOrBasisForMeasurementCode, x=>x.PackagingCode);
		validator.IfOneIsFilled_AllAreRequired(x=>x.QuantityQualifier2, x=>x.Quantity2);
		validator.IfOneIsFilled_AllAreRequired(x=>x.UnitOrBasisForMeasurementCode2, x=>x.PackagingCode2);
