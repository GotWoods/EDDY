...
public class RCD_ReceivingConditions : EdiX12Segment
{
	...
	public override ValidationResult Validate()
	{
		...
		validator.ARequiresB(x=>x.QuantityUnitsReceivedOrAccepted, x=>x.UnitOrBasisForMeasurementCode);
		validator.ARequiresB(x=>x.QuantityUnitsReturned, x=>x.UnitOrBasisForMeasurementCode2);
