...
public class PSC_ProductServiceContract : EdiX12Segment
{
	...
	public override ValidationResult Validate()
	{
		...
		validator.IfOneIsFilled_AllAreRequired(x=>x.UnitOrBasisForMeasurementCode, x=>x.Count);
		validator.IfOneIsFilledThenAtLeastOne(x=>x.UnitOrBasisForMeasurementCode2, x=>x.RangeMaximum, x=>x.RangeMinimum, x=>x.MeasurementValue);
		...
		validator.ARequiresB(x=>x.MeasurementValue, x=>x.UnitOrBasisForMeasurementCode2);
