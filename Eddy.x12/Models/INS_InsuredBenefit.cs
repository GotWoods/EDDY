...
public class INS_InsuredBenefit : EdiX12Segment
{
	...
	[Position(18)]
	public string ChangedIdentifyingInformationCode { get; set; }

	[Position(19)]
	public string ProviderNetworkStatusInformationCode { get; set; }
	...
	public override ValidationResult Validate()
	{
		...
		validator.Length(x => x.ChangedIdentifyingInformationCode, 1, 2);
		validator.Length(x => x.ProviderNetworkStatusInformationCode, 1, 2);
