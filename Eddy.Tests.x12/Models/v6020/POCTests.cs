...
public class POCTests
{
	...
	{
		string x12Line = "POC*I*dZ*7***5*YC*O5*E*pF*8*cj*G*A4*0*Q7*f*06*f*p1*A*qY*K*p2*i*Uv*i";

		var expected = new POC_LineItemChange()
		{
			AssignedIdentification = "I",
			ChangeOrResponseTypeCode = "dZ",
			Quantity = 7,
			ChangeQuantities = null,
			CompositeUnitOfMeasure = null,
			UnitPrice = 5,
			BasisOfUnitPriceCode = "YC",
			ProductServiceIDQualifier = "O5",
			ProductServiceID = "E",
			ProductServiceIDQualifier2 = "pF",
			ProductServiceID2 = "8",
			ProductServiceIDQualifier3 = "cj",
			ProductServiceID3 = "G",
			ProductServiceIDQualifier4 = "A4",
			ProductServiceID4 = "0",
			ProductServiceIDQualifier5 = "Q7",
			ProductServiceID5 = "f",
			ProductServiceIDQualifier6 = "06",
			ProductServiceID6 = "f",
			ProductServiceIDQualifier7 = "p1",
			ProductServiceID7 = "A",
			ProductServiceIDQualifier8 = "qY",
			ProductServiceID8 = "K",
			ProductServiceIDQualifier9 = "p2",
			ProductServiceID9 = "i",
			ProductServiceIDQualifier10 = "Uv",
	...
	[Theory]
	[InlineData("", 0, true)]
	[InlineData("YC", 5, true)]
	[InlineData("YC", 0, false)]
	[InlineData("", 5, true)]
