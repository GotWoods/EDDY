...
public class PAMTests
{
	...
	[Theory]
	[InlineData("", "", true)]
	[InlineData("h9R", "zNb", true)]
	[InlineData("h9R", "", false)]
	[InlineData("", "zNb", true)]
	...
	[Theory]
	[InlineData("", "", "", true)]
	[InlineData("h9R", "6vII7EGt", "zAHH", true)]
	[InlineData("h9R", "", "", false)]
	[InlineData("", "6vII7EGt", "zAHH", true)]
	...
	[Theory]
	[InlineData("", "", true)]
	[InlineData("6vII7EGt", "h9R", true)]
	[InlineData("6vII7EGt", "", false)]
	[InlineData("", "h9R", true)]
	...
	[Theory]
	[InlineData("", "", true)]
	[InlineData("zAHH", "h9R", true)]
	[InlineData("zAHH", "", false)]
	[InlineData("", "h9R", true)]
