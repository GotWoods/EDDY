...
public class BTPTests
{
	...
	{
		string x12Line = "BTP*wQ*G*6dH9OyYF*mm8I*Uk*f5*g*hdlm9B4X*rxVt*VDi";

		var expected = new BTP_BeginningSegmentForTradingPartnerProfile()
		{
			TransactionSetPurposeCode = "wQ",
			ReferenceIdentification = "G",
			Date = "6dH9OyYF",
			Time = "mm8I",
			TransactionTypeCode = "Uk",
			TransactionSetPurposeCode2 = "f5",
			ReferenceIdentification2 = "g",
			Date2 = "hdlm9B4X",
			Time2 = "rxVt",
			PaymentMethodCode = "VDi",
		};
	...
	public void Validation_RequiredTransactionSetPurposeCode(string transactionSetPurposeCode, bool isValidExpected)
	{
		...
		subject.Date = "6dH9OyYF";
		subject.Time = "mm8I";
		subject.TransactionTypeCode = "Uk";
		//Test Parameters
	...
	public void Validation_RequiredReferenceIdentification(string referenceIdentification, bool isValidExpected)
	{
		var subject = new BTP_BeginningSegmentForTradingPartnerProfile();
		//Required fields
		subject.TransactionSetPurposeCode = "wQ";
		subject.Date = "6dH9OyYF";
		subject.Time = "mm8I";
		subject.TransactionTypeCode = "Uk";
		//Test Parameters
	...
	[Theory]
	[InlineData("", "", true)]
	[InlineData("hdlm9B4X", "g", true)]
	[InlineData("hdlm9B4X", "", false)]
	[InlineData("", "g", true)]
	...
	[Theory]
	[InlineData("", "", true)]
	[InlineData("rxVt", "hdlm9B4X", true)]
	[InlineData("rxVt", "", false)]
	[InlineData("", "hdlm9B4X", true)]
