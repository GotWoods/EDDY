...
public class PO1Tests
{
	...
	{
		string x12Line = "PO1*X*2*f7*9*qz*OA*O*VK*d*H1*j*G2*l*8G*U*YJ*O*If*1*yw*t*ro*z*tB*b";
		...
		var expected = new PO1_BaselineItemData()
		{
			...
			UnitPrice = 9,
			BasisOfUnitPriceCode = "qz",
			ProductServiceIDQualifier = "OA",
			ProductServiceID = "O",
			ProductServiceIDQualifier2 = "VK",
			ProductServiceID2 = "d",
			ProductServiceIDQualifier3 = "H1",
			ProductServiceID3 = "j",
			ProductServiceIDQualifier4 = "G2",
			ProductServiceID4 = "l",
			ProductServiceIDQualifier5 = "8G",
			ProductServiceID5 = "U",
			ProductServiceIDQualifier6 = "YJ",
			ProductServiceID6 = "O",
			ProductServiceIDQualifier7 = "If",
			ProductServiceID7 = "1",
			ProductServiceIDQualifier8 = "yw",
			ProductServiceID8 = "t",
			ProductServiceIDQualifier9 = "ro",
			ProductServiceID9 = "z",
			ProductServiceIDQualifier10 = "tB",
	...
	[Theory]
	[InlineData("", 0, true)]
	[InlineData("f7", 2, true)]
	[InlineData("f7", 0, false)]
	[InlineData("", 2, true)]
	public void Validation_ARequiresBUnitOrBasisForMeasurementCode(string unitOrBasisForMeasurementCode, decimal quantityOrdered, bool isValidExpected)
	{
		...
		{
			subject.ProductServiceIDQualifier2 = "VK";
			subject.ProductServiceID2 = "d";
		}
		//If one is filled, all are required
		if(!string.IsNullOrEmpty(subject.ProductServiceIDQualifier3) || !string.IsNullOrEmpty(subject.ProductServiceIDQualifier3) || !string.IsNullOrEmpty(subject.ProductServiceID3))
		{
			subject.ProductServiceIDQualifier3 = "H1";
		...
		{
			subject.ProductServiceIDQualifier4 = "G2";
			subject.ProductServiceID4 = "l";
		}
		//If one is filled, all are required
		...
		{
			subject.ProductServiceIDQualifier5 = "8G";
		...
		{
			subject.ProductServiceIDQualifier6 = "YJ";
			subject.ProductServiceID6 = "O";
		}
		//If one is filled, all are required
		...
		{
			subject.ProductServiceIDQualifier7 = "If";
			subject.ProductServiceID7 = "1";
		}
		//If one is filled, all are required
		...
		{
			subject.ProductServiceIDQualifier8 = "yw";
			subject.ProductServiceID8 = "t";
		}
		//If one is filled, all are required
		...
		{
			subject.ProductServiceIDQualifier9 = "ro";
		...
		{
			subject.ProductServiceIDQualifier10 = "tB";
	...
	[Theory]
	[InlineData("", 0, true)]
	[InlineData("qz", 9, true)]
	[InlineData("qz", 0, false)]
	[InlineData("", 9, true)]
