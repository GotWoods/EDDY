...
public class G39Tests
{
	...
	{
		string x12Line = "G39*8gdsbzPTlhIu*T9*2*EU*1*W*F*2*vW*5*3I*2*mS*7*pj*527263*6*7*1Q*3*3*V*2E*U*t*9*3*dLy*0";

		var expected = new G39_ItemCharacteristicsVendorsSellingUnit()
		{
			UPCCaseCode = "8gdsbzPTlhIu",
			ProductServiceIDQualifier = "T9",
			ProductServiceID = "2",
			SpecialHandlingCode = "EU",
			UnitWeight = 1,
			WeightQualifier = "W",
			WeightUnitCode = "F",
			Height = 2,
			UnitOrBasisForMeasurementCode = "vW",
			Width = 5,
			UnitOrBasisForMeasurementCode2 = "3I",
			Length = 2,
			UnitOrBasisForMeasurementCode3 = "mS",
			Volume = 7,
			UnitOrBasisForMeasurementCode4 = "pj",
			PalletBlockAndTiers = 527263,
			Pack = 6,
			Size = 7,
			UnitOrBasisForMeasurementCode5 = "1Q",
			Color = "3",
			OrderSizingFactor = 3,
			AlternateTiersPerPallet = "V",
			ProductServiceIDQualifier2 = "2E",
			ProductServiceID2 = "U",
			WeightQualifier2 = "t",
			UnitWeight2 = 9,
			InnerPack = 3,
	...
	[Theory]
	[InlineData("", "", false)]
	[InlineData("8gdsbzPTlhIu", "T9", true)]
	[InlineData("8gdsbzPTlhIu", "", true)]
	[InlineData("", "T9", true)]
	public void Validation_AtLeastOneUPCCaseCode(string uPCCaseCode, string productServiceIDQualifier, bool isValidExpected)
	{
		...
		{
			subject.ProductServiceIDQualifier = "T9";
	...
	public void Validation_AllAreRequiredProductServiceIDQualifier(string productServiceIDQualifier, string productServiceID, bool isValidExpected)
	{
		...
		subject.ProductServiceID = productServiceID;
			subject.UPCCaseCode = "8gdsbzPTlhIu";
		//If one is filled, all are required
		if(subject.Height > 0 || subject.Height > 0 || !string.IsNullOrEmpty(subject.UnitOrBasisForMeasurementCode))
		{
			subject.Height = 2;
	...
	[Theory]
	[InlineData(0, "", true)]
	[InlineData(2, "mS", true)]
	[InlineData(2, "", false)]
	[InlineData(0, "mS", false)]
