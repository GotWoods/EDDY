...
public class CDTests
{
	...
	{
		string x12Line = "CD*T4*6Q9O*5*g*m*4*d";

		var expected = new CD_ShipmentConditions()
		{
			ConditionSegmentLogicalConnector = "T4",
			ConditionCode = "6Q9O",
			ConditionValue = "5",
			ConditionValue2 = "g",
			ConditionValue3 = "m",
