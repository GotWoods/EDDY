...
public class BAUTests
{
	...
	{
		string x12Line = "BAU*4*OG9*rc*fKA*U*t";

		var expected = new BAU_BeginningSegmentForTheDebitAuthorization()
		{
			ReferenceIdentification = "4",
			PaymentMethodCode = "OG9",
			DFIIDNumberQualifier = "rc",
			DFIIdentificationNumber = "fKA",
			AccountNumber = "U",
			Name = "t",
		};
	...
	public void Validation_RequiredReferenceIdentification(string referenceIdentification, bool isValidExpected)
	{
		...
		//Required fields
		subject.PaymentMethodCode = "OG9";
		subject.DFIIDNumberQualifier = "rc";
		subject.DFIIdentificationNumber = "fKA";
		subject.AccountNumber = "U";
		//Test Parameters
