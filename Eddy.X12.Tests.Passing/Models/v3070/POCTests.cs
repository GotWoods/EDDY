...
public class POCTests
{
	...
	{
		string x12Line = "POC*b*Y8*6*4**8*7S*Dx*e*9Q*g*4r*k*KV*1*q5*F*3x*H*49*A*1O*Z*lA*D*XG*6";

		var expected = new POC_LineItemChange()
		{
			AssignedIdentification = "b",
			ChangeOrResponseTypeCode = "Y8",
			QuantityOrdered = 6,
			QuantityLeftToReceive = 4,
			CompositeUnitOfMeasure = null,
			UnitPrice = 8,
			BasisOfUnitPriceCode = "7S",
			ProductServiceIDQualifier = "Dx",
			ProductServiceID = "e",
			ProductServiceIDQualifier2 = "9Q",
			ProductServiceID2 = "g",
			ProductServiceIDQualifier3 = "4r",
			ProductServiceID3 = "k",
			ProductServiceIDQualifier4 = "KV",
			ProductServiceID4 = "1",
			ProductServiceIDQualifier5 = "q5",
			ProductServiceID5 = "F",
			ProductServiceIDQualifier6 = "3x",
			ProductServiceID6 = "H",
			ProductServiceIDQualifier7 = "49",
			ProductServiceID7 = "A",
			ProductServiceIDQualifier8 = "1O",
			ProductServiceID8 = "Z",
			ProductServiceIDQualifier9 = "lA",
			ProductServiceID9 = "D",
			ProductServiceIDQualifier10 = "XG",
			ProductServiceID10 = "6",
		};
	...
	public void Validation_RequiredChangeOrResponseTypeCode(string changeOrResponseTypeCode, bool isValidExpected)
	{
		...
		{
			subject.ProductServiceIDQualifier4 = "KV";
		...
		{
			subject.ProductServiceIDQualifier5 = "q5";
		...
		{
			subject.ProductServiceIDQualifier6 = "3x";
		...
		{
			subject.ProductServiceIDQualifier7 = "49";
		...
		{
			subject.ProductServiceIDQualifier8 = "1O";
		...
		{
			subject.ProductServiceIDQualifier9 = "lA";
		...
		{
			subject.ProductServiceIDQualifier10 = "XG";
			subject.ProductServiceID10 = "6";
		}
