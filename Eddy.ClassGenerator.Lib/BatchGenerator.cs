...
public class BatchGenerator
{
    ...
    public async Task Start(string projectBasePath, int batchCount)
    {
        ...
        var ignored = new List<string>() {"ADJ", "B10", "CD", "CTP", "D1", "CUR", "F04", "F07", "FK", "G48", "G62", "G69", "G83", "H6", "L11", "M11", "M6", "MEA", "N12", "RCD", "POC", "NCA", "PID", "PKG", "Q2",  "PSD", "PO4", "SCH", "SDQ", "QTY", "PS", "PR", "SLN", "SHP",  }; //ones that are not generating very well
