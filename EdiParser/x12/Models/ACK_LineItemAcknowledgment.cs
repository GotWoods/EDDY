...
{
    [Position(01)] public string LineItemStatusCode { get; set; }

    [Position(02)] public decimal? Quantity { get; set; }

    [Position(03)] public string UnitOrBasisForMeasurementCode { get; set; }

    [Position(04)] public string DateTimeQualifier { get; set; }

    [Position(05)] public string Date { get; set; }

    [Position(06)] public string RequestReferenceNumber { get; set; }

    [Position(07)] public string ProductServiceIDQualifier { get; set; }

    [Position(08)] public string ProductServiceID { get; set; }

    [Position(09)] public string ProductServiceIDQualifier2 { get; set; }

    [Position(10)] public string ProductServiceID2 { get; set; }

    [Position(11)] public string ProductServiceIDQualifier3 { get; set; }

    [Position(12)] public string ProductServiceID3 { get; set; }

    [Position(13)] public string ProductServiceIDQualifier4 { get; set; }

    [Position(14)] public string ProductServiceID4 { get; set; }

    [Position(15)] public string ProductServiceIDQualifier5 { get; set; }

    [Position(16)] public string ProductServiceID5 { get; set; }

    [Position(17)] public string ProductServiceIDQualifier6 { get; set; }

    [Position(18)] public string ProductServiceID6 { get; set; }

    [Position(19)] public string ProductServiceIDQualifier7 { get; set; }

    [Position(20)] public string ProductServiceID7 { get; set; }

    [Position(21)] public string ProductServiceIDQualifier8 { get; set; }

    [Position(22)] public string ProductServiceID8 { get; set; }

    [Position(23)] public string ProductServiceIDQualifier9 { get; set; }

    [Position(24)] public string ProductServiceID9 { get; set; }

    [Position(25)] public string ProductServiceIDQualifier10 { get; set; }

    [Position(26)] public string ProductServiceID10 { get; set; }

    [Position(27)] public string AgencyQualifierCode { get; set; }

    [Position(28)] public string SourceSubqualifier { get; set; }

    [Position(29)] public string IndustryCode { get; set; }
