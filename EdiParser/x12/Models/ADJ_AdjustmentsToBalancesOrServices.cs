...
{
    [Position(01)] public string AdjustmentApplicationCode { get; set; }

    [Position(02)] public decimal? MonetaryAmount { get; set; }

    [Position(03)] public decimal? MonetaryAmount2 { get; set; }

    [Position(04)] public string Date { get; set; }

    [Position(05)] public string Date2 { get; set; }

    [Position(06)] public int? Number { get; set; }

    [Position(07)] public string Description { get; set; }

    [Position(08)] public string ProductServiceIDQualifier { get; set; }

    [Position(09)] public string ProductServiceID { get; set; }

    [Position(10)] public string Amount { get; set; }

    [Position(11)] public string Amount2 { get; set; }

    [Position(12)] public string Amount3 { get; set; }

    [Position(13)] public decimal? Quantity { get; set; }

    [Position(14)] public decimal? Quantity2 { get; set; }

    [Position(15)] public decimal? Quantity3 { get; set; }

    [Position(16)] public string ReferenceIdentificationQualifier { get; set; }

    [Position(17)] public string ReferenceIdentification { get; set; }
