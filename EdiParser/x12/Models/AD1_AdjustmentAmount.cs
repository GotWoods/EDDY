...
{
    [Position(01)] public string AdjustmentReasonCode { get; set; }

    [Position(02)] public decimal? MonetaryAmount { get; set; }

    [Position(03)] public string AdjustmentReasonCodeCharacteristic { get; set; }

    [Position(04)] public string FrequencyCode { get; set; }

    [Position(05)] public string LateReasonCode { get; set; }
