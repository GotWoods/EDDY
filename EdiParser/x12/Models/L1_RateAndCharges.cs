...
public class L1_RateAndCharges : EdiX12Segment
{
    ...
    [Position(02)] public decimal? FreightRate { get; set; }

    [Position(03)] public string RateValueQualifier { get; set; }

    [Position(04)] public string AmountCharged { get; set; }

    [Position(05)] public string Advances { get; set; }

    [Position(06)] public string PrepaidAmount { get; set; }

    [Position(07)] public string RateCombinationPointCode { get; set; }

    [Position(08)] public string SpecialChargeOrAllowanceCode { get; set; }

    [Position(09)] public string RateClassCode { get; set; }

    [Position(10)] public string EntitlementCode { get; set; }

    [Position(11)] public string ChargeMethodOfPaymentCode { get; set; }

    [Position(12)] public string SpecialChargeDescription { get; set; }

    [Position(13)] public string TariffApplicationCode { get; set; }

    [Position(14)] public string DeclaredValue { get; set; }

    [Position(15)] public string RateValueQualifier2 { get; set; }

    [Position(16)] public string LadingLiabilityCode { get; set; }

    [Position(17)] public string BilledRatedAsQuantity { get; set; }

    [Position(18)] public string BilledRatedAsQualifier { get; set; }

    [Position(19)] public string PercentageAsDecimal { get; set; }

    [Position(20)] public string CurrencyCode { get; set; }

    [Position(21)] public string Amount { get; set; }

    [Position(22)] public string LadingValue { get; set; }
    ...
    public override ValidationResult Validate()
    {
        ...
        validator.AtLeastOneIsRequired(x => x.AmountCharged, x => x.Advances, x => x.PrepaidAmount);
