...
namespace Eddy.x12.DomainModels.Finance.v7040._833;

public class LCRO__LLX__LN1__LCDA_LIN1 {
	...
	{
		var validator = new TransactionValidator<LCRO__LLX__LN1__LCDA_LIN1>(this);
