...
namespace Eddy.x12.DomainModels.Finance.v5020._811;

public class LHL__LSLN_LNM1 {
	...
	{
		var validator = new TransactionValidator<LHL__LSLN_LNM1>(this);
		validator.Required(x => x.IndividualOrOrganizationalName);
		validator.CollectionSize(x => x.AdditionalNameInformation, 0, 2);
		validator.CollectionSize(x => x.PartyLocation, 0, 2);
		validator.CollectionSize(x => x.ReferenceInformation, 0, 8);
