...
namespace Eddy.x12.DomainModels.Finance.v5020._823;

public class LDEP__LBAT__LBPR__LRMR_LIT1 {
	[SectionPosition(1)] public IT1_BaselineItemDataInvoice BaselineItemDataInvoice { get; set; } = new();
	[SectionPosition(2)] public List<LDEP__LBAT__LBPR__LRMR__LIT1_LREF> LREF {get;set;} = new();
	[SectionPosition(3)] public List<LDEP__LBAT__LBPR__LRMR__LIT1_LSAC> LSAC {get;set;} = new();
	[SectionPosition(4)] public List<LDEP__LBAT__LBPR__LRMR__LIT1_LSLN> LSLN {get;set;} = new();
	public ValidationResult Validate()
	{
		var validator = new TransactionValidator<LDEP__LBAT__LBPR__LRMR_LIT1>(this);
