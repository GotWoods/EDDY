...
namespace Eddy.x12.DomainModels.Finance.v5020._196;
...
public class LN1 {
	...
	[SectionPosition(5)] public List<LN1_LG61> LG61 {get;set;} = new();
	public ValidationResult Validate()
	{
		...
		validator.CollectionSize(x => x.LG61, 1, 2147483647);
