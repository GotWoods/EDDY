...
using Eddy.x12.DomainModels.Finance.v5040._810;
...
public class Edi810_Invoice {
	...
	[SectionPosition(21)] public List<LLM> LLM {get;set;} = new();
	[SectionPosition(22)] public List<LN9> LN9 {get;set;} = new();
	[SectionPosition(23)] public List<LV1> LV1 {get;set;} = new();
	[SectionPosition(24)] public List<LFA1> LFA1 {get;set;} = new();

	//Details
	[SectionPosition(25)] public List<LIT1> LIT1 {get;set;} = new();

	//Summary
	[SectionPosition(26)] public TDS_TotalMonetaryValueSummary TotalMonetaryValueSummary { get; set; } = new();
	[SectionPosition(27)] public List<TXI_TaxInformation> TaxInformation { get; set; } = new();
	[SectionPosition(28)] public CAD_CarrierDetails? CarrierDetails { get; set; }
	[SectionPosition(29)] public List<AMT_MonetaryAmountInformation> MonetaryAmountInformation { get; set; } = new();
	[SectionPosition(30)] public List<LSAC> LSAC {get;set;} = new();
	[SectionPosition(31)] public List<LISS> LISS {get;set;} = new();
	[SectionPosition(32)] public CTT_TransactionTotals? TransactionTotals { get; set; }
