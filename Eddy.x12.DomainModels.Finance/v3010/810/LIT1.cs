...
public class LIT1 {
	...
	[SectionPosition(3)] public List<IT3_AdditionalItemData> AdditionalItemData { get; set; } = new();
	...
	[SectionPosition(7)] public List<LIT1_LPID> LPID {get;set;} = new();
	[SectionPosition(8)] public List<PWK_Paperwork> Paperwork { get; set; } = new();
	[SectionPosition(9)] public List<PKG_MarkingPackagingLoading> MarkingPackagingLoading { get; set; } = new();
	[SectionPosition(10)] public PO4_ItemPhysicalDetails? ItemPhysicalDetails { get; set; }
	[SectionPosition(11)] public List<ITD_TermsOfSaleDeferredTermsOfSale> TermsOfSaleDeferredTermsOfSale { get; set; } = new();
	[SectionPosition(12)] public List<REF_ReferenceNumbers> ReferenceNumbers { get; set; } = new();
	[SectionPosition(13)] public List<PER_AdministrativeCommunicationsContact> AdministrativeCommunicationsContact { get; set; } = new();
	[SectionPosition(14)] public List<SDQ_DestinationQuantity> DestinationQuantity { get; set; } = new();
	[SectionPosition(15)] public List<DTM_DateTimeReference> DateTimeReference { get; set; } = new();
	[SectionPosition(16)] public List<CAD_CarrierDetail> CarrierDetail { get; set; } = new();
	[SectionPosition(17)] public List<L7_TariffReference> TariffReference { get; set; } = new();
	[SectionPosition(18)] public List<LIT1_LITA> LITA {get;set;} = new();
	[SectionPosition(19)] public List<LIT1_LSLN> LSLN {get;set;} = new();
	[SectionPosition(20)] public List<LIT1_LN1> LN1 {get;set;} = new();
