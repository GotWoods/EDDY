...
using Eddy.x12.DomainModels.Finance.v3010._822;
...
public class Edi822_CustomerAccountAnalysis {
	...
	[SectionPosition(10)] public RTE_RateInformation? RateInformation { get; set; }
	...
	//Summary
	[SectionPosition(13)] public CTT_TransactionTotals TransactionTotals { get; set; } = new();
