...
public class LN1 {
	...
	[SectionPosition(8)] public CUR_Currency? Currency { get; set; }
	[SectionPosition(9)] public List<RTE_RateInformation> RateInformation { get; set; } = new();
	[SectionPosition(10)] public List<LN1_LACT> LACT {get;set;} = new();
	public ValidationResult Validate()
	{
		...
		validator.CollectionSize(x => x.LACT, 0, 500);
