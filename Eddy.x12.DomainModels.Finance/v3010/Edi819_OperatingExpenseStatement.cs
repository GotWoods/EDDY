...
using Eddy.x12.DomainModels.Finance.v3010._819;
...
public class Edi819_OperatingExpenseStatement {
	...
	[SectionPosition(5)] public List<ITD_TermsOfSaleDeferredTermsOfSale> TermsOfSaleDeferredTermsOfSale { get; set; } = new();
	...
	[SectionPosition(8)] public List<LPSA> LPSA {get;set;} = new();
	[SectionPosition(9)] public CTT_TransactionTotals TransactionTotals { get; set; } = new();
	...
	public ValidationResult Validate()
	{
		...
		validator.CollectionSize(x => x.LPSA, 1, 1000);
