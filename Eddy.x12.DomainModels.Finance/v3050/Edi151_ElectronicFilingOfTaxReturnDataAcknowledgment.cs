...
using Eddy.x12.DomainModels.Finance.v3050._151;
...
public class Edi151_ElectronicFilingOfTaxReturnDataAcknowledgment {
	...
	[SectionPosition(6)] public List<PBI_ProblemIdentification> ProblemIdentification { get; set; } = new();

	//Details
	[SectionPosition(7)] public List<LTFS> LTFS {get;set;} = new();
