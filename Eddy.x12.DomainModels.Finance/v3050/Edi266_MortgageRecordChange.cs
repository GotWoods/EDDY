...
using Eddy.x12.DomainModels.Finance.v3050._266;

namespace Eddy.x12.DomainModels.Finance.v3050;

public class Edi266_MortgageRecordChange {
	...
	{
		var validator = new TransactionValidator<Edi266_MortgageRecordChange>(this);
