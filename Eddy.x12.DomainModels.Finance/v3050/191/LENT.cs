...
namespace Eddy.x12.DomainModels.Finance.v3050._191;
...
public class LENT {
	...
	[SectionPosition(9)] public ENR_SchoolEnrollmentInformation? SchoolEnrollmentInformation { get; set; }
	[SectionPosition(10)] public List<LENT_LIN1> LIN1 {get;set;} = new();
