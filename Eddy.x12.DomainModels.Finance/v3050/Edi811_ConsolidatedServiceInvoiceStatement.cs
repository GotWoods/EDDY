...
using Eddy.x12.DomainModels.Finance.v3050._811;
...
public class Edi811_ConsolidatedServiceInvoiceStatement {
	...
	//Details
	[SectionPosition(11)] public List<LHL> LHL {get;set;} = new();

	//Summary
	[SectionPosition(12)] public TDS_TotalMonetaryValueSummary TotalMonetaryValueSummary { get; set; } = new();
	[SectionPosition(13)] public List<LITA> LITA {get;set;} = new();
	[SectionPosition(14)] public List<LBAL> LBAL {get;set;} = new();
	[SectionPosition(15)] public List<LN1> LN12 {get;set;} = new();
	[SectionPosition(16)] public CTT_TransactionTotals? TransactionTotals { get; set; }
