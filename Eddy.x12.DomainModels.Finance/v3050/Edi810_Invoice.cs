...
using Eddy.x12.DomainModels.Finance.v3050._810;
...
public class Edi810_Invoice {
	...
	[SectionPosition(19)] public List<LLM> LLM {get;set;} = new();
	[SectionPosition(20)] public List<LN9> LN9 {get;set;} = new();
	[SectionPosition(21)] public List<LV1> LV1 {get;set;} = new();

	//Details
	[SectionPosition(22)] public List<LIT1> LIT1 {get;set;} = new();

	//Summary
	[SectionPosition(23)] public TDS_TotalMonetaryValueSummary TotalMonetaryValueSummary { get; set; } = new();
	[SectionPosition(24)] public List<TXI_TaxInformation> TaxInformation { get; set; } = new();
	[SectionPosition(25)] public CAD_CarrierDetail? CarrierDetail { get; set; }
	[SectionPosition(26)] public List<LSAC> LSAC {get;set;} = new();
	[SectionPosition(27)] public List<LISS> LISS {get;set;} = new();
	[SectionPosition(28)] public CTT_TransactionTotals TransactionTotals { get; set; } = new();
	[SectionPosition(29)] public SE_TransactionSetTrailer TransactionSetTrailer { get; set; } = new();
