...
public class LIT1 {
	...
	[SectionPosition(15)] public List<REF_ReferenceNumbers> ReferenceNumbers { get; set; } = new();
	[SectionPosition(16)] public List<PER_AdministrativeCommunicationsContact> AdministrativeCommunicationsContact { get; set; } = new();
	[SectionPosition(17)] public List<SDQ_DestinationQuantity> DestinationQuantity { get; set; } = new();
	[SectionPosition(18)] public List<DTM_DateTimeReference> DateTimeReference { get; set; } = new();
	[SectionPosition(19)] public List<CAD_CarrierDetail> CarrierDetail { get; set; } = new();
	[SectionPosition(20)] public List<L7_TariffReference> TariffReference { get; set; } = new();
	[SectionPosition(21)] public SR_RequestedServiceSchedule? RequestedServiceSchedule { get; set; }
	[SectionPosition(22)] public List<LIT1_LSAC> LSAC {get;set;} = new();
	[SectionPosition(23)] public List<LIT1_LSLN> LSLN {get;set;} = new();
	[SectionPosition(24)] public List<LIT1_LN1> LN1 {get;set;} = new();
	[SectionPosition(25)] public List<LIT1_LLM> LLM {get;set;} = new();
	[SectionPosition(26)] public List<LIT1_LV1> LV1 {get;set;} = new();
