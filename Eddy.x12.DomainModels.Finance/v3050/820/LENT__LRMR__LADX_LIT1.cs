...
namespace Eddy.x12.DomainModels.Finance.v3050._820;

public class LENT__LRMR__LADX_LIT1 {
	[SectionPosition(1)] public IT1_BaselineItemDataInvoice BaselineItemDataInvoice { get; set; } = new();
	[SectionPosition(2)] public List<LENT__LRMR__LADX__LIT1_LREF> LREF {get;set;} = new();
	[SectionPosition(3)] public List<LENT__LRMR__LADX__LIT1_LSAC> LSAC {get;set;} = new();
	[SectionPosition(4)] public List<LENT__LRMR__LADX__LIT1_LSLN> LSLN {get;set;} = new();
	public ValidationResult Validate()
	{
		var validator = new TransactionValidator<LENT__LRMR__LADX_LIT1>(this);
