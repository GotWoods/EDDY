...
using Eddy.x12.DomainModels.Finance.v3050._200;
...
public class Edi200_MortgageCreditReport {
	...
	[SectionPosition(9)] public List<NX2_RealEstatePropertyIDComponent> RealEstatePropertyIDComponent { get; set; } = new();
