...
using Eddy.x12.DomainModels.Finance.v7030._810;
...
public class Edi810_Invoice {
	...
	[SectionPosition(17)] public List<BAL_BalanceDetail> BalanceDetail { get; set; } = new();
	[SectionPosition(18)] public INC_InstallmentInformation? InstallmentInformation { get; set; }
	[SectionPosition(19)] public List<PAM_PeriodAmount> PeriodAmount { get; set; } = new();
	[SectionPosition(20)] public CRC_ConditionsIndicator? ConditionsIndicator { get; set; }
	[SectionPosition(21)] public List<MTX_Text> Text { get; set; } = new();
	[SectionPosition(22)] public List<LLM> LLM {get;set;} = new();
	[SectionPosition(23)] public List<LN9> LN9 {get;set;} = new();
	[SectionPosition(24)] public List<LV1> LV1 {get;set;} = new();
	[SectionPosition(25)] public List<LFA1> LFA1 {get;set;} = new();

	//Details
	[SectionPosition(26)] public List<LIT1> LIT1 {get;set;} = new();

	//Summary
	[SectionPosition(27)] public TDS_TotalMonetaryValueSummary TotalMonetaryValueSummary { get; set; } = new();
	[SectionPosition(28)] public List<TXI_TaxInformation> TaxInformation { get; set; } = new();
	[SectionPosition(29)] public CAD_CarrierDetails? CarrierDetails { get; set; }
	[SectionPosition(30)] public List<AMT_MonetaryAmountInformation> MonetaryAmountInformation { get; set; } = new();
	[SectionPosition(31)] public List<LSAC> LSAC {get;set;} = new();
	[SectionPosition(32)] public List<LISS> LISS {get;set;} = new();
	[SectionPosition(33)] public CTT_TransactionTotals? TransactionTotals { get; set; }
