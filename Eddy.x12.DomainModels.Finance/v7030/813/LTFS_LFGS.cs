...
namespace Eddy.x12.DomainModels.Finance.v7030._813;
...
public class LTFS_LFGS {
	...
	[SectionPosition(4)] public List<LTFS__LFGS_LN1> LN1 {get;set;} = new();
	[SectionPosition(5)] public List<LTFS__LFGS_LTIA> LTIA {get;set;} = new();
