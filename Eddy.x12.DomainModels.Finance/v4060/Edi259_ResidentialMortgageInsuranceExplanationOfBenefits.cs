...
using Eddy.x12.DomainModels.Finance.v4060._259;

namespace Eddy.x12.DomainModels.Finance.v4060;

public class Edi259_ResidentialMortgageInsuranceExplanationOfBenefits {
	...
	{
		var validator = new TransactionValidator<Edi259_ResidentialMortgageInsuranceExplanationOfBenefits>(this);
