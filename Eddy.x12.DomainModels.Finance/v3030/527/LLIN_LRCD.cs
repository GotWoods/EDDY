...
public class LLIN_LRCD {
	...
	[SectionPosition(4)] public AT_FinancialAccounting? FinancialAccounting { get; set; }
	...
	public ValidationResult Validate()
	{
		...
		validator.CollectionSize(x => x.LREF, 0, 5000);
		validator.CollectionSize(x => x.LQTY, 0, 100);
