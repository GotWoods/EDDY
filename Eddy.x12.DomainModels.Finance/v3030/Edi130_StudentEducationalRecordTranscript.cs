...
using Eddy.x12.DomainModels.Finance.v3030._130;
...
public class Edi130_StudentEducationalRecordTranscript {
	...
	[SectionPosition(7)] public List<PCL_PreviousCollege> PreviousCollege { get; set; } = new();
	...
	[SectionPosition(10)] public List<LIN1> LIN1 {get;set;} = new();
	[SectionPosition(11)] public List<LSST> LSST {get;set;} = new();
	[SectionPosition(12)] public List<LTST> LTST {get;set;} = new();
	[SectionPosition(13)] public List<LSUM> LSUM {get;set;} = new();
