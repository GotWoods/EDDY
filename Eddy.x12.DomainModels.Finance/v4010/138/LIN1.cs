...
namespace Eddy.x12.DomainModels.Finance.v4010._138;
...
public class LIN1 {
	...
	[SectionPosition(10)] public List<RQS_RequestForInformation> RequestForInformation { get; set; } = new();
	[SectionPosition(11)] public List<SCA_StatisticalCategoryAnalysis> StatisticalCategoryAnalysis { get; set; } = new();
	[SectionPosition(12)] public List<LIN1_LEMS> LEMS {get;set;} = new();
