...
public class LLX_LLRQ {
	...
	[SectionPosition(3)] public PRD_MortgageLoanProductDescription MortgageLoanProductDescription { get; set; } = new();
	...
	[SectionPosition(11)] public List<LLX__LLRQ_LSCM> LSCM {get;set;} = new();
	[SectionPosition(12)] public List<LLX__LLRQ_LNX1> LNX1 {get;set;} = new();
	[SectionPosition(13)] public List<LLX__LLRQ_LIN1> LIN1 {get;set;} = new();
	[SectionPosition(14)] public List<LLX__LLRQ_LREA> LREA {get;set;} = new();
	[SectionPosition(15)] public List<LLX__LLRQ_LMCD> LMCD {get;set;} = new();
	[SectionPosition(16)] public List<LLX__LLRQ_LBUY> LBUY {get;set;} = new();
	[SectionPosition(17)] public List<LLX__LLRQ_LPRJ> LPRJ {get;set;} = new();
	public ValidationResult Validate()
	{
		var validator = new TransactionValidator<LLX_LLRQ>(this);
		...
		validator.CollectionSize(x => x.MortgageInsuranceCoverage, 1, 5);
