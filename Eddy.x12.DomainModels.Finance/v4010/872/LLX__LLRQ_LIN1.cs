...
public class LLX__LLRQ_LIN1 {
	...
	[SectionPosition(8)] public List<LLX__LLRQ__LIN1_LSCM> LSCM {get;set;} = new();
	[SectionPosition(9)] public List<LLX__LLRQ__LIN1_LNX1> LNX1 {get;set;} = new();
	public ValidationResult Validate()
	{
		var validator = new TransactionValidator<LLX__LLRQ_LIN1>(this);
