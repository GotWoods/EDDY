...
namespace Eddy.x12.DomainModels.Finance.v4010._201;
...
public class LLRQ {
	...
	[SectionPosition(6)] public III_Information? Information { get; set; }
	...
	[SectionPosition(11)] public List<LLRQ_LNX1> LNX1 {get;set;} = new();
	[SectionPosition(12)] public List<LLRQ_LPEX> LPEX {get;set;} = new();
	[SectionPosition(13)] public List<LLRQ_LAMT> LAMT {get;set;} = new();
	[SectionPosition(14)] public List<LLRQ_LIN1> LIN1 {get;set;} = new();
	[SectionPosition(15)] public List<LLRQ_LLX> LLX {get;set;} = new();
	public ValidationResult Validate()
	{
		var validator = new TransactionValidator<LLRQ>(this);
		validator.Required(x => x.MortgageCharacteristicsRequested);
		validator.CollectionSize(x => x.ReferenceIdentification, 1, 3);
