...
namespace Eddy.x12.DomainModels.Finance.v4010._200;
...
public class LRO {
	...
	[SectionPosition(6)] public List<LRO_LAMT> LAMT {get;set;} = new();
	[SectionPosition(7)] public List<LRO_LN1> LN1 {get;set;} = new();
