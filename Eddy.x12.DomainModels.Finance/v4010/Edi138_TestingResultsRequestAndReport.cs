...
using Eddy.x12.DomainModels.Finance.v4010._138;

namespace Eddy.x12.DomainModels.Finance.v4010;

public class Edi138_TestingResultsRequestAndReport {
	...
	{
		var validator = new TransactionValidator<Edi138_TestingResultsRequestAndReport>(this);
