...
namespace Eddy.x12.DomainModels.Finance.v4010._833;
...
public class LCRO__LLX_LN1 {
	...
	[SectionPosition(7)] public List<LCRO__LLX__LN1_LEMP> LEMP {get;set;} = new();
	[SectionPosition(8)] public List<LCRO__LLX__LN1_LFAA> LFAA {get;set;} = new();
	[SectionPosition(9)] public List<LCRO__LLX__LN1_LCDA> LCDA {get;set;} = new();
