...
public class LLX__LSES_LCRS {
	...
	[SectionPosition(4)] public List<RAP_RequirementAttributeAndProficiency> RequirementAttributeAndProficiency { get; set; } = new();
	...
	public ValidationResult Validate()
	{
		...
		validator.CollectionSize(x => x.RequirementAttributeAndProficiency, 0, 5);
