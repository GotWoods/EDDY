...
public class LCRO_LLX {
	...
	[SectionPosition(8)] public List<LCRO__LLX_LREA> LREA {get;set;} = new();
	[SectionPosition(9)] public List<LCRO__LLX_LIN1> LIN1 {get;set;} = new();
	[SectionPosition(10)] public List<LCRO__LLX_LNX1> LNX1 {get;set;} = new();
	[SectionPosition(11)] public List<LCRO__LLX_LN1> LN1 {get;set;} = new();
	public ValidationResult Validate()
	{
		...
		validator.CollectionSize(x => x.CivilActionIncome, 0, 10);
