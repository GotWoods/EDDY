...
using Eddy.x12.DomainModels.Finance.v3040._833;

namespace Eddy.x12.DomainModels.Finance.v3040;

public class Edi833_ResidentialMortgageCreditReportOrder {
	...
	{
		var validator = new TransactionValidator<Edi833_ResidentialMortgageCreditReportOrder>(this);
