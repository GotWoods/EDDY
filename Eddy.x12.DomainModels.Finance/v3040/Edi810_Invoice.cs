...
using Eddy.x12.DomainModels.Finance.v3040._810;
...
public class Edi810_Invoice {
	...
	[SectionPosition(18)] public List<LLM> LLM {get;set;} = new();
	[SectionPosition(19)] public List<LN9> LN9 {get;set;} = new();

	//Details
	[SectionPosition(20)] public List<LIT1> LIT1 {get;set;} = new();

	//Summary
	[SectionPosition(21)] public TDS_TotalMonetaryValueSummary TotalMonetaryValueSummary { get; set; } = new();
	[SectionPosition(22)] public List<TXI_TaxInformation> TaxInformation { get; set; } = new();
	[SectionPosition(23)] public CAD_CarrierDetail? CarrierDetail { get; set; }
	[SectionPosition(24)] public List<LSAC> LSAC {get;set;} = new();
	[SectionPosition(25)] public List<ISS_InvoiceShipmentSummary> InvoiceShipmentSummary { get; set; } = new();
	[SectionPosition(26)] public CTT_TransactionTotals TransactionTotals { get; set; } = new();
