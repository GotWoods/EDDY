...
using Eddy.x12.DomainModels.Finance.v3040._880;
...
public class Edi880_GroceryProductsInvoice {
	...
	[SectionPosition(7)] public List<G27_CarrierDetail> CarrierDetail { get; set; } = new();
	[SectionPosition(8)] public List<G23_TermsOfSale> TermsOfSale { get; set; } = new();
	[SectionPosition(9)] public G25_FOBInformation FOBInformation { get; set; } = new();
	[SectionPosition(10)] public List<L0100> L0100 {get;set;} = new();
	[SectionPosition(11)] public List<L0200> L0200 {get;set;} = new();

	//Details
	[SectionPosition(12)] public List<L0300> L0300 {get;set;} = new();

	//Summary
	[SectionPosition(13)] public G31_TotalInvoiceQuantity TotalInvoiceQuantity { get; set; } = new();
	[SectionPosition(14)] public G33_TotalDollarsSummary TotalDollarsSummary { get; set; } = new();
	...
	public ValidationResult Validate()
	{
		...
		validator.CollectionSize(x => x.CarrierDetail, 0, 5);
		validator.CollectionSize(x => x.TermsOfSale, 0, 20);
		validator.Required(x => x.FOBInformation);
		...
		validator.CollectionSize(x => x.L0300, 1, 9999);
