...
using Eddy.x12.DomainModels.Finance.v3040._135;
...
public class Edi135_StudentLoanApplication {
	...
	[SectionPosition(3)] public SLI_SpecificLoanInformation SpecificLoanInformation { get; set; } = new();
	[SectionPosition(4)] public List<DB_DisbursementInformation> DisbursementInformation { get; set; } = new();
	[SectionPosition(5)] public DEF_DefermentInformation? DefermentInformation { get; set; }
