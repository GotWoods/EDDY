...
namespace Eddy.x12.DomainModels.Finance.v3040._880;
...
public class L0300 {
	...
	[SectionPosition(3)] public G19_LineItemDetailQuantityUnitOfMeasurePriceDifferences? LineItemDetailQuantityUnitOfMeasurePriceDifferences { get; set; }
	[SectionPosition(4)] public G20_ItemPackingDetail? ItemPackingDetail { get; set; }
	[SectionPosition(5)] public List<G23_TermsOfSale> TermsOfSale { get; set; } = new();
	[SectionPosition(6)] public G25_FOBInformation? FOBInformation { get; set; }
