...
namespace Eddy.x12.DomainModels.Finance.v4030._150;

public class LTFS_LTRS {
	...
	[SectionPosition(4)] public List<LTFS__LTRS_LN1> LN1 {get;set;} = new();
	public ValidationResult Validate()
	{
		var validator = new TransactionValidator<LTFS_LTRS>(this);
