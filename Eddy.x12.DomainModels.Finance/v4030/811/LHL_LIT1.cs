...
public class LHL_LIT1 {
	...
	[SectionPosition(10)] public CAD_CarrierDetail? CarrierDetail { get; set; }
	[SectionPosition(11)] public List<YNQ_YesNoQuestion> YesNoQuestion { get; set; } = new();
	[SectionPosition(12)] public List<LHL__LIT1_LAMT> LAMT {get;set;} = new();
	[SectionPosition(13)] public List<LHL__LIT1_LQTY> LQTY {get;set;} = new();
	[SectionPosition(14)] public List<LHL__LIT1_LITA> LITA {get;set;} = new();
	[SectionPosition(15)] public List<LHL__LIT1_LNM1> LNM1 {get;set;} = new();
	public ValidationResult Validate()
	{
		...
		validator.CollectionSize(x => x.ReferenceIdentification, 0, 8);
