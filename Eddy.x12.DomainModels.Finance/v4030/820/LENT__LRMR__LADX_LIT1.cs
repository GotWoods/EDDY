...
namespace Eddy.x12.DomainModels.Finance.v4030._820;
...
public class LENT__LRMR__LADX_LIT1 {
	...
	[SectionPosition(4)] public List<LENT__LRMR__LADX__LIT1_LREF> LREF {get;set;} = new();
	[SectionPosition(5)] public List<LENT__LRMR__LADX__LIT1_LSAC> LSAC {get;set;} = new();
	[SectionPosition(6)] public List<LENT__LRMR__LADX__LIT1_LSLN> LSLN {get;set;} = new();
