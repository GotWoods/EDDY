...
public class LENT__LRMR__LADX__LIT1_LSLN {
	[SectionPosition(1)] public SLN_SublineItemDetail SublineItemDetail { get; set; } = new();
	[SectionPosition(2)] public List<LENT__LRMR__LADX__LIT1__LSLN_LREF> LREF {get;set;} = new();
	[SectionPosition(3)] public List<LENT__LRMR__LADX__LIT1__LSLN_LSAC> LSAC {get;set;} = new();
	public ValidationResult Validate()
	{
		var validator = new TransactionValidator<LENT__LRMR__LADX__LIT1_LSLN>(this);
