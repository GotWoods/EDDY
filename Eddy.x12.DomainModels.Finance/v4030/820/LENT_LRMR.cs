...
public class LENT_LRMR {
	...
	[SectionPosition(6)] public List<LENT__LRMR_LIT1> LIT1 {get;set;} = new();
	[SectionPosition(7)] public List<LENT__LRMR_LADX> LADX {get;set;} = new();
	[SectionPosition(8)] public List<LENT__LRMR_LFA1> LFA1 {get;set;} = new();
