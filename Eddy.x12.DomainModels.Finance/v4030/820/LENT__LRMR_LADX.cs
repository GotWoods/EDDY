...
public class LENT__LRMR_LADX {
	...
	[SectionPosition(4)] public List<LENT__LRMR__LADX_LREF> LREF {get;set;} = new();
	[SectionPosition(5)] public List<LENT__LRMR__LADX_LIT1> LIT1 {get;set;} = new();
	public ValidationResult Validate()
	{
		var validator = new TransactionValidator<LENT__LRMR_LADX>(this);
