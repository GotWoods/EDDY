...
using Eddy.x12.DomainModels.Finance.v4030._819;
...
public class Edi819_JointInterestBillingAndOperatingExpenseStatement {
	...
	[SectionPosition(2)] public BOS_BeginningSegmentForTheOperatingExpenseStatement BeginningSegmentForJointInterestBillingAndOperatingExpenseStatement { get; set; } = new();
