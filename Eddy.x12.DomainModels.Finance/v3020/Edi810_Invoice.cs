...
using Eddy.x12.DomainModels.Finance.v3020._810;
...
public class Edi810_Invoice {
	...
	//Details
	[SectionPosition(16)] public List<LIT1> LIT1 {get;set;} = new();

	//Summary
	[SectionPosition(17)] public TDS_TotalMonetaryValueSummary TotalMonetaryValueSummary { get; set; } = new();
	[SectionPosition(18)] public List<TXI_TaxInformation> TaxInformation { get; set; } = new();
	[SectionPosition(19)] public CAD_CarrierDetail? CarrierDetail { get; set; }
	[SectionPosition(20)] public List<LITA> LITA {get;set;} = new();
	[SectionPosition(21)] public List<ISS_InvoiceShipmentSummary> InvoiceShipmentSummary { get; set; } = new();
	[SectionPosition(22)] public CTT_TransactionTotals TransactionTotals { get; set; } = new();
