...
namespace Eddy.x12.DomainModels.Finance.v3020._844;
...
public class LCON_LPAD {
	...
	[SectionPosition(9)] public List<REF_ReferenceNumbers> ReferenceNumbers { get; set; } = new();
	...
	[SectionPosition(12)] public SSS_SpecialServices? SpecialServices { get; set; }
