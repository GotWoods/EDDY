...
using Eddy.x12.DomainModels.Finance.v6050._198;

namespace Eddy.x12.DomainModels.Finance.v6050;

public class Edi198_LoanVerificationInformation {
	[SectionPosition(1)] public ST_TransactionSetHeader TransactionSetHeader { get; set; } = new();
	[SectionPosition(2)] public BGN_BeginningSegment BeginningSegment { get; set; } = new();
	[SectionPosition(3)] public List<LN1> LN1 {get;set;} = new();

	//Details
	[SectionPosition(4)] public List<LIN1> LIN1 {get;set;} = new();
	...
	{
		var validator = new TransactionValidator<Edi198_LoanVerificationInformation>(this);
