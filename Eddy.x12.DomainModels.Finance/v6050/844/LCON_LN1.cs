...
namespace Eddy.x12.DomainModels.Finance.v6050._844;

public class LCON_LN1 {
	...
	[SectionPosition(7)] public List<LCON__LN1_LSII> LSII {get;set;} = new();
	public ValidationResult Validate()
	{
		var validator = new TransactionValidator<LCON_LN1>(this);
		...
		validator.CollectionSize(x => x.LSII, 1, 2147483647);
		foreach (var item in LSII) validator.Results.AddRange(item.Validate().Errors);
