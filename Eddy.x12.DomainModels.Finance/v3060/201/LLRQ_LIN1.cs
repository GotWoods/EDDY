...
public class LLRQ_LIN1 {
	...
	[SectionPosition(11)] public List<QTY_Quantity> Quantity { get; set; } = new();
	[SectionPosition(12)] public FTH_FirstTimeHomeBuyer? FirstTimeHomeBuyer { get; set; }
	[SectionPosition(13)] public List<AIN_Income> Income { get; set; } = new();
	[SectionPosition(14)] public List<PPY_PersonalPropertyDescription> PersonalPropertyDescription { get; set; } = new();
	...
	[SectionPosition(19)] public List<LLRQ__LIN1_LCDA> LCDA {get;set;} = new();
	[SectionPosition(20)] public List<LLRQ__LIN1_LFAA> LFAA {get;set;} = new();
	[SectionPosition(21)] public LS_LoopHeader? LoopHeader { get; set; }
	[SectionPosition(22)] public List<LLRQ__LIN1_LAMT> LAMT {get;set;} = new();
	[SectionPosition(23)] public LE_LoopTrailer? LoopTrailer { get; set; }
