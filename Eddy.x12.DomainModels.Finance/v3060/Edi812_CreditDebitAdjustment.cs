...
using Eddy.x12.DomainModels.Finance.v3060._812;
...
public class Edi812_CreditDebitAdjustment {
	...
	[SectionPosition(10)] public List<AT_FinancialAccounting> FinancialAccounting { get; set; } = new();
	[SectionPosition(11)] public List<SAC_ServicePromotionAllowanceOrChargeInformation> ServicePromotionAllowanceOrChargeInformation { get; set; } = new();
	[SectionPosition(12)] public List<LN1> LN1 {get;set;} = new();
	[SectionPosition(13)] public List<LLM> LLM {get;set;} = new();
