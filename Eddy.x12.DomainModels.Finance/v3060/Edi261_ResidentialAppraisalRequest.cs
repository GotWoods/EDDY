...
using Eddy.x12.DomainModels.Finance.v3060._261;

namespace Eddy.x12.DomainModels.Finance.v3060;

public class Edi261_ResidentialAppraisalRequest {
	...
	{
		var validator = new TransactionValidator<Edi261_ResidentialAppraisalRequest>(this);
