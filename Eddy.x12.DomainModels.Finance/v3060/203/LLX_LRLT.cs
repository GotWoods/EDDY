...
public class LLX_LRLT {
	...
	[SectionPosition(7)] public List<NX2_RealEstatePropertyIDComponent> RealEstatePropertyIDComponent { get; set; } = new();
	[SectionPosition(8)] public List<LLX__LRLT_LN1> LN1 {get;set;} = new();
