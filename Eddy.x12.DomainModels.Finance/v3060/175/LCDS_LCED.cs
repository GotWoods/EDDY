...
namespace Eddy.x12.DomainModels.Finance.v3060._175;

public class LCDS_LCED {
	[SectionPosition(1)] public CED_CourtEventDescription CourtEventDescription { get; set; } = new();
	...
	[SectionPosition(8)] public List<CDS_CaseDescription> CaseDescription { get; set; } = new();
	[SectionPosition(9)] public List<MSG_MessageText> MessageText { get; set; } = new();
	[SectionPosition(10)] public List<LCDS__LCED_LLM> LLM {get;set;} = new();
	[SectionPosition(11)] public List<LCDS__LCED_LNM1> LNM1 {get;set;} = new();
	public ValidationResult Validate()
	{
		var validator = new TransactionValidator<LCDS_LCED>(this);
		validator.Required(x => x.CourtEventDescription);
