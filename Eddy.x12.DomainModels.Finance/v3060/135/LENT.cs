...
namespace Eddy.x12.DomainModels.Finance.v3060._135;
...
public class LENT {
	...
	[SectionPosition(10)] public List<LENT_LN1> LN1 {get;set;} = new();
	[SectionPosition(11)] public List<LENT_LPLI> LPLI {get;set;} = new();
	[SectionPosition(12)] public List<LENT_LIN1> LIN1 {get;set;} = new();
