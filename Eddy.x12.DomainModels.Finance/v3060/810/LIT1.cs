...
public class LIT1 {
	...
	[SectionPosition(15)] public List<REF_ReferenceIdentification> ReferenceIdentification { get; set; } = new();
	...
	[SectionPosition(20)] public List<CAD_CarrierDetail> CarrierDetail { get; set; } = new();
	...
	[SectionPosition(23)] public List<AT_FinancialAccounting> FinancialAccounting { get; set; } = new();
	[SectionPosition(24)] public List<LIT1_LSAC> LSAC {get;set;} = new();
	[SectionPosition(25)] public List<LIT1_LSLN> LSLN {get;set;} = new();
	[SectionPosition(26)] public List<LIT1_LN1> LN1 {get;set;} = new();
	[SectionPosition(27)] public List<LIT1_LLM> LLM {get;set;} = new();
	[SectionPosition(28)] public List<LIT1_LV1> LV1 {get;set;} = new();
