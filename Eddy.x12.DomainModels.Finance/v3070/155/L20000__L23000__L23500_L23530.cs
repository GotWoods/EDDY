...
public class L20000__L23000__L23500_L23530 {
	...
	[SectionPosition(8)] public ITC_InformationTypeAndCommentResults? InformationTypeAndCommentResults { get; set; }
	[SectionPosition(9)] public List<MTX_Text> Text { get; set; } = new();
	[SectionPosition(10)] public YNQ_YesNoQuestion? YesNoQuestion { get; set; }
	[SectionPosition(11)] public List<AWD_AmountWithDescription> AmountWithDescription { get; set; } = new();
	[SectionPosition(12)] public List<L20000__L23000__L23500__L23530_L23531> L23531 {get;set;} = new();
