...
public class L20000__L23000_L23200 {
	...
	[SectionPosition(10)] public List<AWD_AmountWithDescription> AmountWithDescription { get; set; } = new();
	[SectionPosition(11)] public ASO_AssetOwnership? AssetOwnership { get; set; }
	[SectionPosition(12)] public YNQ_YesNoQuestion? YesNoQuestion { get; set; }
	[SectionPosition(13)] public List<PCT_PercentAmounts> PercentAmounts { get; set; } = new();
