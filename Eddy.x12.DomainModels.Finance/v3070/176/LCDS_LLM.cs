...
public class LCDS_LLM {
	...
	[SectionPosition(3)] public CED_CourtEventDescription? CourtEventDescription { get; set; }
	[SectionPosition(4)] public List<MSG_MessageText> MessageText { get; set; } = new();
	public ValidationResult Validate()
	{
		var validator = new TransactionValidator<LCDS_LLM>(this);
