...
namespace Eddy.x12.DomainModels.Finance.v3070._149;
...
public class LTFS_LFGS {
	...
	[SectionPosition(6)] public List<LTFS__LFGS_LAMT> LAMT {get;set;} = new();
	[SectionPosition(7)] public List<LTFS__LFGS_LN1> LN1 {get;set;} = new();
