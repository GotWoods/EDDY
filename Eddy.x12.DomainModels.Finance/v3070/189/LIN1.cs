...
public class LIN1 {
	...
	[SectionPosition(6)] public List<IMM_ImmunizationStatusCode> ImmunizationStatusCode { get; set; } = new();
	...
	public ValidationResult Validate()
	{
		...
		validator.CollectionSize(x => x.ImmunizationStatusCode, 1, 2147483647);
