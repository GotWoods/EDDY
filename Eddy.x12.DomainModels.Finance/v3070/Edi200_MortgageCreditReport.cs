...
using Eddy.x12.DomainModels.Finance.v3070._200;
...
public class Edi200_MortgageCreditReport {
	...
	[SectionPosition(10)] public List<G32_SurveyQuestionResponse> SurveyQuestionResponse { get; set; } = new();
	[SectionPosition(11)] public List<LN1> LN1 {get;set;} = new();

	//Details
	[SectionPosition(12)] public List<LLX> LLX {get;set;} = new();
	[SectionPosition(13)] public List<LTLN> LTLN {get;set;} = new();
	[SectionPosition(14)] public List<LRO> LRO {get;set;} = new();
	[SectionPosition(15)] public List<LCCI> LCCI {get;set;} = new();
	[SectionPosition(16)] public List<LINQ> LINQ {get;set;} = new();
	[SectionPosition(17)] public List<LVAR> LVAR {get;set;} = new();
	[SectionPosition(18)] public LS_LoopHeader? LoopHeader { get; set; }
	[SectionPosition(19)] public List<LNTE> LNTE {get;set;} = new();
	[SectionPosition(20)] public LE_LoopTrailer? LoopTrailer { get; set; }
