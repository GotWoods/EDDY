...
using Eddy.x12.DomainModels.Finance.v4020._810;
...
public class Edi810_Invoice {
	...
	[SectionPosition(23)] public List<LFA1> LFA1 {get;set;} = new();

	//Details
	[SectionPosition(24)] public List<LIT1> LIT1 {get;set;} = new();

	//Summary
	[SectionPosition(25)] public TDS_TotalMonetaryValueSummary TotalMonetaryValueSummary { get; set; } = new();
	[SectionPosition(26)] public List<TXI_TaxInformation> TaxInformation { get; set; } = new();
	[SectionPosition(27)] public CAD_CarrierDetail? CarrierDetail { get; set; }
	[SectionPosition(28)] public List<AMT_MonetaryAmount> MonetaryAmount { get; set; } = new();
	[SectionPosition(29)] public List<LSAC> LSAC {get;set;} = new();
	[SectionPosition(30)] public List<LISS> LISS {get;set;} = new();
	[SectionPosition(31)] public CTT_TransactionTotals? TransactionTotals { get; set; }
