...
namespace Eddy.x12.DomainModels.Finance.v4020._814;
...
public class LLIN {
	...
	[SectionPosition(8)] public List<LLIN_LFA1> LFA1 {get;set;} = new();
	[SectionPosition(9)] public List<LLIN_LNM1> LNM1 {get;set;} = new();
