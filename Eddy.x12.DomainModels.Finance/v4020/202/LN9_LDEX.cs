...
namespace Eddy.x12.DomainModels.Finance.v4020._202;
...
public class LN9_LDEX {
	...
	public ValidationResult Validate()
	{
		...
		validator.CollectionSize(x => x.ReferenceIdentification, 1, 15);
		validator.CollectionSize(x => x.PercentAmounts, 0, 10);
		validator.CollectionSize(x => x.Interest, 0, 10);
		validator.CollectionSize(x => x.MonetaryAmount, 0, 4);
