...
namespace Eddy.x12.DomainModels.Finance.v4020._261;
...
public class LLX_LNX1 {
	...
	[SectionPosition(14)] public List<AMT_MonetaryAmount> MonetaryAmount { get; set; } = new();
	[SectionPosition(15)] public List<QTY_Quantity> Quantity { get; set; } = new();
