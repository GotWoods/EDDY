...
using Eddy.x12.DomainModels.Finance.v4020._138;

namespace Eddy.x12.DomainModels.Finance.v4020;

public class Edi138_EducationTestingResultsRequestAndReport {
	[SectionPosition(1)] public ST_TransactionSetHeader TransactionSetHeader { get; set; } = new();
	[SectionPosition(2)] public BGN_BeginningSegment BeginningSegment { get; set; } = new();
	[SectionPosition(3)] public ERP_EducationalRecordPurpose EducationalRecordPurpose { get; set; } = new();
	[SectionPosition(4)] public REF_ReferenceIdentification ReferenceIdentification { get; set; } = new();
	...
	{
		var validator = new TransactionValidator<Edi138_EducationTestingResultsRequestAndReport>(this);
