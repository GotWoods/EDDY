...
namespace Eddy.x12.DomainModels.Finance.v4040._176;

public class LFGS_LLM {
	...
	[SectionPosition(3)] public CED_AdministrationOfJusticeEventDescription? AdministrationOfJusticeEventDescription { get; set; }
	[SectionPosition(4)] public List<MSG_MessageText> MessageText { get; set; } = new();
	public ValidationResult Validate()
	{
		var validator = new TransactionValidator<LFGS_LLM>(this);
