...
namespace Eddy.x12.DomainModels.Finance.v4040._849;
...
public class LCON_LPAD {
	...
	[SectionPosition(10)] public List<REF_ReferenceIdentification> ReferenceIdentification { get; set; } = new();
	...
	[SectionPosition(13)] public SSS_SpecialServices? SpecialServices { get; set; }
