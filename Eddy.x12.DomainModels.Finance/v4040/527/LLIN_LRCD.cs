...
namespace Eddy.x12.DomainModels.Finance.v4040._527;
...
public class LLIN_LRCD {
	...
	[SectionPosition(4)] public List<DD_DemandDetail> DemandDetail { get; set; } = new();
	[SectionPosition(5)] public List<N9_ReferenceIdentification> ReferenceIdentification { get; set; } = new();
	[SectionPosition(6)] public AMT_MonetaryAmount? MonetaryAmount { get; set; }
	[SectionPosition(7)] public List<NTE_NoteSpecialInstruction> NoteSpecialInstruction { get; set; } = new();
	[SectionPosition(8)] public List<G66_TransportationInstructions> TransportationInstructions { get; set; } = new();
	[SectionPosition(9)] public List<LLIN__LRCD_LLM> LLM {get;set;} = new();
	[SectionPosition(10)] public List<LLIN__LRCD_LCS> LCS {get;set;} = new();
	[SectionPosition(11)] public List<LLIN__LRCD_LN1> LN1 {get;set;} = new();
	[SectionPosition(12)] public List<LLIN__LRCD_LREF> LREF {get;set;} = new();
	[SectionPosition(13)] public List<LLIN__LRCD_LQTY> LQTY {get;set;} = new();
	[SectionPosition(14)] public List<LLIN__LRCD_LFA1> LFA1 {get;set;} = new();
