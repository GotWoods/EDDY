...
using Eddy.x12.DomainModels.Finance.v6040._157;

namespace Eddy.x12.DomainModels.Finance.v6040;

public class Edi157_NoticeOfPowerOfAttorney {
	...
	{
		var validator = new TransactionValidator<Edi157_NoticeOfPowerOfAttorney>(this);
