...
namespace Eddy.x12.DomainModels.Finance.v4050._262;
...
public class L2000_L2100 {
	...
	[SectionPosition(11)] public List<AMT_MonetaryAmount> MonetaryAmountInformation { get; set; } = new();
	...
	public ValidationResult Validate()
	{
		...
		validator.CollectionSize(x => x.QuantityInformation, 0, 25);
		validator.CollectionSize(x => x.ReferenceInformation, 0, 30);
