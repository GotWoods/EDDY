...
using Eddy.x12.DomainModels.Finance.v4050._810;
...
public class Edi810_Invoice {
	...
	[SectionPosition(28)] public CAD_CarrierDetail? CarrierDetail { get; set; }
	[SectionPosition(29)] public List<AMT_MonetaryAmount> MonetaryAmountInformation { get; set; } = new();
