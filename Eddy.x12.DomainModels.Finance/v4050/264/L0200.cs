...
namespace Eddy.x12.DomainModels.Finance.v4050._264;

public class L0200 {
	[SectionPosition(1)] public LX_AssignedNumber TransactionSetLineNumber { get; set; } = new();
	[SectionPosition(2)] public List<DTM_DateTimeReference> DateTimeReference { get; set; } = new();
	[SectionPosition(3)] public N1_Name? PartyIdentification { get; set; }
	[SectionPosition(4)] public N2_AdditionalNameInformation? AdditionalNameInformation { get; set; }
	[SectionPosition(5)] public N3_AddressInformation? PartyLocation { get; set; }
	[SectionPosition(6)] public N4_GeographicLocation? GeographicLocation { get; set; }
	[SectionPosition(7)] public List<REF_ReferenceIdentification> ReferenceInformation { get; set; } = new();
	[SectionPosition(8)] public List<PER_AdministrativeCommunicationsContact> AdministrativeCommunicationsContact { get; set; } = new();
	[SectionPosition(9)] public List<QTY_Quantity> QuantityInformation { get; set; } = new();
	[SectionPosition(10)] public List<AMT_MonetaryAmount> MonetaryAmountInformation { get; set; } = new();
