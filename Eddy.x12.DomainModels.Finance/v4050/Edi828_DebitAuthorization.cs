...
using Eddy.x12.DomainModels.Finance.v4050._828;
...
public class Edi828_DebitAuthorization {
	...
	[SectionPosition(5)] public List<N3_AddressInformation> PartyLocation { get; set; } = new();
	...
	[SectionPosition(11)] public AMT_MonetaryAmount? MonetaryAmountInformation { get; set; }
