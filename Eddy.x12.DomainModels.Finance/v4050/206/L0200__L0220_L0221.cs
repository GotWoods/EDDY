...
namespace Eddy.x12.DomainModels.Finance.v4050._206;
...
public class L0200__L0220_L0221 {
	...
	[SectionPosition(9)] public List<AMT_MonetaryAmount> MonetaryAmountInformation { get; set; } = new();
	...
	[SectionPosition(13)] public List<QTY_Quantity> QuantityInformation { get; set; } = new();
