...
namespace Eddy.x12.DomainModels.Finance.v4050._155;
...
public class L20000__L23000_L23200 {
	...
	[SectionPosition(6)] public List<N3_AddressInformation> PartyLocation { get; set; } = new();
	...
	[SectionPosition(10)] public List<N9_ReferenceIdentification> ExtendedReferenceInformation { get; set; } = new();
	...
	[SectionPosition(16)] public List<QTY_Quantity> QuantityInformation { get; set; } = new();
