...
using Eddy.x12.DomainModels.Finance.v4050._880;
...
public class Edi880_GroceryProductsInvoice {
	...
	[SectionPosition(13)] public List<L0400> L0400 {get;set;} = new();

	//Summary
	[SectionPosition(14)] public G31_TotalInvoiceQuantity TotalInvoiceQuantity { get; set; } = new();
	[SectionPosition(15)] public G33_TotalDollarsSummary TotalDollarsSummary { get; set; } = new();
