...
namespace Eddy.x12.DomainModels.Finance.v4050._266;
...
public class L0200__L0220_L0222 {
	...
	[SectionPosition(2)] public List<N3_AddressInformation> PartyLocation { get; set; } = new();
	...
	[SectionPosition(8)] public AMT_MonetaryAmount? MonetaryAmountInformation { get; set; }
