...
namespace Eddy.x12.DomainModels.Finance.v4050._154;
...
public class LLS1 {
	...
	[SectionPosition(9)] public List<N9_ReferenceIdentification> ExtendedReferenceInformation { get; set; } = new();
	...
	[SectionPosition(12)] public List<AMT_MonetaryAmount> MonetaryAmountInformation { get; set; } = new();
