...
namespace Eddy.x12.DomainModels.Finance.v4050._844;
...
public class LCON_LPAD {
	...
	[SectionPosition(7)] public List<AMT_MonetaryAmount> MonetaryAmountInformation { get; set; } = new();
	[SectionPosition(8)] public RCD_ReceivingConditions? ReceivingConditions { get; set; }
	[SectionPosition(9)] public List<REF_ReferenceIdentification> ReferenceInformation { get; set; } = new();
	...
	[SectionPosition(12)] public SSS_SpecialServices? ProductSpecialServices { get; set; }
