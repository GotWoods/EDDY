...
using Eddy.x12.DomainModels.Finance.v4050._814;
...
public class Edi814_GeneralRequestResponseOrConfirmation {
	...
	[SectionPosition(6)] public List<AMT_MonetaryAmount> MonetaryAmountInformation { get; set; } = new();
	[SectionPosition(7)] public List<N9_ReferenceIdentification> ExtendedReferenceInformation { get; set; } = new();
