...
namespace Eddy.x12.DomainModels.Finance.v4050._203;
...
public class LLX_LRLT {
	...
	[SectionPosition(4)] public IRA_InvestorReportingActionCode? InvestorReportingAction { get; set; }
	...
	[SectionPosition(8)] public List<LQ_IndustryCode> IndustryCodeIdentification { get; set; } = new();
