...
namespace Eddy.x12.DomainModels.Finance.v8010._133;
...
public class LHL_LN1 {
	...
	[SectionPosition(5)] public List<PPA_PropertyLocation> PropertyLocation { get; set; } = new();
	[SectionPosition(6)] public List<COM_CommunicationContactInformation> CommunicationContactInformation { get; set; } = new();
	public ValidationResult Validate()
	{
		...
		validator.CollectionSize(x => x.PropertyLocation, 1, 2147483647);
