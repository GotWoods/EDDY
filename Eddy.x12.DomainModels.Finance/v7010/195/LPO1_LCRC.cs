...
namespace Eddy.x12.DomainModels.Finance.v7010._195;

public class LPO1_LCRC {
	...
	[SectionPosition(4)] public List<LPO1__LCRC_LLM> LLM {get;set;} = new();
	[SectionPosition(5)] public List<LPO1__LCRC_LN1> LN1 {get;set;} = new();
	public ValidationResult Validate()
	{
		var validator = new TransactionValidator<LPO1_LCRC>(this);
