...
namespace Eddy.x12.DomainModels.Finance.v7010._261;
...
public class LLX_LNX1 {
	...
	[SectionPosition(6)] public List<PDS_PropertyDescriptionLegalDescription> PropertyDescriptionLegalDescription { get; set; } = new();
	[SectionPosition(7)] public List<PDE_PropertyMetesAndBoundsDescription> PropertyMetesAndBoundsDescription { get; set; } = new();
	[SectionPosition(8)] public List<PEX_PropertyOrHousingExpense> PropertyOrHousingExpense { get; set; } = new();
	[SectionPosition(9)] public REC_RealEstateCondition? RealEstateCondition { get; set; }
	[SectionPosition(10)] public REA_RealEstatePropertyInformation? RealEstatePropertyInformation { get; set; }
	[SectionPosition(11)] public List<III_Information> Information { get; set; } = new();
	[SectionPosition(12)] public List<AM1_InformationalValues> InformationalValues { get; set; } = new();
	[SectionPosition(13)] public List<API_ActivityOrProcessInformation> ActivityOrProcessInformation { get; set; } = new();
	[SectionPosition(14)] public List<AMT_MonetaryAmountInformation> MonetaryAmountInformation { get; set; } = new();
	[SectionPosition(15)] public List<QTY_QuantityInformation> QuantityInformation { get; set; } = new();
	[SectionPosition(16)] public List<PCT_PercentAmounts> PercentAmounts { get; set; } = new();
	[SectionPosition(17)] public List<NTE_NoteSpecialInstruction> NoteSpecialInstruction { get; set; } = new();
	[SectionPosition(18)] public List<LLX__LNX1_LPWK> LPWK {get;set;} = new();
