...
namespace Eddy.x12.DomainModels.Finance.v7050._175;

public class LCDS__LCED__LNM1__LLX_LLM {
	...
	{
		var validator = new TransactionValidator<LCDS__LCED__LNM1__LLX_LLM>(this);
