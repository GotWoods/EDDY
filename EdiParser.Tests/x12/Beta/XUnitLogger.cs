...
public class XUnitLoggingFactory : ILoggerFactory
{
    private readonly ITestOutputHelper _testOutputHelper;

    public XUnitLoggingFactory(ITestOutputHelper testOutputHelper)
    {
        _testOutputHelper = testOutputHelper;
    }
    ...
    public ILogger CreateLogger(string categoryName)
    {
        return XUnitLogger.CreateLogger(_testOutputHelper);
    }
