...
using Eddy.x12.DomainModels.CommunicationsAndControls.v3060._868;

namespace Eddy.x12.DomainModels.CommunicationsAndControls.v3060;
...
public class Edi868_ElectronicFormStructure {
	...
	[SectionPosition(8)] public List<LE30> LE30 {get;set;} = new();
	[SectionPosition(9)] public List<LE40> LE40 {get;set;} = new();
