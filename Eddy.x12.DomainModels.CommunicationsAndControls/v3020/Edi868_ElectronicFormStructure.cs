...
using Eddy.x12.DomainModels.CommunicationsAndControls.v3020._868;

namespace Eddy.x12.DomainModels.CommunicationsAndControls.v3020;
...
public class Edi868_ElectronicFormStructure {
	...
	[SectionPosition(5)] public List<LE10> LE10 {get;set;} = new();
	[SectionPosition(6)] public List<LE20> LE20 {get;set;} = new();
	[SectionPosition(7)] public List<LE30> LE30 {get;set;} = new();
	[SectionPosition(8)] public List<LE40> LE40 {get;set;} = new();
