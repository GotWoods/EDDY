...
public class ELM_SimpleDataElementDetails : EdifactSegment
{
	...
	[Position(4)]
	public string SimpleDataElementMaximumLengthMeasure { get; set; }

	[Position(5)]
	public string SimpleDataElementMinimumLengthMeasure { get; set; }
	...
	public override ValidationResult Validate()
	{
		...
		validator.Length(x => x.SimpleDataElementMaximumLengthMeasure, 1, 3);
		validator.Length(x => x.SimpleDataElementMinimumLengthMeasure, 1, 3);
