...
public class DGS_DangerousGoods : EdifactSegment
{
	...
	[Position(12)]
	public string HazardousMeansOfTransportCategoryCode { get; set; }
	...
	public override ValidationResult Validate()
	{
		...
		validator.Length(x => x.EmergencyProcedureForShipsIdentifier, 1, 6);
		...
		validator.Length(x => x.HazardousMeansOfTransportCategoryCode, 1, 3);
