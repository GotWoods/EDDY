...
namespace Eddy.Edifact.Models.D17A.Composites;
...
public class C059_Street : EdifactComponent
{
	...
	public override ValidationResult Validate()
	{
		...
		validator.Length(x => x.StreetAndNumberOrPostOfficeBoxIdentifier2, 1, 256);
		validator.Length(x => x.StreetAndNumberOrPostOfficeBoxIdentifier3, 1, 256);
		validator.Length(x => x.StreetAndNumberOrPostOfficeBoxIdentifier4, 1, 256);
