...
namespace Eddy.Edifact.Models.D05B.Composites;
...
public class C222_TransportIdentification : EdifactComponent
{
	...
	public override ValidationResult Validate()
	{
		...
		validator.Length(x => x.TransportMeansIdentificationNameIdentifier, 1, 35);
		validator.Length(x => x.CodeListIdentificationCode, 1, 17);
		validator.Length(x => x.CodeListResponsibleAgencyCode, 1, 3);
		validator.Length(x => x.TransportMeansIdentificationName, 1, 70);
