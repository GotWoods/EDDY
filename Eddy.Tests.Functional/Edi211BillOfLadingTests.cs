...
public class Edi211BillOfLadingTests
{
    private readonly ITestOutputHelper _output;

    public Edi211BillOfLadingTests(ITestOutputHelper output)
    {
        _output = output;
    ...
    [Theory]
    [InlineData(@"G:\EdiSamples\Holland\211\OUT\2023\02", '*', '~')]
    [InlineData(@"G:\EdiSamples\FedEx\211\OUT\2023\02", '*', '~')]
        ...
        foreach (var file in Directory.GetFiles(path))
        {
            ...
            try
            {
                ...
                foreach (var section in document.Sections)
                {
                    ...
                    var edi = mapper.Map<Edi211_MotorCarrierBillOfLading>();
