...
public class Edi214TransportationCarrierShipmentStatusMessage
{
    private readonly ITestOutputHelper _output;

    public Edi214TransportationCarrierShipmentStatusMessage(ITestOutputHelper output)
    {
        _output = output;
    ...
    [Theory]
    [InlineData(@"G:\EdiSamples\CHRobinson\214\OUT\2023\02", '*', '~')]
    [InlineData(@"G:\EdiSamples\FedEx\214\IN\2023\02", '*', '\n')]
    [InlineData(@"G:\EdiSamples\Load\214\IN\2023\02", '*', '~')]
    [InlineData(@"G:\EdiSamples\CHRobinson\214\IN\2023\02", '*', '~')]
    [InlineData(@"G:\EdiSamples\R2Logistics\214\IN\2023\02", '*', '~')]
    [InlineData(@"G:\EdiSamples\PureTransportation\214\IN\2023\02", '*', '~')]
    [InlineData(@"G:\EdiSamples\Magellan\214\IN", '*', '~')]
    [InlineData(@"G:\EdiSamples\Magna\214\OUT\2023\01", '*', '~')]
    [InlineData(@"G:\EdiSamples\LandstarAgent\214\IN\2023\02", '*', '~')]
    [InlineData(@"G:\EdiSamples\LIVEnterprises\214\IN\2023\02", '*', '~')]
    [InlineData(@"G:\EdiSamples\knight\214\IN\2023\02", '*', '~')]
