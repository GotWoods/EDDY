...
namespace Eddy.Edifact.DomainModels.Transport.D17B.IFTMBF;
...
public class SegmentGroup17 {
	...
	[SectionPosition(11)] public List<SegmentGroup17_SegmentGroup18> SegmentGroup18 {get;set;} = new();
	[SectionPosition(12)] public List<GDS_NatureOfCargo> NatureOfCargo { get; set; } = new();
	[SectionPosition(13)] public List<SegmentGroup17_SegmentGroup19> SegmentGroup19 {get;set;} = new();
	[SectionPosition(14)] public List<SegmentGroup17_SegmentGroup20> SegmentGroup20 {get;set;} = new();
	[SectionPosition(15)] public List<SegmentGroup17_SegmentGroup21> SegmentGroup21 {get;set;} = new();
	[SectionPosition(16)] public List<SegmentGroup17_SegmentGroup22> SegmentGroup22 {get;set;} = new();
	[SectionPosition(17)] public List<SegmentGroup17_SegmentGroup23> SegmentGroup23 {get;set;} = new();
	[SectionPosition(18)] public List<SegmentGroup17_SegmentGroup24> SegmentGroup24 {get;set;} = new();
	[SectionPosition(19)] public List<SegmentGroup17_SegmentGroup26> SegmentGroup26 {get;set;} = new();
	[SectionPosition(20)] public List<SegmentGroup17_SegmentGroup28> SegmentGroup28 {get;set;} = new();
