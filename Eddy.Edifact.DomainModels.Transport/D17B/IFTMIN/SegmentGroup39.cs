...
namespace Eddy.Edifact.DomainModels.Transport.D17B.IFTMIN;
...
public class SegmentGroup39 {
	...
	[SectionPosition(12)] public List<SegmentGroup39_SegmentGroup40> SegmentGroup40 {get;set;} = new();
	[SectionPosition(13)] public List<SegmentGroup39_SegmentGroup41> SegmentGroup41 {get;set;} = new();
	[SectionPosition(14)] public List<SegmentGroup39_SegmentGroup43> SegmentGroup43 {get;set;} = new();
	[SectionPosition(15)] public List<SegmentGroup39_SegmentGroup44> SegmentGroup44 {get;set;} = new();
