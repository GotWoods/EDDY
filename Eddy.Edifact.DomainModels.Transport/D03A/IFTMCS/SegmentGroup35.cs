...
public class SegmentGroup35 {
	...
	[SectionPosition(11)] public List<RFF_Reference> Reference { get; set; } = new();
	[SectionPosition(12)] public List<SegmentGroup35_SegmentGroup36> SegmentGroup36 {get;set;} = new();
	[SectionPosition(13)] public List<SegmentGroup35_SegmentGroup37> SegmentGroup37 {get;set;} = new();
	[SectionPosition(14)] public List<SegmentGroup35_SegmentGroup38> SegmentGroup38 {get;set;} = new();
	[SectionPosition(15)] public List<SegmentGroup35_SegmentGroup39> SegmentGroup39 {get;set;} = new();
	public ValidationResult Validate()
	{
		var validator = new TransactionValidator<SegmentGroup35>(this);
