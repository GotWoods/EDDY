...
using Eddy.Edifact.DomainModels.Transport.D03A.HANMOV;

namespace Eddy.Edifact.DomainModels.Transport.D03A;

public class HANMOV_CargoGoodsHandlingAndMovement {
	...
	[SectionPosition(11)] public List<SegmentGroup7> SegmentGroup7 {get;set;} = new();
	[SectionPosition(12)] public List<SegmentGroup11> SegmentGroup11 {get;set;} = new();
	[SectionPosition(13)] public List<SegmentGroup12> SegmentGroup12 {get;set;} = new();
	[SectionPosition(14)] public List<SegmentGroup20> SegmentGroup20 {get;set;} = new();
	[SectionPosition(15)] public List<SegmentGroup23> SegmentGroup23 {get;set;} = new();
	[SectionPosition(16)] public UNT_MessageTrailer MessageTrailer { get; set; } = new();
	...
	{
		var validator = new TransactionValidator<HANMOV_CargoGoodsHandlingAndMovement>(this);
