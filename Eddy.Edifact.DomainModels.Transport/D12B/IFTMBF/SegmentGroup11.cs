...
public class SegmentGroup11 {
	...
	[SectionPosition(3)] public List<SegmentGroup11_SegmentGroup12> SegmentGroup12 {get;set;} = new();
	[SectionPosition(4)] public List<SegmentGroup11_SegmentGroup13> SegmentGroup13 {get;set;} = new();
	[SectionPosition(5)] public List<SegmentGroup11_SegmentGroup14> SegmentGroup14 {get;set;} = new();
	[SectionPosition(6)] public List<SegmentGroup11_SegmentGroup15> SegmentGroup15 {get;set;} = new();
	[SectionPosition(7)] public List<SegmentGroup11_SegmentGroup16> SegmentGroup16 {get;set;} = new();
