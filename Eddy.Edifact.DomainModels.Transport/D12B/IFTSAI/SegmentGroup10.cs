...
namespace Eddy.Edifact.DomainModels.Transport.D12B.IFTSAI;
...
public class SegmentGroup10 {
	...
	[SectionPosition(4)] public List<SegmentGroup10_SegmentGroup11> SegmentGroup11 {get;set;} = new();
	[SectionPosition(5)] public List<SegmentGroup10_SegmentGroup12> SegmentGroup12 {get;set;} = new();
	[SectionPosition(6)] public List<SegmentGroup10_SegmentGroup13> SegmentGroup13 {get;set;} = new();
	[SectionPosition(7)] public List<SegmentGroup10_SegmentGroup14> SegmentGroup14 {get;set;} = new();
