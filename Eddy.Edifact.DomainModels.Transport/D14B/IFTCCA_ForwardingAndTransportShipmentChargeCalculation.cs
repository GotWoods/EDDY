...
using Eddy.Edifact.DomainModels.Transport.D14B.IFTCCA;

namespace Eddy.Edifact.DomainModels.Transport.D14B;

public class IFTCCA_ForwardingAndTransportShipmentChargeCalculation {
	...
	[SectionPosition(3)] public List<CTA_ContactInformation> ContactInformation { get; set; } = new();
	...
	[SectionPosition(11)] public List<CNT_ControlTotal> ControlTotal { get; set; } = new();
	...
	[SectionPosition(16)] public List<SegmentGroup9> SegmentGroup9 {get;set;} = new();
	[SectionPosition(17)] public List<SegmentGroup23> SegmentGroup23 {get;set;} = new();
	[SectionPosition(18)] public UNT_MessageTrailer MessageTrailer { get; set; } = new();
	...
	{
		var validator = new TransactionValidator<IFTCCA_ForwardingAndTransportShipmentChargeCalculation>(this);
