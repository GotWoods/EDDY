...
namespace Eddy.Edifact.DomainModels.Transport.D14B.COREOR;
...
public class SegmentGroup6 {
	...
	[SectionPosition(8)] public List<SegmentGroup6_SegmentGroup9> SegmentGroup9 {get;set;} = new();
	[SectionPosition(9)] public List<SegmentGroup6_SegmentGroup11> SegmentGroup11 {get;set;} = new();
