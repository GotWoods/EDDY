...
using Eddy.Edifact.DomainModels.Transport.D14B.BAPLIE;
...
public class BAPLIE_BayplanStowagePlanOccupiedAndEmptyLocations {
	...
	[SectionPosition(7)] public UNS_SectionControl SectionControl { get; set; } = new();
	...
	public ValidationResult Validate()
	{
		...
		validator.Required(x => x.SectionControl);
