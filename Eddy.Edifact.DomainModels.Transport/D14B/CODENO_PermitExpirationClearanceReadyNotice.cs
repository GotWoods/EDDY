...
using Eddy.Edifact.DomainModels.Transport.D14B.CODENO;

namespace Eddy.Edifact.DomainModels.Transport.D14B;

public class CODENO_PermitExpirationClearanceReadyNotice {
	...
	{
		var validator = new TransactionValidator<CODENO_PermitExpirationClearanceReadyNotice>(this);
