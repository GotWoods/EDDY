...
using Eddy.Edifact.DomainModels.Transport.D20A.IFCSUM;
...
public class IFCSUM_ForwardingAndConsolidationSummary {
	...
	[SectionPosition(15)] public List<SegmentGroup23> SegmentGroup23 {get;set;} = new();
	[SectionPosition(16)] public List<SegmentGroup28> SegmentGroup28 {get;set;} = new();
	...
	public ValidationResult Validate()
	{
		...
		validator.CollectionSize(x => x.SegmentGroup28, 0, 9999);
