...
public class SegmentGroup14_SegmentGroup15 {
	...
	[SectionPosition(7)] public List<SegmentGroup14__SegmentGroup15_SegmentGroup16> SegmentGroup16 {get;set;} = new();
	[SectionPosition(8)] public List<SegmentGroup14__SegmentGroup15_SegmentGroup17> SegmentGroup17 {get;set;} = new();
	[SectionPosition(9)] public LOC_PlaceLocationIdentification PlaceLocationIdentification { get; set; } = new();
	[SectionPosition(10)] public List<PCI_PackageIdentification> PackageIdentification { get; set; } = new();
	[SectionPosition(11)] public List<SegmentGroup14__SegmentGroup15_SegmentGroup19> SegmentGroup19 {get;set;} = new();
	[SectionPosition(12)] public List<SegmentGroup14__SegmentGroup15_SegmentGroup21> SegmentGroup21 {get;set;} = new();
	[SectionPosition(13)] public List<SegmentGroup14__SegmentGroup15_SegmentGroup25> SegmentGroup25 {get;set;} = new();
