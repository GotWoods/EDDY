...
using Eddy.Edifact.DomainModels.Transport.D20A.COARRI;

namespace Eddy.Edifact.DomainModels.Transport.D20A;

public class COARRI_ContainerDischargeLoadingReport {
	...
	{
		var validator = new TransactionValidator<COARRI_ContainerDischargeLoadingReport>(this);
