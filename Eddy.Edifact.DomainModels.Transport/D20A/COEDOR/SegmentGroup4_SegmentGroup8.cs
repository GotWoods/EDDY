...
namespace Eddy.Edifact.DomainModels.Transport.D20A.COEDOR;
...
public class SegmentGroup4_SegmentGroup8 {
	...
	[SectionPosition(5)] public List<SegmentGroup4__SegmentGroup8_SegmentGroup9> SegmentGroup9 {get;set;} = new();
