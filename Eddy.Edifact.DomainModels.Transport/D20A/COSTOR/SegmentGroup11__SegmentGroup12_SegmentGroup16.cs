...
namespace Eddy.Edifact.DomainModels.Transport.D20A.COSTOR;
...
public class SegmentGroup11__SegmentGroup12_SegmentGroup16 {
	...
	[SectionPosition(5)] public List<SegmentGroup11__SegmentGroup12__SegmentGroup16_SegmentGroup17> SegmentGroup17 {get;set;} = new();
	[SectionPosition(6)] public List<SegmentGroup11__SegmentGroup12__SegmentGroup16_SegmentGroup18> SegmentGroup18 {get;set;} = new();
