...
using Eddy.Edifact.DomainModels.Transport.D12A.IFTMBF;
...
public class IFTMBF_FirmBooking {
	...
	[SectionPosition(17)] public List<SegmentGroup11> SegmentGroup11 {get;set;} = new();
	[SectionPosition(18)] public List<SegmentGroup17> SegmentGroup17 {get;set;} = new();
	[SectionPosition(19)] public List<SegmentGroup33> SegmentGroup33 {get;set;} = new();
