...
public class SegmentGroup33 {
	...
	[SectionPosition(9)] public RNG_RangeDetails RangeDetails { get; set; } = new();
	...
	[SectionPosition(12)] public List<SegmentGroup33_SegmentGroup34> SegmentGroup34 {get;set;} = new();
	[SectionPosition(13)] public List<SegmentGroup33_SegmentGroup36> SegmentGroup36 {get;set;} = new();
