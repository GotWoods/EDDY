...
namespace Eddy.Edifact.DomainModels.Transport.D19B.CODECO;
...
public class SegmentGroup10 {
	...
	[SectionPosition(14)] public List<SegmentGroup10_SegmentGroup11> SegmentGroup11 {get;set;} = new();
	[SectionPosition(15)] public List<SegmentGroup10_SegmentGroup12> SegmentGroup12 {get;set;} = new();
	[SectionPosition(16)] public List<NAD_NameAndAddress> NameAndAddress { get; set; } = new();
	[SectionPosition(17)] public List<SegmentGroup10_SegmentGroup14> SegmentGroup14 {get;set;} = new();
	[SectionPosition(18)] public List<SegmentGroup10_SegmentGroup16> SegmentGroup16 {get;set;} = new();
