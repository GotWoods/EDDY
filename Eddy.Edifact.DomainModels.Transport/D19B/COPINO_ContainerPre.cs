...
using Eddy.Edifact.DomainModels.Transport.D19B.COPINO;

namespace Eddy.Edifact.DomainModels.Transport.D19B;

public class COPINO_ContainerPre {
	...
	[SectionPosition(9)] public List<SegmentGroup11> SegmentGroup11 {get;set;} = new();
	...
	{
		var validator = new TransactionValidator<COPINO_ContainerPre>(this);
