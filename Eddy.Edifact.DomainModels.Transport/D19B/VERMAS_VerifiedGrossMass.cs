...
using Eddy.Edifact.DomainModels.Transport.D19B.VERMAS;

namespace Eddy.Edifact.DomainModels.Transport.D19B;

public class VERMAS_VerifiedGrossMass {
	...
	[SectionPosition(7)] public UNT_MessageTrailer MessageTrailer { get; set; } = new();
	...
	{
		var validator = new TransactionValidator<VERMAS_VerifiedGrossMass>(this);
