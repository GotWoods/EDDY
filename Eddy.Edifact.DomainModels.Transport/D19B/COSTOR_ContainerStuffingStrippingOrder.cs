...
using Eddy.Edifact.DomainModels.Transport.D19B.COSTOR;

namespace Eddy.Edifact.DomainModels.Transport.D19B;

public class COSTOR_ContainerStuffingStrippingOrder {
	...
	[SectionPosition(10)] public List<SegmentGroup11> SegmentGroup11 {get;set;} = new();
	[SectionPosition(11)] public CNT_ControlTotal ControlTotal { get; set; } = new();
	...
	{
		var validator = new TransactionValidator<COSTOR_ContainerStuffingStrippingOrder>(this);
		...
		validator.CollectionSize(x => x.SegmentGroup6, 0, 99999);
		validator.CollectionSize(x => x.SegmentGroup11, 0, 99999);
