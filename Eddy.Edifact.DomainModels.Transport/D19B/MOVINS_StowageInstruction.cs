...
using Eddy.Edifact.DomainModels.Transport.D19B.MOVINS;

namespace Eddy.Edifact.DomainModels.Transport.D19B;

public class MOVINS_StowageInstruction {
	...
	[SectionPosition(7)] public List<SegmentGroup6> SegmentGroup6 {get;set;} = new();
	...
	{
		var validator = new TransactionValidator<MOVINS_StowageInstruction>(this);
