...
namespace Eddy.Edifact.DomainModels.Transport.D19B.MOVINS;
...
public class SegmentGroup6__SegmentGroup7_SegmentGroup8 {
	...
	[SectionPosition(9)] public List<SegmentGroup6__SegmentGroup7__SegmentGroup8_SegmentGroup9> SegmentGroup9 {get;set;} = new();
	[SectionPosition(10)] public List<SegmentGroup6__SegmentGroup7__SegmentGroup8_SegmentGroup10> SegmentGroup10 {get;set;} = new();
	[SectionPosition(11)] public List<SegmentGroup6__SegmentGroup7__SegmentGroup8_SegmentGroup11> SegmentGroup11 {get;set;} = new();
	[SectionPosition(12)] public List<SegmentGroup6__SegmentGroup7__SegmentGroup8_SegmentGroup12> SegmentGroup12 {get;set;} = new();
