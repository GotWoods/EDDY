...
using Eddy.Edifact.DomainModels.Transport.D19B.IFTMBP;
...
public class IFTMBP_ProvisionalBooking {
	...
	[SectionPosition(15)] public List<SegmentGroup15> SegmentGroup15 {get;set;} = new();
	[SectionPosition(16)] public List<SegmentGroup30> SegmentGroup30 {get;set;} = new();
	...
	public ValidationResult Validate()
	{
		...
		validator.CollectionSize(x => x.SegmentGroup15, 0, 99999);
