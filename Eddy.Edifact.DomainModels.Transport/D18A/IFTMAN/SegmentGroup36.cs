...
public class SegmentGroup36 {
	...
	[SectionPosition(12)] public List<SegmentGroup36_SegmentGroup37> SegmentGroup37 {get;set;} = new();
	[SectionPosition(13)] public List<SegmentGroup36_SegmentGroup38> SegmentGroup38 {get;set;} = new();
	[SectionPosition(14)] public List<SegmentGroup36_SegmentGroup39> SegmentGroup39 {get;set;} = new();
	[SectionPosition(15)] public List<SegmentGroup36_SegmentGroup40> SegmentGroup40 {get;set;} = new();
