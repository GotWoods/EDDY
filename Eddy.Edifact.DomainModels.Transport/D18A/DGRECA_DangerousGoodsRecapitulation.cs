...
using Eddy.Edifact.DomainModels.Transport.D18A.DGRECA;

namespace Eddy.Edifact.DomainModels.Transport.D18A;

public class DGRECA_DangerousGoodsRecapitulation {
	...
	{
		var validator = new TransactionValidator<DGRECA_DangerousGoodsRecapitulation>(this);
