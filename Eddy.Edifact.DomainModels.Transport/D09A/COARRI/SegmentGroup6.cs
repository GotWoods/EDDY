...
namespace Eddy.Edifact.DomainModels.Transport.D09A.COARRI;
...
public class SegmentGroup6 {
	...
	[SectionPosition(13)] public List<SegmentGroup6_SegmentGroup9> SegmentGroup9 {get;set;} = new();
	...
	[SectionPosition(16)] public COD_ComponentDetails ComponentDetails { get; set; } = new();
	[SectionPosition(17)] public List<HAN_HandlingInstructions> HandlingInstructions { get; set; } = new();
	[SectionPosition(18)] public List<SegmentGroup6_SegmentGroup11> SegmentGroup11 {get;set;} = new();
	[SectionPosition(19)] public List<SegmentGroup6_SegmentGroup12> SegmentGroup12 {get;set;} = new();
	[SectionPosition(20)] public List<NAD_NameAndAddress> NameAndAddress { get; set; } = new();
