...
public class SegmentGroup4__SegmentGroup5_SegmentGroup12 {
	...
	[SectionPosition(6)] public List<SegmentGroup4__SegmentGroup5__SegmentGroup12_SegmentGroup13> SegmentGroup13 {get;set;} = new();
	[SectionPosition(7)] public List<SegmentGroup4__SegmentGroup5__SegmentGroup12_SegmentGroup14> SegmentGroup14 {get;set;} = new();
	[SectionPosition(8)] public List<SegmentGroup4__SegmentGroup5__SegmentGroup12_SegmentGroup15> SegmentGroup15 {get;set;} = new();
	public ValidationResult Validate()
	{
		var validator = new TransactionValidator<SegmentGroup4__SegmentGroup5_SegmentGroup12>(this);
