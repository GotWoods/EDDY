...
public class SegmentGroup37 {
	...
	[SectionPosition(12)] public List<SegmentGroup37_SegmentGroup38> SegmentGroup38 {get;set;} = new();
	[SectionPosition(13)] public List<SegmentGroup37_SegmentGroup39> SegmentGroup39 {get;set;} = new();
	[SectionPosition(14)] public List<SegmentGroup37_SegmentGroup41> SegmentGroup41 {get;set;} = new();
	[SectionPosition(15)] public List<SegmentGroup37_SegmentGroup42> SegmentGroup42 {get;set;} = new();
