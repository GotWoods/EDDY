...
public class SegmentGroup9_SegmentGroup16 {
	...
	[SectionPosition(3)] public List<SegmentGroup9__SegmentGroup16_SegmentGroup17> SegmentGroup17 {get;set;} = new();
	[SectionPosition(4)] public List<SegmentGroup9__SegmentGroup16_SegmentGroup18> SegmentGroup18 {get;set;} = new();
	[SectionPosition(5)] public List<SegmentGroup9__SegmentGroup16_SegmentGroup19> SegmentGroup19 {get;set;} = new();
	[SectionPosition(6)] public List<SegmentGroup9__SegmentGroup16_SegmentGroup20> SegmentGroup20 {get;set;} = new();
