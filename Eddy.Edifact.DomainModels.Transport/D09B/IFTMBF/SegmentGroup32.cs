...
public class SegmentGroup32 {
	...
	[SectionPosition(11)] public List<SegmentGroup32_SegmentGroup33> SegmentGroup33 {get;set;} = new();
	[SectionPosition(12)] public List<SegmentGroup32_SegmentGroup35> SegmentGroup35 {get;set;} = new();
