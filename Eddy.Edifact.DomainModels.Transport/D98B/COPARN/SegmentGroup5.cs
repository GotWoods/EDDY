...
public class SegmentGroup5 {
	...
	[SectionPosition(10)] public List<SegmentGroup5_SegmentGroup7> SegmentGroup7 {get;set;} = new();
	[SectionPosition(11)] public List<SegmentGroup5_SegmentGroup8> SegmentGroup8 {get;set;} = new();
