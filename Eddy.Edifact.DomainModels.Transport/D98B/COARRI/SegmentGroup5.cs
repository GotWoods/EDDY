...
namespace Eddy.Edifact.DomainModels.Transport.D98B.COARRI;
...
public class SegmentGroup5 {
	...
	[SectionPosition(19)] public List<SegmentGroup5_SegmentGroup6> SegmentGroup6 {get;set;} = new();
	[SectionPosition(20)] public List<SegmentGroup5_SegmentGroup7> SegmentGroup7 {get;set;} = new();
