...
namespace Eddy.Edifact.DomainModels.Transport.D98B.IFTDGN;

public class SegmentGroup6__SegmentGroup10_SegmentGroup12 {
	...
	[SectionPosition(6)] public List<SegmentGroup6__SegmentGroup10__SegmentGroup12_SegmentGroup13> SegmentGroup13 {get;set;} = new();
	public ValidationResult Validate()
	{
		var validator = new TransactionValidator<SegmentGroup6__SegmentGroup10_SegmentGroup12>(this);
