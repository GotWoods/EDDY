...
namespace Eddy.Edifact.DomainModels.Transport.D00B.IFTMCS;
...
public class SegmentGroup18 {
	...
	[SectionPosition(21)] public List<SegmentGroup18_SegmentGroup30> SegmentGroup30 {get;set;} = new();
	public ValidationResult Validate()
	{
		...
		validator.CollectionSize(x => x.SegmentGroup29, 0, 99);
