...
using Eddy.Edifact.DomainModels.Transport.D00B.IFTMBC;
...
public class IFTMBC_BookingConfirmation {
	...
	[SectionPosition(12)] public List<TCC_TransportChargeRateCalculations> TransportChargeRateCalculations { get; set; } = new();
	...
	[SectionPosition(15)] public List<SegmentGroup9> SegmentGroup9 {get;set;} = new();
	[SectionPosition(16)] public List<SegmentGroup18> SegmentGroup18 {get;set;} = new();
