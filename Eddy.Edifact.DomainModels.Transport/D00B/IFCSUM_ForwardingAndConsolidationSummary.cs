...
using Eddy.Edifact.DomainModels.Transport.D00B.IFCSUM;
...
public class IFCSUM_ForwardingAndConsolidationSummary {
	...
	[SectionPosition(15)] public List<SegmentGroup21> SegmentGroup21 {get;set;} = new();
	[SectionPosition(16)] public List<SegmentGroup25> SegmentGroup25 {get;set;} = new();
