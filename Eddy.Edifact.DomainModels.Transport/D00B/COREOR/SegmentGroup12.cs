...
public class SegmentGroup12 {
	...
	[SectionPosition(6)] public List<SegmentGroup12_SegmentGroup13> SegmentGroup13 {get;set;} = new();
	...
	[SectionPosition(12)] public List<SegmentGroup12_SegmentGroup14> SegmentGroup14 {get;set;} = new();
	[SectionPosition(13)] public List<SegmentGroup12_SegmentGroup15> SegmentGroup15 {get;set;} = new();
	[SectionPosition(14)] public List<SegmentGroup12_SegmentGroup16> SegmentGroup16 {get;set;} = new();
