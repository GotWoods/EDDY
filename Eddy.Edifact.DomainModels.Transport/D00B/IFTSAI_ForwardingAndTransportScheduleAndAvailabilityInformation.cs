...
using Eddy.Edifact.DomainModels.Transport.D00B.IFTSAI;
...
public class IFTSAI_ForwardingAndTransportScheduleAndAvailabilityInformation {
	...
	[SectionPosition(5)] public GIS_GeneralIndicator GeneralIndicator { get; set; } = new();
	...
	public ValidationResult Validate()
	{
		...
		validator.Required(x => x.GeneralIndicator);
