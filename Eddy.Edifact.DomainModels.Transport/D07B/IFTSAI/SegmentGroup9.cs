...
namespace Eddy.Edifact.DomainModels.Transport.D07B.IFTSAI;
...
public class SegmentGroup9 {
	...
	[SectionPosition(5)] public List<SegmentGroup9_SegmentGroup11> SegmentGroup11 {get;set;} = new();
	[SectionPosition(6)] public List<SegmentGroup9_SegmentGroup12> SegmentGroup12 {get;set;} = new();
	[SectionPosition(7)] public List<SegmentGroup9_SegmentGroup13> SegmentGroup13 {get;set;} = new();
