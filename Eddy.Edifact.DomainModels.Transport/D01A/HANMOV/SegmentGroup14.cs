...
public class SegmentGroup14 {
	...
	[SectionPosition(15)] public List<SegmentGroup14_SegmentGroup15> SegmentGroup15 {get;set;} = new();
	[SectionPosition(16)] public List<SGP_SplitGoodsPlacement> SplitGoodsPlacement { get; set; } = new();
	[SectionPosition(17)] public List<TCC_TransportChargeRateCalculations> ChargeRateCalculations { get; set; } = new();
	[SectionPosition(18)] public List<SegmentGroup14_SegmentGroup16> SegmentGroup16 {get;set;} = new();
