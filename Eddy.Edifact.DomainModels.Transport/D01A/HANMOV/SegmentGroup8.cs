...
public class SegmentGroup8 {
	...
	[SectionPosition(5)] public List<TCC_TransportChargeRateCalculations> ChargeRateCalculations { get; set; } = new();
	[SectionPosition(6)] public List<SegmentGroup8_SegmentGroup9> SegmentGroup9 {get;set;} = new();
	...
	[SectionPosition(13)] public List<SegmentGroup8_SegmentGroup11> SegmentGroup11 {get;set;} = new();
	[SectionPosition(14)] public List<LOC_PlaceLocationIdentification> PlaceLocationIdentification { get; set; } = new();
	[SectionPosition(15)] public List<SegmentGroup8_SegmentGroup12> SegmentGroup12 {get;set;} = new();
