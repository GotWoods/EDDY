...
public class SegmentGroup21 {
	...
	[SectionPosition(15)] public List<SegmentGroup21_SegmentGroup22> SegmentGroup22 {get;set;} = new();
	[SectionPosition(16)] public List<SegmentGroup21_SegmentGroup23> SegmentGroup23 {get;set;} = new();
	public ValidationResult Validate()
	{
		var validator = new TransactionValidator<SegmentGroup21>(this);
