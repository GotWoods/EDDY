...
using Eddy.Edifact.DomainModels.Transport.D01A.IFTMBC;
...
public class IFTMBC_BookingConfirmation {
	...
	[SectionPosition(12)] public List<TCC_TransportChargeRateCalculations> ChargeRateCalculations { get; set; } = new();
