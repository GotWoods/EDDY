...
using Eddy.Edifact.DomainModels.Transport.D10B.IFTMIN;

namespace Eddy.Edifact.DomainModels.Transport.D10B;
...
public class IFTMIN_Instruction {
	...
	[SectionPosition(22)] public List<SegmentGroup38> SegmentGroup38 {get;set;} = new();
	...
	public ValidationResult Validate()
	{
		...
		validator.CollectionSize(x => x.SegmentGroup19, 0, 99999);
		validator.CollectionSize(x => x.SegmentGroup38, 0, 999);
