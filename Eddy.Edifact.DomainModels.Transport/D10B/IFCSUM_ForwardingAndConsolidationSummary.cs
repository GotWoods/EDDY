...
using Eddy.Edifact.DomainModels.Transport.D10B.IFCSUM;
...
public class IFCSUM_ForwardingAndConsolidationSummary {
	...
	[SectionPosition(16)] public List<SegmentGroup27> SegmentGroup27 {get;set;} = new();
	...
	public ValidationResult Validate()
	{
		...
		validator.CollectionSize(x => x.SegmentGroup27, 0, 9999);
