...
public class SegmentGroup38 {
	...
	[SectionPosition(12)] public List<SegmentGroup38_SegmentGroup39> SegmentGroup39 {get;set;} = new();
	[SectionPosition(13)] public List<SegmentGroup38_SegmentGroup40> SegmentGroup40 {get;set;} = new();
	[SectionPosition(14)] public List<SegmentGroup38_SegmentGroup42> SegmentGroup42 {get;set;} = new();
	[SectionPosition(15)] public List<SegmentGroup38_SegmentGroup43> SegmentGroup43 {get;set;} = new();
	public ValidationResult Validate()
	{
		var validator = new TransactionValidator<SegmentGroup38>(this);
