...
using Eddy.Edifact.DomainModels.Transport.D13A.IFTMIN;

namespace Eddy.Edifact.DomainModels.Transport.D13A;

public class IFTMIN_Instruction {
	...
	[SectionPosition(11)] public List<DOC_DocumentMessageDetails> DocumentMessageDetails { get; set; } = new();
	[SectionPosition(12)] public List<GDS_NatureOfCargo> NatureOfCargo { get; set; } = new();
	[SectionPosition(13)] public List<SegmentGroup1> SegmentGroup1 {get;set;} = new();
	[SectionPosition(14)] public List<SegmentGroup2> SegmentGroup2 {get;set;} = new();
	[SectionPosition(15)] public List<SegmentGroup3> SegmentGroup3 {get;set;} = new();
	[SectionPosition(16)] public List<SegmentGroup4> SegmentGroup4 {get;set;} = new();
	[SectionPosition(17)] public List<SegmentGroup6> SegmentGroup6 {get;set;} = new();
	[SectionPosition(18)] public List<SegmentGroup7> SegmentGroup7 {get;set;} = new();
	[SectionPosition(19)] public List<SegmentGroup8> SegmentGroup8 {get;set;} = new();
	[SectionPosition(20)] public List<SegmentGroup12> SegmentGroup12 {get;set;} = new();
	[SectionPosition(21)] public List<SegmentGroup19> SegmentGroup19 {get;set;} = new();
	[SectionPosition(22)] public List<SegmentGroup20> SegmentGroup20 {get;set;} = new();
	[SectionPosition(23)] public List<SegmentGroup39> SegmentGroup39 {get;set;} = new();
	[SectionPosition(24)] public UNT_MessageTrailer MessageTrailer { get; set; } = new();
	...
	{
		var validator = new TransactionValidator<IFTMIN_Instruction>(this);
		...
		validator.CollectionSize(x => x.SegmentGroup20, 0, 99999);
		validator.CollectionSize(x => x.SegmentGroup39, 0, 999);
