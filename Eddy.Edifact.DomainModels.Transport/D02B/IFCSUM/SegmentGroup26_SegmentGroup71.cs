...
namespace Eddy.Edifact.DomainModels.Transport.D02B.IFCSUM;

public class SegmentGroup26_SegmentGroup71 {
	...
	[SectionPosition(12)] public List<SegmentGroup26__SegmentGroup71_SegmentGroup72> SegmentGroup72 {get;set;} = new();
	[SectionPosition(13)] public List<SegmentGroup26__SegmentGroup71_SegmentGroup73> SegmentGroup73 {get;set;} = new();
	[SectionPosition(14)] public List<SegmentGroup26__SegmentGroup71_SegmentGroup74> SegmentGroup74 {get;set;} = new();
	[SectionPosition(15)] public List<SegmentGroup26__SegmentGroup71_SegmentGroup75> SegmentGroup75 {get;set;} = new();
	public ValidationResult Validate()
	{
		var validator = new TransactionValidator<SegmentGroup26_SegmentGroup71>(this);
		...
		validator.CollectionSize(x => x.SegmentGroup72, 0, 99);
		validator.CollectionSize(x => x.SegmentGroup73, 0, 9);
		validator.CollectionSize(x => x.SegmentGroup74, 0, 99);
		validator.CollectionSize(x => x.SegmentGroup75, 0, 99);
