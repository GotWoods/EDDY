...
using Eddy.Edifact.DomainModels.Transport.D19A.IFTMAN;
...
public class IFTMAN_ArrivalNotice {
	...
	[SectionPosition(19)] public List<SegmentGroup12> SegmentGroup12 {get;set;} = new();
	[SectionPosition(20)] public List<SegmentGroup19> SegmentGroup19 {get;set;} = new();
	[SectionPosition(21)] public List<SegmentGroup36> SegmentGroup36 {get;set;} = new();
