...
namespace Eddy.Edifact.DomainModels.Transport.D19A.COSTCO;
...
public class SegmentGroup10__SegmentGroup11_SegmentGroup14 {
	...
	[SectionPosition(5)] public List<SegmentGroup10__SegmentGroup11__SegmentGroup14_SegmentGroup15> SegmentGroup15 {get;set;} = new();
	[SectionPosition(6)] public List<SegmentGroup10__SegmentGroup11__SegmentGroup14_SegmentGroup16> SegmentGroup16 {get;set;} = new();
