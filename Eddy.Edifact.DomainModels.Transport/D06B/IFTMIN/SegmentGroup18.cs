...
namespace Eddy.Edifact.DomainModels.Transport.D06B.IFTMIN;
...
public class SegmentGroup18 {
	...
	[SectionPosition(13)] public List<SegmentGroup18_SegmentGroup20> SegmentGroup20 {get;set;} = new();
	[SectionPosition(14)] public List<SegmentGroup18_SegmentGroup21> SegmentGroup21 {get;set;} = new();
	[SectionPosition(15)] public List<SegmentGroup18_SegmentGroup22> SegmentGroup22 {get;set;} = new();
	[SectionPosition(16)] public List<SegmentGroup18_SegmentGroup23> SegmentGroup23 {get;set;} = new();
	[SectionPosition(17)] public List<SegmentGroup18_SegmentGroup24> SegmentGroup24 {get;set;} = new();
	[SectionPosition(18)] public List<SegmentGroup18_SegmentGroup25> SegmentGroup25 {get;set;} = new();
	[SectionPosition(19)] public List<SegmentGroup18_SegmentGroup27> SegmentGroup27 {get;set;} = new();
	[SectionPosition(20)] public List<SegmentGroup18_SegmentGroup29> SegmentGroup29 {get;set;} = new();
	[SectionPosition(21)] public List<SegmentGroup18_SegmentGroup31> SegmentGroup31 {get;set;} = new();
	[SectionPosition(22)] public List<SegmentGroup18_SegmentGroup32> SegmentGroup32 {get;set;} = new();
	public ValidationResult Validate()
	{
		...
		validator.CollectionSize(x => x.SegmentGroup29, 0, 999);
