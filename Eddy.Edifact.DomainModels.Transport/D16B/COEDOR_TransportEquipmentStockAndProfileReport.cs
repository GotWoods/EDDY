...
using Eddy.Edifact.DomainModels.Transport.D16B.COEDOR;

namespace Eddy.Edifact.DomainModels.Transport.D16B;

public class COEDOR_TransportEquipmentStockAndProfileReport {
	...
	{
		var validator = new TransactionValidator<COEDOR_TransportEquipmentStockAndProfileReport>(this);
		...
		validator.CollectionSize(x => x.SegmentGroup4, 0, 999999);
