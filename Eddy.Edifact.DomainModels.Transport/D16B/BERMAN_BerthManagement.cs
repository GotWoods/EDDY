...
using Eddy.Edifact.DomainModels.Transport.D16B.BERMAN;

namespace Eddy.Edifact.DomainModels.Transport.D16B;

public class BERMAN_BerthManagement {
	...
	{
		var validator = new TransactionValidator<BERMAN_BerthManagement>(this);
