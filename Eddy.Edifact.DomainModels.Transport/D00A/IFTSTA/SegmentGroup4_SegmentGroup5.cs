...
public class SegmentGroup4_SegmentGroup5 {
	...
	[SectionPosition(10)] public List<SegmentGroup4__SegmentGroup5_SegmentGroup8> SegmentGroup8 {get;set;} = new();
	[SectionPosition(11)] public List<SegmentGroup4__SegmentGroup5_SegmentGroup10> SegmentGroup10 {get;set;} = new();
