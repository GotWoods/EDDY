...
public class SegmentGroup25__SegmentGroup50__SegmentGroup57_SegmentGroup58 {
	[SectionPosition(1)] public DOC_DocumentMessageDetails DocumentMessageDetails { get; set; } = new();
	[SectionPosition(2)] public DTM_DateTimePeriod DateTimePeriod { get; set; } = new();
	public ValidationResult Validate()
	{
		var validator = new TransactionValidator<SegmentGroup25__SegmentGroup50__SegmentGroup57_SegmentGroup58>(this);
