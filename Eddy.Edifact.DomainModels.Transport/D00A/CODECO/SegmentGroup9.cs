...
namespace Eddy.Edifact.DomainModels.Transport.D00A.CODECO;
...
public class SegmentGroup9 {
	...
	[SectionPosition(14)] public List<SegmentGroup9_SegmentGroup10> SegmentGroup10 {get;set;} = new();
	[SectionPosition(15)] public List<SegmentGroup9_SegmentGroup11> SegmentGroup11 {get;set;} = new();
	[SectionPosition(16)] public List<NAD_NameAndAddress> NameAndAddress { get; set; } = new();
	[SectionPosition(17)] public List<SegmentGroup9_SegmentGroup13> SegmentGroup13 {get;set;} = new();
