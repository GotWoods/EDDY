...
using Eddy.Edifact.DomainModels.Transport.D96B.IFTMBP;

namespace Eddy.Edifact.DomainModels.Transport.D96B;

public class IFTMBP_ProvisionalBooking {
	...
	[SectionPosition(12)] public List<SegmentGroup5> SegmentGroup5 {get;set;} = new();
	[SectionPosition(13)] public List<SegmentGroup8> SegmentGroup8 {get;set;} = new();
	[SectionPosition(14)] public List<SegmentGroup14> SegmentGroup14 {get;set;} = new();
	[SectionPosition(15)] public List<SegmentGroup29> SegmentGroup29 {get;set;} = new();
	...
	{
		var validator = new TransactionValidator<IFTMBP_ProvisionalBooking>(this);
		...
		validator.CollectionSize(x => x.SegmentGroup14, 0, 999);
