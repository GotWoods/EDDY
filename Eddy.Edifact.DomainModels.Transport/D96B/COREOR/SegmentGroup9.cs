...
namespace Eddy.Edifact.DomainModels.Transport.D96B.COREOR;
...
public class SegmentGroup9 {
	...
	[SectionPosition(11)] public List<SegmentGroup9_SegmentGroup10> SegmentGroup10 {get;set;} = new();
	[SectionPosition(12)] public List<SegmentGroup9_SegmentGroup11> SegmentGroup11 {get;set;} = new();
