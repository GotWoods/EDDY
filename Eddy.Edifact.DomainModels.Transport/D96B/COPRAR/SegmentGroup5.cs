...
namespace Eddy.Edifact.DomainModels.Transport.D96B.COPRAR;
...
public class SegmentGroup5 {
	...
	[SectionPosition(15)] public List<SegmentGroup5_SegmentGroup6> SegmentGroup6 {get;set;} = new();
	[SectionPosition(16)] public NAD_NameAndAddress NameAndAddress { get; set; } = new();
