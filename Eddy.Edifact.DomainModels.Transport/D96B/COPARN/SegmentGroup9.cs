...
public class SegmentGroup9 {
	...
	[SectionPosition(18)] public List<SegmentGroup9_SegmentGroup10> SegmentGroup10 {get;set;} = new();
	[SectionPosition(19)] public List<SegmentGroup9_SegmentGroup11> SegmentGroup11 {get;set;} = new();
	[SectionPosition(20)] public List<SegmentGroup9_SegmentGroup12> SegmentGroup12 {get;set;} = new();
