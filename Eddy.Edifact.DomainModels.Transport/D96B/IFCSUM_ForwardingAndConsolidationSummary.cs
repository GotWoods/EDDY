...
using Eddy.Edifact.DomainModels.Transport.D96B.IFCSUM;
...
public class IFCSUM_ForwardingAndConsolidationSummary {
	...
	[SectionPosition(11)] public List<SegmentGroup8> SegmentGroup8 {get;set;} = new();
	[SectionPosition(12)] public List<SegmentGroup17> SegmentGroup17 {get;set;} = new();
	[SectionPosition(13)] public List<SegmentGroup19> SegmentGroup19 {get;set;} = new();
	...
	public ValidationResult Validate()
	{
		...
		validator.CollectionSize(x => x.SegmentGroup17, 0, 999);
		validator.CollectionSize(x => x.SegmentGroup19, 0, 9999);
