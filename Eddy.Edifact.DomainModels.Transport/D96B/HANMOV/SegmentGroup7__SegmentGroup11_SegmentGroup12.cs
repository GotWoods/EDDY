...
namespace Eddy.Edifact.DomainModels.Transport.D96B.HANMOV;

public class SegmentGroup7__SegmentGroup11_SegmentGroup12 {
	...
	{
		var validator = new TransactionValidator<SegmentGroup7__SegmentGroup11_SegmentGroup12>(this);
