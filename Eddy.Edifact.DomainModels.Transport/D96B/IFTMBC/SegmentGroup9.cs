...
namespace Eddy.Edifact.DomainModels.Transport.D96B.IFTMBC;
...
public class SegmentGroup9 {
	...
	[SectionPosition(8)] public List<SegmentGroup9_SegmentGroup10> SegmentGroup10 {get;set;} = new();
	[SectionPosition(9)] public List<GDS_NatureOfCargo> NatureOfCargo { get; set; } = new();
	[SectionPosition(10)] public List<SegmentGroup9_SegmentGroup11> SegmentGroup11 {get;set;} = new();
	[SectionPosition(11)] public List<SegmentGroup9_SegmentGroup12> SegmentGroup12 {get;set;} = new();
	[SectionPosition(12)] public List<SegmentGroup9_SegmentGroup13> SegmentGroup13 {get;set;} = new();
	[SectionPosition(13)] public List<SegmentGroup9_SegmentGroup14> SegmentGroup14 {get;set;} = new();
	[SectionPosition(14)] public List<SegmentGroup9_SegmentGroup15> SegmentGroup15 {get;set;} = new();
