...
using Eddy.Edifact.DomainModels.Transport.D18B.IFTMCA;

namespace Eddy.Edifact.DomainModels.Transport.D18B;

public class IFTMCA_ConsignmentAdvice {
	...
	[SectionPosition(18)] public List<SegmentGroup13> SegmentGroup13 {get;set;} = new();
	[SectionPosition(19)] public List<SegmentGroup17> SegmentGroup17 {get;set;} = new();
	[SectionPosition(20)] public List<SegmentGroup37> SegmentGroup37 {get;set;} = new();
	...
	{
		var validator = new TransactionValidator<IFTMCA_ConsignmentAdvice>(this);
		...
		validator.CollectionSize(x => x.SegmentGroup17, 0, 99999);
