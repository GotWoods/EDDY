...
namespace Eddy.Edifact.DomainModels.Transport.D21A.COARRI;
...
public class SegmentGroup6 {
	...
	[SectionPosition(11)] public List<ATT_Attribute> Attribute { get; set; } = new();
	...
	[SectionPosition(14)] public List<SegmentGroup6_SegmentGroup9> SegmentGroup9 {get;set;} = new();
	...
	[SectionPosition(19)] public List<SegmentGroup6_SegmentGroup11> SegmentGroup11 {get;set;} = new();
	[SectionPosition(20)] public List<SegmentGroup6_SegmentGroup12> SegmentGroup12 {get;set;} = new();
