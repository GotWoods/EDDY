...
namespace Eddy.Edifact.DomainModels.Transport.D21A.COHAOR;
...
public class SegmentGroup4 {
	...
	[SectionPosition(8)] public List<ATT_Attribute> Attribute { get; set; } = new();
	...
	[SectionPosition(12)] public List<SegmentGroup4_SegmentGroup7> SegmentGroup7 {get;set;} = new();
	[SectionPosition(13)] public List<SegmentGroup4_SegmentGroup9> SegmentGroup9 {get;set;} = new();
	[SectionPosition(14)] public List<SegmentGroup4_SegmentGroup11> SegmentGroup11 {get;set;} = new();
