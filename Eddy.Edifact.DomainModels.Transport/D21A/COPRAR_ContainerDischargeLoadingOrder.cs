...
using Eddy.Edifact.DomainModels.Transport.D21A.COPRAR;

namespace Eddy.Edifact.DomainModels.Transport.D21A;

public class COPRAR_ContainerDischargeLoadingOrder {
	...
	{
		var validator = new TransactionValidator<COPRAR_ContainerDischargeLoadingOrder>(this);
