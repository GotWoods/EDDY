...
public class SegmentGroup12 {
	...
	[SectionPosition(15)] public List<SegmentGroup12_SegmentGroup15> SegmentGroup15 {get;set;} = new();
	[SectionPosition(16)] public List<SegmentGroup12_SegmentGroup17> SegmentGroup17 {get;set;} = new();
	[SectionPosition(17)] public List<SegmentGroup12_SegmentGroup18> SegmentGroup18 {get;set;} = new();
