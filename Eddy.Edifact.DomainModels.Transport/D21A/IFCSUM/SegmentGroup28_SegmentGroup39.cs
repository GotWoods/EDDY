...
namespace Eddy.Edifact.DomainModels.Transport.D21A.IFCSUM;

public class SegmentGroup28_SegmentGroup39 {
	...
	{
		var validator = new TransactionValidator<SegmentGroup28_SegmentGroup39>(this);
