...
public class SegmentGroup11 {
	...
	[SectionPosition(12)] public List<SegmentGroup11_SegmentGroup12> SegmentGroup12 {get;set;} = new();
	[SectionPosition(13)] public List<NAD_NameAndAddress> NameAndAddress { get; set; } = new();
	[SectionPosition(14)] public List<SegmentGroup11_SegmentGroup14> SegmentGroup14 {get;set;} = new();
	[SectionPosition(15)] public List<SegmentGroup11_SegmentGroup16> SegmentGroup16 {get;set;} = new();
