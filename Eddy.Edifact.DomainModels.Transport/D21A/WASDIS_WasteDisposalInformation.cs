...
using Eddy.Edifact.DomainModels.Transport.D21A.WASDIS;

namespace Eddy.Edifact.DomainModels.Transport.D21A;

public class WASDIS_WasteDisposalInformation {
	...
	{
		var validator = new TransactionValidator<WASDIS_WasteDisposalInformation>(this);
