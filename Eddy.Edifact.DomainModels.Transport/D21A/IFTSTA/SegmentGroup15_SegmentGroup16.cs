...
public class SegmentGroup15_SegmentGroup16 {
	...
	[SectionPosition(6)] public List<SegmentGroup15__SegmentGroup16_SegmentGroup17> SegmentGroup17 {get;set;} = new();
	...
	[SectionPosition(9)] public List<SegmentGroup15__SegmentGroup16_SegmentGroup19> SegmentGroup19 {get;set;} = new();
	[SectionPosition(10)] public List<SegmentGroup15__SegmentGroup16_SegmentGroup21> SegmentGroup21 {get;set;} = new();
	[SectionPosition(11)] public List<SegmentGroup15__SegmentGroup16_SegmentGroup25> SegmentGroup25 {get;set;} = new();
