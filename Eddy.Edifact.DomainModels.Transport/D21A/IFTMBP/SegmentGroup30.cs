...
namespace Eddy.Edifact.DomainModels.Transport.D21A.IFTMBP;
...
public class SegmentGroup30 {
	...
	[SectionPosition(12)] public List<SegmentGroup30_SegmentGroup31> SegmentGroup31 {get;set;} = new();
	public ValidationResult Validate()
	{
		var validator = new TransactionValidator<SegmentGroup30>(this);
