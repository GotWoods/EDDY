...
public class SegmentGroup6_SegmentGroup7 {
	...
	[SectionPosition(10)] public List<SegmentGroup6__SegmentGroup7_SegmentGroup8> SegmentGroup8 {get;set;} = new();
	[SectionPosition(11)] public List<SegmentGroup6__SegmentGroup7_SegmentGroup9> SegmentGroup9 {get;set;} = new();
	[SectionPosition(12)] public List<SegmentGroup6__SegmentGroup7_SegmentGroup10> SegmentGroup10 {get;set;} = new();
	[SectionPosition(13)] public List<SegmentGroup6__SegmentGroup7_SegmentGroup11> SegmentGroup11 {get;set;} = new();
