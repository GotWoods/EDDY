...
namespace Eddy.Edifact.DomainModels.Transport.D21A.COEDOR;
...
public class SegmentGroup4 {
	...
	[SectionPosition(12)] public List<ATT_Attribute> Attribute { get; set; } = new();
	[SectionPosition(13)] public List<NAD_NameAndAddress> NameAndAddress { get; set; } = new();
	[SectionPosition(14)] public EQN_NumberOfUnits NumberOfUnits { get; set; } = new();
	[SectionPosition(15)] public List<SegmentGroup4_SegmentGroup5> SegmentGroup5 {get;set;} = new();
	[SectionPosition(16)] public List<SegmentGroup4_SegmentGroup6> SegmentGroup6 {get;set;} = new();
	[SectionPosition(17)] public List<SegmentGroup4_SegmentGroup8> SegmentGroup8 {get;set;} = new();
	[SectionPosition(18)] public List<SegmentGroup4_SegmentGroup10> SegmentGroup10 {get;set;} = new();
