...
namespace Eddy.Edifact.DomainModels.Transport.D21A.MOVINS;
...
public class SegmentGroup6__SegmentGroup7_SegmentGroup8 {
	...
	[SectionPosition(5)] public List<ATT_Attribute> Attribute { get; set; } = new();
	[SectionPosition(6)] public List<DIM_Dimensions> Dimensions { get; set; } = new();
	[SectionPosition(7)] public List<RFF_Reference> Reference { get; set; } = new();
	...
	[SectionPosition(10)] public List<SegmentGroup6__SegmentGroup7__SegmentGroup8_SegmentGroup9> SegmentGroup9 {get;set;} = new();
	[SectionPosition(11)] public List<SegmentGroup6__SegmentGroup7__SegmentGroup8_SegmentGroup10> SegmentGroup10 {get;set;} = new();
	[SectionPosition(12)] public List<SegmentGroup6__SegmentGroup7__SegmentGroup8_SegmentGroup11> SegmentGroup11 {get;set;} = new();
	[SectionPosition(13)] public List<SegmentGroup6__SegmentGroup7__SegmentGroup8_SegmentGroup12> SegmentGroup12 {get;set;} = new();
	public ValidationResult Validate()
	{
		...
		validator.CollectionSize(x => x.Attribute, 1, 99);
