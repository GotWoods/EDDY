...
using Eddy.Edifact.DomainModels.Transport.D21A.COREOR;

namespace Eddy.Edifact.DomainModels.Transport.D21A;

public class COREOR_ContainerReleaseOrder {
	...
	[SectionPosition(9)] public List<SegmentGroup12> SegmentGroup12 {get;set;} = new();
	...
	{
		var validator = new TransactionValidator<COREOR_ContainerReleaseOrder>(this);
		...
		validator.CollectionSize(x => x.SegmentGroup12, 0, 99999);
