...
namespace Eddy.Edifact.DomainModels.Transport.D08A.IFTMBF;
...
public class SegmentGroup16 {
	...
	[SectionPosition(11)] public List<SegmentGroup16_SegmentGroup17> SegmentGroup17 {get;set;} = new();
	[SectionPosition(12)] public List<GDS_NatureOfCargo> NatureOfCargo { get; set; } = new();
	[SectionPosition(13)] public List<SegmentGroup16_SegmentGroup18> SegmentGroup18 {get;set;} = new();
	[SectionPosition(14)] public List<SegmentGroup16_SegmentGroup19> SegmentGroup19 {get;set;} = new();
	[SectionPosition(15)] public List<SegmentGroup16_SegmentGroup20> SegmentGroup20 {get;set;} = new();
	[SectionPosition(16)] public List<SegmentGroup16_SegmentGroup21> SegmentGroup21 {get;set;} = new();
	[SectionPosition(17)] public List<SegmentGroup16_SegmentGroup22> SegmentGroup22 {get;set;} = new();
	[SectionPosition(18)] public List<SegmentGroup16_SegmentGroup23> SegmentGroup23 {get;set;} = new();
	[SectionPosition(19)] public List<SegmentGroup16_SegmentGroup25> SegmentGroup25 {get;set;} = new();
	[SectionPosition(20)] public List<SegmentGroup16_SegmentGroup27> SegmentGroup27 {get;set;} = new();
