...
public class SegmentGroup19_SegmentGroup60 {
	...
	[SectionPosition(12)] public List<SegmentGroup19__SegmentGroup60_SegmentGroup61> SegmentGroup61 {get;set;} = new();
	[SectionPosition(13)] public List<SegmentGroup19__SegmentGroup60_SegmentGroup62> SegmentGroup62 {get;set;} = new();
	[SectionPosition(14)] public List<SegmentGroup19__SegmentGroup60_SegmentGroup63> SegmentGroup63 {get;set;} = new();
	public ValidationResult Validate()
	{
		var validator = new TransactionValidator<SegmentGroup19_SegmentGroup60>(this);
		...
		validator.CollectionSize(x => x.SegmentGroup61, 0, 99);
