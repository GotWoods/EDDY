...
using Eddy.Edifact.DomainModels.Transport.D97B.IFTMBC;
...
public class IFTMBC_BookingConfirmation {
	...
	[SectionPosition(11)] public List<TCC_TransportChargeRateCalculations> TransportChargeRateCalculations { get; set; } = new();
	[SectionPosition(12)] public List<SegmentGroup3> SegmentGroup3 {get;set;} = new();
	[SectionPosition(13)] public List<SegmentGroup6> SegmentGroup6 {get;set;} = new();
	[SectionPosition(14)] public List<SegmentGroup9> SegmentGroup9 {get;set;} = new();
	[SectionPosition(15)] public List<SegmentGroup18> SegmentGroup18 {get;set;} = new();
