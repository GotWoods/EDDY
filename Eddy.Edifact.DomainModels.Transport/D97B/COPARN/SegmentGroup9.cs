...
namespace Eddy.Edifact.DomainModels.Transport.D97B.COPARN;
...
public class SegmentGroup9 {
	...
	[SectionPosition(15)] public DGS_DangerousGoods DangerousGoods { get; set; } = new();
	...
	[SectionPosition(20)] public List<SegmentGroup9_SegmentGroup10> SegmentGroup10 {get;set;} = new();
	[SectionPosition(21)] public List<SegmentGroup9_SegmentGroup11> SegmentGroup11 {get;set;} = new();
	[SectionPosition(22)] public List<SegmentGroup9_SegmentGroup12> SegmentGroup12 {get;set;} = new();
