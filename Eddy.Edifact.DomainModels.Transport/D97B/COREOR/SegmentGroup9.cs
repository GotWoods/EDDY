...
public class SegmentGroup9 {
	...
	[SectionPosition(13)] public List<SegmentGroup9_SegmentGroup10> SegmentGroup10 {get;set;} = new();
	[SectionPosition(14)] public List<SegmentGroup9_SegmentGroup11> SegmentGroup11 {get;set;} = new();
