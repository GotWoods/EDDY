...
namespace Eddy.Edifact.DomainModels.Transport.D97B.COARRI;
...
public class SegmentGroup5 {
	...
	[SectionPosition(18)] public List<SegmentGroup5_SegmentGroup6> SegmentGroup6 {get;set;} = new();
	[SectionPosition(19)] public List<SegmentGroup5_SegmentGroup7> SegmentGroup7 {get;set;} = new();
