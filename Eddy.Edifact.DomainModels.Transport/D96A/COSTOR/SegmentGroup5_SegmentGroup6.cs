...
public class SegmentGroup5_SegmentGroup6 {
	...
	[SectionPosition(7)] public List<SegmentGroup5__SegmentGroup6_SegmentGroup7> SegmentGroup7 {get;set;} = new();
	...
	[SectionPosition(11)] public List<SegmentGroup5__SegmentGroup6_SegmentGroup8> SegmentGroup8 {get;set;} = new();
	[SectionPosition(12)] public List<SegmentGroup5__SegmentGroup6_SegmentGroup9> SegmentGroup9 {get;set;} = new();
