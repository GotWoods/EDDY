...
public class SegmentGroup3 {
	...
	[SectionPosition(6)] public List<SegmentGroup3_SegmentGroup4> SegmentGroup4 {get;set;} = new();
	...
	[SectionPosition(10)] public List<SegmentGroup3_SegmentGroup5> SegmentGroup5 {get;set;} = new();
	[SectionPosition(11)] public List<SegmentGroup3_SegmentGroup6> SegmentGroup6 {get;set;} = new();
