...
public class SegmentGroup7 {
	...
	[SectionPosition(18)] public List<SegmentGroup7_SegmentGroup8> SegmentGroup8 {get;set;} = new();
	[SectionPosition(19)] public List<SegmentGroup7_SegmentGroup9> SegmentGroup9 {get;set;} = new();
	[SectionPosition(20)] public List<SegmentGroup7_SegmentGroup10> SegmentGroup10 {get;set;} = new();
