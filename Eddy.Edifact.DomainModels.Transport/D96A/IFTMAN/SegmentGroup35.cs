...
public class SegmentGroup35 {
	...
	[SectionPosition(11)] public List<SegmentGroup35_SegmentGroup36> SegmentGroup36 {get;set;} = new();
	[SectionPosition(12)] public List<SegmentGroup35_SegmentGroup37> SegmentGroup37 {get;set;} = new();
	[SectionPosition(13)] public List<SegmentGroup35_SegmentGroup38> SegmentGroup38 {get;set;} = new();
