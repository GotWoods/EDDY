...
using Eddy.Edifact.DomainModels.Transport.D96A.VESDEP;

namespace Eddy.Edifact.DomainModels.Transport.D96A;

public class VESDEP_VesselDeparture {
	...
	{
		var validator = new TransactionValidator<VESDEP_VesselDeparture>(this);
