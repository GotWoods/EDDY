...
public class SegmentGroup15_SegmentGroup56 {
	...
	[SectionPosition(11)] public List<SegmentGroup15__SegmentGroup56_SegmentGroup57> SegmentGroup57 {get;set;} = new();
	[SectionPosition(12)] public List<SegmentGroup15__SegmentGroup56_SegmentGroup58> SegmentGroup58 {get;set;} = new();
	[SectionPosition(13)] public List<SegmentGroup15__SegmentGroup56_SegmentGroup59> SegmentGroup59 {get;set;} = new();
	public ValidationResult Validate()
	{
		var validator = new TransactionValidator<SegmentGroup15_SegmentGroup56>(this);
		...
		validator.CollectionSize(x => x.SegmentGroup59, 0, 99);
