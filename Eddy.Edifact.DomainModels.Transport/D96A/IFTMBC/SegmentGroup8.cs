...
public class SegmentGroup8 {
	...
	[SectionPosition(8)] public List<SegmentGroup8_SegmentGroup9> SegmentGroup9 {get;set;} = new();
	[SectionPosition(9)] public List<GDS_NatureOfCargo> NatureOfCargo { get; set; } = new();
	[SectionPosition(10)] public List<SegmentGroup8_SegmentGroup10> SegmentGroup10 {get;set;} = new();
	[SectionPosition(11)] public List<SegmentGroup8_SegmentGroup11> SegmentGroup11 {get;set;} = new();
	[SectionPosition(12)] public List<SegmentGroup8_SegmentGroup12> SegmentGroup12 {get;set;} = new();
	[SectionPosition(13)] public List<SegmentGroup8_SegmentGroup13> SegmentGroup13 {get;set;} = new();
	[SectionPosition(14)] public List<SegmentGroup8_SegmentGroup14> SegmentGroup14 {get;set;} = new();
