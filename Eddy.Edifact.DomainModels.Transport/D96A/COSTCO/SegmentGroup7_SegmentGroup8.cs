...
namespace Eddy.Edifact.DomainModels.Transport.D96A.COSTCO;
...
public class SegmentGroup7_SegmentGroup8 {
	...
	[SectionPosition(9)] public List<SegmentGroup7__SegmentGroup8_SegmentGroup9> SegmentGroup9 {get;set;} = new();
	[SectionPosition(10)] public List<SegmentGroup7__SegmentGroup8_SegmentGroup10> SegmentGroup10 {get;set;} = new();
