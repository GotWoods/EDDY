...
using Eddy.Edifact.DomainModels.Transport.D98A.IFTMBF;
...
public class IFTMBF_FirmBooking {
	...
	[SectionPosition(12)] public List<SegmentGroup3> SegmentGroup3 {get;set;} = new();
	[SectionPosition(13)] public List<SegmentGroup4> SegmentGroup4 {get;set;} = new();
	[SectionPosition(14)] public List<SegmentGroup6> SegmentGroup6 {get;set;} = new();
	[SectionPosition(15)] public List<SegmentGroup7> SegmentGroup7 {get;set;} = new();
	[SectionPosition(16)] public List<SegmentGroup10> SegmentGroup10 {get;set;} = new();
	[SectionPosition(17)] public List<SegmentGroup16> SegmentGroup16 {get;set;} = new();
	[SectionPosition(18)] public List<SegmentGroup32> SegmentGroup32 {get;set;} = new();
	[SectionPosition(19)] public UNT_MessageTrailer MessageTrailer { get; set; } = new();
