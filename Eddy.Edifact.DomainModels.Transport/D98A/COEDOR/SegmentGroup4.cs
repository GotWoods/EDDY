...
namespace Eddy.Edifact.DomainModels.Transport.D98A.COEDOR;
...
public class SegmentGroup4 {
	...
	[SectionPosition(7)] public List<SegmentGroup4_SegmentGroup5> SegmentGroup5 {get;set;} = new();
	[SectionPosition(8)] public List<SegmentGroup4_SegmentGroup6> SegmentGroup6 {get;set;} = new();
