...
namespace Eddy.Edifact.DomainModels.Transport.D98A.COSTCO;
...
public class SegmentGroup6__SegmentGroup7_SegmentGroup9 {
	...
	[SectionPosition(4)] public List<SegmentGroup6__SegmentGroup7__SegmentGroup9_SegmentGroup10> SegmentGroup10 {get;set;} = new();
	[SectionPosition(5)] public List<SegmentGroup6__SegmentGroup7__SegmentGroup9_SegmentGroup11> SegmentGroup11 {get;set;} = new();
