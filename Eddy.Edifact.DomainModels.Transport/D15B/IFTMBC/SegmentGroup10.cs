...
namespace Eddy.Edifact.DomainModels.Transport.D15B.IFTMBC;
...
public class SegmentGroup10 {
	...
	[SectionPosition(9)] public List<SegmentGroup10_SegmentGroup11> SegmentGroup11 {get;set;} = new();
	[SectionPosition(10)] public List<GDS_NatureOfCargo> NatureOfCargo { get; set; } = new();
	[SectionPosition(11)] public List<SegmentGroup10_SegmentGroup12> SegmentGroup12 {get;set;} = new();
	[SectionPosition(12)] public List<SegmentGroup10_SegmentGroup13> SegmentGroup13 {get;set;} = new();
	[SectionPosition(13)] public List<SegmentGroup10_SegmentGroup14> SegmentGroup14 {get;set;} = new();
	[SectionPosition(14)] public List<SegmentGroup10_SegmentGroup15> SegmentGroup15 {get;set;} = new();
	[SectionPosition(15)] public List<SegmentGroup10_SegmentGroup16> SegmentGroup16 {get;set;} = new();
