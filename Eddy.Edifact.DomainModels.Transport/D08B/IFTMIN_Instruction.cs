...
using Eddy.Edifact.DomainModels.Transport.D08B.IFTMIN;

namespace Eddy.Edifact.DomainModels.Transport.D08B;
...
public class IFTMIN_Instruction {
	...
	[SectionPosition(20)] public List<SegmentGroup11> SegmentGroup11 {get;set;} = new();
	[SectionPosition(21)] public List<SegmentGroup18> SegmentGroup18 {get;set;} = new();
	[SectionPosition(22)] public List<SegmentGroup37> SegmentGroup37 {get;set;} = new();
	...
	public ValidationResult Validate()
	{
		...
		validator.CollectionSize(x => x.SegmentGroup18, 0, 99999);
