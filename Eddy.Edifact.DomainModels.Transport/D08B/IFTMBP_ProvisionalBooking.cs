...
using Eddy.Edifact.DomainModels.Transport.D08B.IFTMBP;
...
public class IFTMBP_ProvisionalBooking {
	...
	[SectionPosition(14)] public List<SegmentGroup8> SegmentGroup8 {get;set;} = new();
	[SectionPosition(15)] public List<SegmentGroup14> SegmentGroup14 {get;set;} = new();
	[SectionPosition(16)] public List<SegmentGroup29> SegmentGroup29 {get;set;} = new();
	...
	public ValidationResult Validate()
	{
		...
		validator.CollectionSize(x => x.SegmentGroup14, 0, 99999);
