...
using Eddy.Edifact.DomainModels.Transport.D97A.IFTMAN;

namespace Eddy.Edifact.DomainModels.Transport.D97A;

public class IFTMAN_ArrivalNotice {
	...
	[SectionPosition(17)] public List<SegmentGroup8> SegmentGroup8 {get;set;} = new();
	[SectionPosition(18)] public List<SegmentGroup11> SegmentGroup11 {get;set;} = new();
	[SectionPosition(19)] public List<SegmentGroup18> SegmentGroup18 {get;set;} = new();
	[SectionPosition(20)] public List<SegmentGroup35> SegmentGroup35 {get;set;} = new();
	[SectionPosition(21)] public UNT_MessageTrailer MessageTrailer { get; set; } = new();
	...
	{
		var validator = new TransactionValidator<IFTMAN_ArrivalNotice>(this);
