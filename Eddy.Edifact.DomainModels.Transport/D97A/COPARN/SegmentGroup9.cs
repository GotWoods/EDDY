...
namespace Eddy.Edifact.DomainModels.Transport.D97A.COPARN;
...
public class SegmentGroup9 {
	...
	[SectionPosition(14)] public DGS_DangerousGoods DangerousGoods { get; set; } = new();
	...
	[SectionPosition(19)] public List<SegmentGroup9_SegmentGroup10> SegmentGroup10 {get;set;} = new();
	[SectionPosition(20)] public List<SegmentGroup9_SegmentGroup11> SegmentGroup11 {get;set;} = new();
