...
using Eddy.Edifact.DomainModels.Transport.D97A.CODECO;

namespace Eddy.Edifact.DomainModels.Transport.D97A;

public class CODECO_ContainerGate {
	...
	[SectionPosition(9)] public List<SegmentGroup7> SegmentGroup7 {get;set;} = new();
	...
	{
		var validator = new TransactionValidator<CODECO_ContainerGate>(this);
