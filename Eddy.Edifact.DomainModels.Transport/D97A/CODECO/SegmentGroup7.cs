...
namespace Eddy.Edifact.DomainModels.Transport.D97A.CODECO;
...
public class SegmentGroup7 {
	...
	[SectionPosition(12)] public List<SegmentGroup7_SegmentGroup8> SegmentGroup8 {get;set;} = new();
	[SectionPosition(13)] public List<SegmentGroup7_SegmentGroup9> SegmentGroup9 {get;set;} = new();
	[SectionPosition(14)] public List<NAD_NameAndAddress> NameAndAddress { get; set; } = new();
