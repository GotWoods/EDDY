...
public class SegmentGroup9 {
	...
	[SectionPosition(12)] public List<SegmentGroup9_SegmentGroup10> SegmentGroup10 {get;set;} = new();
	[SectionPosition(13)] public List<SegmentGroup9_SegmentGroup11> SegmentGroup11 {get;set;} = new();
