...
public class SegmentGroup4__SegmentGroup5_SegmentGroup9 {
	...
	[SectionPosition(6)] public List<SegmentGroup4__SegmentGroup5__SegmentGroup9_SegmentGroup10> SegmentGroup10 {get;set;} = new();
	[SectionPosition(7)] public List<SegmentGroup4__SegmentGroup5__SegmentGroup9_SegmentGroup11> SegmentGroup11 {get;set;} = new();
	[SectionPosition(8)] public List<SegmentGroup4__SegmentGroup5__SegmentGroup9_SegmentGroup12> SegmentGroup12 {get;set;} = new();
