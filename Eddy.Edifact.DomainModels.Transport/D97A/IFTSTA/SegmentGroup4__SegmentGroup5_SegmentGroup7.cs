...
public class SegmentGroup4__SegmentGroup5_SegmentGroup7 {
	...
	[SectionPosition(5)] public List<TPL_TransportPlacement> TransportPlacement { get; set; } = new();
	[SectionPosition(6)] public List<SegmentGroup4__SegmentGroup5__SegmentGroup7_SegmentGroup8> SegmentGroup8 {get;set;} = new();
