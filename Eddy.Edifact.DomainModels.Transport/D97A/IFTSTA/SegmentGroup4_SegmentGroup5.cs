...
namespace Eddy.Edifact.DomainModels.Transport.D97A.IFTSTA;
...
public class SegmentGroup4_SegmentGroup5 {
	...
	[SectionPosition(6)] public List<NAD_NameAndAddress> NameAndAddress { get; set; } = new();
	...
	[SectionPosition(9)] public List<SegmentGroup4__SegmentGroup5_SegmentGroup6> SegmentGroup6 {get;set;} = new();
	[SectionPosition(10)] public List<SegmentGroup4__SegmentGroup5_SegmentGroup7> SegmentGroup7 {get;set;} = new();
	[SectionPosition(11)] public List<SegmentGroup4__SegmentGroup5_SegmentGroup9> SegmentGroup9 {get;set;} = new();
