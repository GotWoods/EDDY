...
using Eddy.Edifact.DomainModels.Transport.D97A.IFTDGN;

namespace Eddy.Edifact.DomainModels.Transport.D97A;

public class IFTDGN_DangerousGoodsNotification {
	...
	[SectionPosition(5)] public HAN_HandlingInstructions HandlingInstructions { get; set; } = new();
	...
	[SectionPosition(9)] public List<SegmentGroup5> SegmentGroup5 {get;set;} = new();
	...
	{
		var validator = new TransactionValidator<IFTDGN_DangerousGoodsNotification>(this);
