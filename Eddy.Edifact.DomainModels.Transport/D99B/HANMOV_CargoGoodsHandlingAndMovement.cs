...
using Eddy.Edifact.DomainModels.Transport.D99B.HANMOV;
...
public class HANMOV_CargoGoodsHandlingAndMovement {
	...
	[SectionPosition(13)] public List<SegmentGroup13> SegmentGroup13 {get;set;} = new();
	[SectionPosition(14)] public List<SegmentGroup16> SegmentGroup16 {get;set;} = new();
	[SectionPosition(15)] public UNT_MessageTrailer MessageTrailer { get; set; } = new();
