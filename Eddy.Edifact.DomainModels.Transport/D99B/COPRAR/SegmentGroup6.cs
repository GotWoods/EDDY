...
namespace Eddy.Edifact.DomainModels.Transport.D99B.COPRAR;
...
public class SegmentGroup6 {
	...
	[SectionPosition(14)] public List<SegmentGroup6_SegmentGroup7> SegmentGroup7 {get;set;} = new();
	...
	[SectionPosition(17)] public List<SegmentGroup6_SegmentGroup9> SegmentGroup9 {get;set;} = new();
