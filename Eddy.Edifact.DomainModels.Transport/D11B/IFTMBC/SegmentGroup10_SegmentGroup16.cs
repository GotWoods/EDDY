...
public class SegmentGroup10_SegmentGroup16 {
	...
	[SectionPosition(3)] public List<SegmentGroup10__SegmentGroup16_SegmentGroup17> SegmentGroup17 {get;set;} = new();
	[SectionPosition(4)] public List<SegmentGroup10__SegmentGroup16_SegmentGroup18> SegmentGroup18 {get;set;} = new();
