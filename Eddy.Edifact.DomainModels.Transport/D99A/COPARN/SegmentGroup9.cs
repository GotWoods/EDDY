...
namespace Eddy.Edifact.DomainModels.Transport.D99A.COPARN;
...
public class SegmentGroup9 {
	...
	[SectionPosition(15)] public List<SegmentGroup9_SegmentGroup10> SegmentGroup10 {get;set;} = new();
	...
	[SectionPosition(21)] public List<SegmentGroup9_SegmentGroup12> SegmentGroup12 {get;set;} = new();
	[SectionPosition(22)] public List<SegmentGroup9_SegmentGroup13> SegmentGroup13 {get;set;} = new();
	[SectionPosition(23)] public List<SegmentGroup9_SegmentGroup14> SegmentGroup14 {get;set;} = new();
