...
namespace Eddy.Edifact.DomainModels.Transport.D99A.COREOR;
...
public class SegmentGroup10 {
	...
	[SectionPosition(13)] public List<SegmentGroup10_SegmentGroup11> SegmentGroup11 {get;set;} = new();
	[SectionPosition(14)] public List<SegmentGroup10_SegmentGroup12> SegmentGroup12 {get;set;} = new();
