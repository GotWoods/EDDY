...
using Eddy.Edifact.DomainModels.Transport.D03B.IFTSTQ;
...
public class IFTSTQ_InternationalMultimodalStatusRequest {
	...
	[SectionPosition(6)] public List<TDT_TransportInformation> TransportInformation { get; set; } = new();
	...
	public ValidationResult Validate()
	{
		...
		validator.CollectionSize(x => x.TransportInformation, 1, 99);
