...
public class SegmentGroup26_SegmentGroup37 {
	...
	[SectionPosition(4)] public CUX_Currencies Currencies { get; set; } = new();
	[SectionPosition(5)] public PRI_PriceDetails PriceDetails { get; set; } = new();
	[SectionPosition(6)] public EQN_NumberOfUnits NumberOfUnits { get; set; } = new();
	...
	{
		var validator = new TransactionValidator<SegmentGroup26_SegmentGroup37>(this);
