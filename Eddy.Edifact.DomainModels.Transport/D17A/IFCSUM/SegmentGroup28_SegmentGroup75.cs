...
public class SegmentGroup28_SegmentGroup75 {
	...
	[SectionPosition(12)] public List<SegmentGroup28__SegmentGroup75_SegmentGroup76> SegmentGroup76 {get;set;} = new();
	[SectionPosition(13)] public List<SegmentGroup28__SegmentGroup75_SegmentGroup77> SegmentGroup77 {get;set;} = new();
	[SectionPosition(14)] public List<SegmentGroup28__SegmentGroup75_SegmentGroup78> SegmentGroup78 {get;set;} = new();
	[SectionPosition(15)] public List<SegmentGroup28__SegmentGroup75_SegmentGroup79> SegmentGroup79 {get;set;} = new();
