...
namespace Eddy.Edifact.DomainModels.Transport.D10A.IFTSTA;

public class SegmentGroup13__SegmentGroup14_SegmentGroup19 {
	...
	[SectionPosition(8)] public List<SegmentGroup13__SegmentGroup14__SegmentGroup19_SegmentGroup20> SegmentGroup20 {get;set;} = new();
	[SectionPosition(9)] public List<SegmentGroup13__SegmentGroup14__SegmentGroup19_SegmentGroup21> SegmentGroup21 {get;set;} = new();
	public ValidationResult Validate()
	{
		var validator = new TransactionValidator<SegmentGroup13__SegmentGroup14_SegmentGroup19>(this);
