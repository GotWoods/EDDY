...
namespace Eddy.Edifact.DomainModels.Transport.D01C.COEDOR;
...
public class SegmentGroup4 {
	...
	[SectionPosition(6)] public List<HAN_HandlingInstructions> HandlingInstructions { get; set; } = new();
	[SectionPosition(7)] public EQN_NumberOfUnits NumberOfUnits { get; set; } = new();
	[SectionPosition(8)] public List<SegmentGroup4_SegmentGroup5> SegmentGroup5 {get;set;} = new();
	[SectionPosition(9)] public List<SegmentGroup4_SegmentGroup6> SegmentGroup6 {get;set;} = new();
	[SectionPosition(10)] public List<SegmentGroup4_SegmentGroup8> SegmentGroup8 {get;set;} = new();
	[SectionPosition(11)] public List<SegmentGroup4_SegmentGroup10> SegmentGroup10 {get;set;} = new();
